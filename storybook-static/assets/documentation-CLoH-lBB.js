import{j as e}from"./jsx-runtime-CKrituN3.js";import{M as r}from"./index-DcbqFflo.js";import{useMDXComponents as s}from"./index-DI5IigMn.js";import"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-CKXpZQ8U.js";import"../sb-preview/runtime.js";import"./index-BtM5VmRH.js";import"./index-D_r38UMq.js";import"./index-Cmc67Rxs.js";import"./index-DrFu-skq.js";function t(i){const n=Object.assign({h1:"h1",h2:"h2",p:"p",code:"code",ul:"ul",li:"li",strong:"strong",hr:"hr",h3:"h3",h4:"h4",h5:"h5",em:"em"},s(),i.components);return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Components/Datagrid Cursor/Documentation"}),`
...
`]}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h4,{id:"api-v6",children:"API V6"}),`
`,e.jsx(n.h5,{id:"usage-with-iceberg",children:"usage with Iceberg"}),`
`,e.jsxs(n.p,{children:["We provide a custom hook ",e.jsx(n.code,{children:"useResourcesIcebergV6"})]}),`
`,e.jsx(n.h5,{id:"usage-without-iceberg",children:"usage without Iceberg"}),`
`,e.jsxs(n.p,{children:["We provide a custom hook ",e.jsx(n.code,{children:"useResourcesV6"})]}),`
`,e.jsx(n.h4,{id:"api-v2",children:"API V2"}),`
`,e.jsxs(n.h5,{id:"usage-only-with-iceberg",children:["usage ",e.jsx(n.strong,{children:e.jsx(n.em,{children:"ONLY"})})," with Iceberg"]}),`
`,e.jsxs(n.p,{children:["We provide a custom hook ",e.jsx(n.code,{children:"useResourcesIcebergV2"})]})]})}function p(i={}){const{wrapper:n}=Object.assign({},s(),i.components);return n?e.jsx(n,Object.assign({},i,{children:e.jsx(t,i)})):t(i)}export{p as default};
