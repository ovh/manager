import{j as e}from"./jsx-runtime-BRNY0I4F.js";import{u as t}from"./index-CCRHdEqW.js";import{M as r}from"./index-ziJO4VDg.js";import"./index-Bnop-kX6.js";import"./iframe-RBN6eZbm.js";import"./index-4pTrEEYx.js";import"./index-DOoWsluG.js";import"./index-DrFu-skq.js";const o=""+new URL("dashboard-overview-Bh16JMmx.png",import.meta.url).href;function s(a){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Guidelines/React Templates/Dashboard page"}),`
...
`,e.jsxs(n.li,{children:["Uses the same ",e.jsx(n.code,{children:"baseLayout"})," component from ",e.jsx(n.code,{children:"manager-ui-kit"})]}),`
...
`,e.jsxs(n.p,{children:["Tabs outlet can contains ",e.jsx(n.code,{children:"datagrid"})," from ",e.jsx(n.code,{children:"manager-ui-kit"}),", display data with ",e.jsx(n.code,{children:"chartJS"})," components"]}),`
`]}),`
`,e.jsx(n.h3,{id:"breadcrumb",children:"BREADCRUMB"}),`
`,e.jsxs(n.p,{children:["Import the ",e.jsx(n.code,{children:"Breadcrumb"})," component from ",e.jsx(n.code,{children:"Manager UI Kit"})," and fill the attributes ",e.jsx(n.code,{children:"breadcrumb"})," of ",e.jsx(n.code,{children:"BaseLayout"})," component."]}),`
`,e.jsx(n.p,{children:"Here an exemple"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Breadcrumb, BaseLayout } from '@ovh-ux/muk';
