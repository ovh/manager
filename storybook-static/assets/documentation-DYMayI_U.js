import{j as e}from"./jsx-runtime-BRNY0I4F.js";import{u as o}from"./index-D9W7WIyf.js";import{S as a,a as i,b as l,c}from"./index-DT21l7qR.js";import{S as d}from"./index-DeW_46E-.js";import{M as h,C as p}from"./index-CkYkztty.js";import x,{ExternalLink as m}from"./link.stories-CLy5BfSk.js";import{e as s}from"./external-links-BJh_TBGD.js";import"./index-Bnop-kX6.js";import"./lib-7WI39Bnb-CLGqEc7s.js";import"./iframe-BRkcAREb.js";import"./QueryClientProvider-BPX08D6Z.js";import"./index-DnqQo6oJ.js";import"./index-4pTrEEYx.js";import"./Icon-xxQ9IRzi-ORI6lMWl.js";import"./index-CWkFp9WS-BSIT86NH.js";import"./Link-TMoA1i18-DiBAU0SL.js";import"./Text-BGoUCJU7-BjFZdlzU.js";import"./ComboboxControl-EYkaEIlI-CWYTos8A.js";import"./Divider-wQyo85oE-5vlIiwia.js";import"./index-DOoWsluG.js";import"./index-DrFu-skq.js";import"./iam.constants-CZSXEnm9.js";function r(t){const n={a:"a",em:"em",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Manager UI Kit/Components/Link/Documentation"}),`
`,e.jsx(a,{of:x}),`
`,e.jsx(p,{of:m,sourceState:"none"}),`
`,e.jsx(n.p,{children:"The pre-formatted Link is a customizable, purpose-driven link component that enhances the ODS Link by incorporating visual and functional elements such as icons"}),`
`,e.jsx(i,{label:"Overview",level:2}),`
`,e.jsx(l,{aliases:["Menu","Ellipsis Menu","Dropdown Menu"],githubUrl:s.github.Link,name:"ActionMenu",relatedComponents:[{name:"ods-link",href:s.ods.link}],children:e.jsx(n.p,{children:`Its primary role is to provide clear and intuitive navigation options (e.g.,
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"External Link"}),": clearly communicating that the user will leave the current context"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:'"Back" Link'}),": providing an option to navigate to a previous page or step"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:'"Next" Link'}),": guiding users to the next step in a process or section"]}),`
`]}),`
`,e.jsx(i,{label:"Dos & Don'ts",level:2}),`
`,e.jsx(c,{dos:["Use clear, concise labels for the Link","Use the appropriate variant with the link type (e.g., external link for external navigation)"],donts:["Do not use for inline Link where iconography adds no value","Avoid overloading a page with too many pre-formatted Link; prioritize simplicity"]}),`
...
`,e.jsx(d,{data:{columns:["key","interaction"],rows:[{key:"Tab",interaction:"Navigate to the Link"},{key:"Enter while Link is focused",interaction:"Activate the Link"}]}})]})}function P(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{P as default};
