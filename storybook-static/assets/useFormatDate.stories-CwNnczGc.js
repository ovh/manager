import{j as o}from"./jsx-runtime-BRNY0I4F.js";import{C as n,E as P}from"./manager-react-components-lib.es-DhdezO3q.js";import"./index-Bnop-kX6.js";import"./iframe-D94QFGAF.js";import"./QueryClientProvider-DbnhbVMg.js";import"./index-DUQbBcJX.js";import"./context-Cuu9iSAu.js";import"./index-D0sJu8id.js";const S=({date:h,format:b,invalidDateDisplayLabel:v})=>{const C=P({invalidDateDisplayLabel:v});return o.jsxs(o.Fragment,{children:[o.jsx("strong",{children:"Date :"})," ",C({date:h,format:b})]})},e={args:{date:new Date}},a={args:{date:new Date,format:"dd/MM/yyyy"}},t={args:{date:new Date,format:"dd/MM/yyyy HH:mm"}},r={args:{date:new Date,format:"PPpp"}},s={args:{date:"invalid-date",invalidDateDisplayLabel:"Date inconnue"}},U={title:"Manager React Components/Hooks/useFormatDate",component:S,argTypes:{invalidDateDisplayLabel:{control:"text",value:n,description:"Label used when the date is invalid or missing.",table:{defaultValue:{summary:n},type:{summary:"string"}}},date:{control:"date",description:"Date to format",table:{defaultValue:{summary:"undefined"},type:{summary:"date | string"}}},format:{control:"text",description:"Format of date expected see : https://date-fns.org/docs/format",table:{defaultValue:{summary:"PP"}}}}};var m,d,i;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    date: new Date()
  }
