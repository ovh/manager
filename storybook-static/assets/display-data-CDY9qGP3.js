import{j as e}from"./jsx-runtime-BRNY0I4F.js";import{u as r}from"./index-JTD1cOSY.js";import{M as a}from"./index-BOVma5jo.js";import"./index-Bnop-kX6.js";import"./iframe-COCNz2cq.js";import"./index-4pTrEEYx.js";import"./index-DOoWsluG.js";import"./index-DrFu-skq.js";function t(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Guidelines/Data displaying"}),`
...
`,e.jsxs(n.p,{children:["Use the ",e.jsx(n.code,{children:"Price"})," component from ",e.jsx(n.code,{children:"@ovh-ux/muk"})," for displaying prices, ",e.jsx(n.a,{href:"?path=/docs/manager-ui-kit-components-price--technical-information",children:"here"})," the documentation."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Price, OvhSubsidiary, IntervalUnitType } from '@ovh-ux/muk';
...
`,e.jsxs(n.p,{children:["Use the ",e.jsx(n.code,{children:"useFormatDate"})," hook from ",e.jsx(n.code,{children:"@ovh-ux/muk"}),` for displaying dates.
The hook leverages date-fns for formatting dates in a localized and customizable way,  `,e.jsx(n.a,{href:"?path=/docs/manager-ui-kit-hooks-useformatdate-documentation--technical-information",children:"here"})," the documentation."]}),`
`,e.jsx(n.p,{children:"Here some examples :"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { useFormatDate } from '@ovh-ux/muk';
...
<Text>{formatDate}</Text> // Displays "14 Sep 2024"
...
<Text>{formatDate}</Text> // Displays "Date inconnue"
...
`,e.jsxs(n.p,{children:["Use the ",e.jsx(n.code,{children:"Storage"})," component from ",e.jsx(n.code,{children:"@ovh-ux/muk"})," for displaying storage values:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Storage } from '@ovh-ux/muk';
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Skeleton } from from '@ovhcloud/ods-react';
...
`,e.jsxs(n.li,{children:["[ ] Use appropriate components from ",e.jsx(n.code,{children:"@ovh-ux/muk"})]}),`
