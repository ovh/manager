import{j as o}from"./jsx-runtime-CKrituN3.js";import{r as a}from"./index-CBqU2yxZ.js";import{u as p,O as l}from"./ods-notification-BO89l5nC.js";import{u as f}from"./index-DaQ_SeLH.js";const i=({clearAfterRead:e=!0})=>{const t=f(),[s]=a.useState(t),{notifications:c,clearNotifications:r}=p();return a.useEffect(()=>{e&&s.pathname!==t.pathname&&r()},[e,t.pathname]),o.jsx(o.Fragment,{children:c.map(n=>o.jsx(l,{notification:n},n.uid))})};try{i.displayName="Notifications",i.__docgenInfo={description:`This component display the list of notifications. It acts
