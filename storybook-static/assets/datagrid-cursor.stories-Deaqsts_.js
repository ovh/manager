import{j as a}from"./jsx-runtime-BRNY0I4F.js";import{r as h}from"./index-Bnop-kX6.js";import{O as Ie,a as xe}from"./index-CbA6Q3A_.js";import{d as Re,b as Fe}from"./index-PzEU9Mdi.js";import{K as ve}from"./index-CjyBN8iS.js";import{I as v,S as Ae,X as Me,d as De,g as $e,h as $,F as ke}from"./manager-react-components-lib.es-BxsITpDt.js";import{c as i,a as Ne,b as Ve,d as Oe,e as _e}from"./datagrid.mock-wAuOak7N.js";import"./index-D0sJu8id.js";import"./ods-toggle2-B9ijeUZX.js";import"./iframe-Ufz7B27p.js";import"./QueryClientProvider-DbnhbVMg.js";import"./index-D1HcsAmU.js";import"./context-Cuu9iSAu.js";const s=10,k=3,r=e=>{const[n,R]=h.useState(),[t,c]=h.useState(e.items),[A]=De(),{filters:x,addFilter:de,removeFilter:Se}=$e(),[M,be]=h.useState(""),[fe,ye]=h.useState({}),we=()=>{const o=t==null?void 0:t.length,l=[...Array(s).keys()].map((g,F)=>({label:`Item #${F+o}`,price:Math.floor(1+Math.random()*100)}));c(g=>[...g,...l])},Pe=()=>{const o=t==null?void 0:t.length,l=[...Array(s*k-o).keys()].map((g,F)=>({label:`Item #${F+o}`,price:Math.floor(1+Math.random()*100)}));c(g=>[...g,...l])},D=h.useMemo(()=>{var o;return(o=e==null?void 0:e.columns)==null?void 0:o.find(l=>Object.prototype.hasOwnProperty.call(l,"isSearchable"))},[i]),Ce=o=>{if(D){const l=$(e.items,!o||o.length===0?x:[{key:D.id,value:M,comparator:ke.Includes},...x]);c(l)}};return a.jsxs(a.Fragment,{children:[`${A}`&&a.jsxs(a.Fragment,{children:[a.jsxs("pre",{children:["Search params: ?",`${A}`]}),a.jsx(Ie,{})]}),a.jsx(v,{items:$(t,x),columns:e.columns,hasNextPage:(t==null?void 0:t.length)&&t.length<k*s,onFetchNextPage:we,onFetchAllPages:Pe,totalItems:t==null?void 0:t.length,filters:{filters:x,add:de,remove:Se},columnVisibility:e.columnVisibility,onColumnVisibilityChange:e.onColumnVisibilityChange,topbar:e.topbar,isLoading:e.isLoading,...e.search?{search:{searchInput:M,setSearchInput:be,onSearch:Ce}}:{},getRowCanExpand:e.getRowCanExpand,renderSubComponent:e.renderSubComponent,...e.isSortable?{sorting:n,onSortChange:R,manualSorting:!1}:{},rowSelection:e.rowSelection?{rowSelection:fe,setRowSelection:ye,enableRowSelection:e.enableRowSelection,onToggleAllRowsSelection:e.onToggleAllRowsSelection,onRowSelectionChange:e.onRowSelectionChange}:void 0})]})},p=r.bind({});p.args={columns:i,items:[...Array(s).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100)})),totalItems:20,isSortable:!1,onFetchNextPage:!0};const u=r.bind({});u.args={columns:i,items:[]};const d=r.bind({});d.args={columns:i,items:[],isLoading:!0};const S=r.bind({});S.args={columns:i,items:[...Array(s).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100)})),isSortable:!0};const ze={id:"actions",cell:e=>e.actions,label:""},b=r.bind({});b.args={columns:[...i,ze],items:[...Array(s).keys()].map((e,n)=>({label:`Service #${n}`,price:Math.floor(1+Math.random()*100),actions:a.jsx("div",{className:"flex items-center justify-center",children:a.jsx("div",{children:a.jsx(Ae,{isCompact:!0,variant:Re.ghost,id:n.toString(),items:[{id:1,target:"_blank",label:"Action 1",urn:"urn:v9:eu:resource:manatestkds-fdsfsd",iamActions:["vrackServices:apiovh:iam/resource/update"]},{id:2,target:"_blank",label:"Action 2",urn:"urn:v9:eu:resource:manate",iamActions:["vrackServices:apiovh:iam/resource/delete"]}]})})})})),isSortable:!0};const f=r.bind({});f.args={items:[...Array(s).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100)})),columns:Ne};const y=r.bind({});y.args={items:[...Array(s).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100),iam:{id:"test",urn:"urn:v9:eu:resource:manatestkds-fdsfsd",tags:{key1:`tag-1-${n}`,key2:`tag-2-${n}`,[n]:"value-test"}}})),columns:Ve};const w=r.bind({});w.args={items:[...Array(s).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100)})),columns:Oe,onColumnVisibilityChange:void 0};const P=r.bind({}),Te=()=>a.jsx(xe,{label:"Add item",icon:Fe.plus});P.args={items:[...Array(s).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100),status:`Status #${n}`,anotherStatus:`AnotherStatus #${n}`})),columns:_e,search:{searchInput:"",setSearchInput:()=>{},onSearch:()=>{}},topbar:a.jsx(Te,{}),onColumnVisibilityChange:void 0};const m=r.bind({});m.args={columns:i,items:[...Array(s).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100)})),rowSelection:!0,enableRowSelection:e=>e.original.price>50,onRowSelectionChange:()=>{}};m.argTypes={rowSelection:{description:`this control does not exist on datagrid and simulate the use rowSelection Datagrid prop with the attributes rowSelection and setRowSelection which is a state manage by the parent component.
    ...
    `}),a.jsx(v,{columns:R,items:[{label:"sub component label",price:10,status:"",anotherStatus:"",iam:{}},{label:"sub component label #2",price:100,status:"",anotherStatus:"",iam:{}}],totalItems:2,hideHeader:!0,tableLayoutFixed:!0})]})}};const Ye={title:"Manager React Components/Components/Datagrid Cursor",component:v,decorators:[ve]};var N,V,O;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`args => {
...
}`,...(O=(V=p.parameters)==null?void 0:V.docs)==null?void 0:O.source}}};var _,z,T;u.parameters={...u.parameters,docs:{...(_=u.parameters)==null?void 0:_.docs,source:{originalSource:`args => {
  const [sorting, setSorting] = useState<ColumnSort>();
  const [data, setData] = useState(args.items);
  const [searchParams] = useSearchParams();
  const {
...
}`,...(L=(j=d.parameters)==null?void 0:j.docs)==null?void 0:L.source}}};var W,B,X;S.parameters={...S.parameters,docs:{...(W=S.parameters)==null?void 0:W.docs,source:{originalSource:`args => {
  const [sorting, setSorting] = useState<ColumnSort>();
  const [data, setData] = useState(args.items);
  const [searchParams] = useSearchParams();
  const {
...
}`,...(X=(B=S.parameters)==null?void 0:B.docs)==null?void 0:X.source}}};var K,H,J;b.parameters={...b.parameters,docs:{...(K=b.parameters)==null?void 0:K.docs,source:{originalSource:`args => {
  const [sorting, setSorting] = useState<ColumnSort>();
  const [data, setData] = useState(args.items);
  const [searchParams] = useSearchParams();
  const {
...
}`,...(G=(q=f.parameters)==null?void 0:q.docs)==null?void 0:G.source}}};var Q,Y,Z;y.parameters={...y.parameters,docs:{...(Q=y.parameters)==null?void 0:Q.docs,source:{originalSource:`args => {
  const [sorting, setSorting] = useState<ColumnSort>();
  const [data, setData] = useState(args.items);
  const [searchParams] = useSearchParams();
  const {
...
}`,...(Z=(Y=y.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,ne,ae;w.parameters={...w.parameters,docs:{...(ee=w.parameters)==null?void 0:ee.docs,source:{originalSource:`args => {
  const [sorting, setSorting] = useState<ColumnSort>();
  const [data, setData] = useState(args.items);
  const [searchParams] = useSearchParams();
  const {
...
}`,...(ue=(pe=I.parameters)==null?void 0:pe.docs)==null?void 0:ue.source}}};const Ze=["Basic","Empty","Loading","Sortable","WithActions","Filters","FiltersWithTags","Visibility","Topbar","RowSelection","WithSubComponent","WithDatagridSubComponent"];export{p as Basic,u as Empty,f as Filters,y as FiltersWithTags,d as Loading,m as RowSelection,S as Sortable,P as Topbar,w as Visibility,b as WithActions,I as WithDatagridSubComponent,C as WithSubComponent,Ze as __namedExportsOrder,Ye as default};
