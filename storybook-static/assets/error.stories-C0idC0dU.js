import{j as s}from"./jsx-runtime-BRNY0I4F.js";import{c as a}from"./lib-CWaID5dp-DE0boNln.js";import"./index-Bnop-kX6.js";import"./iframe-ClZwXGXb.js";import"./index-4pTrEEYx.js";import"./index-C2BvAoka.js";const l={error:{}},x={error:{status:404}},f={error:{status:401,data:{message:"[serviceId] Given data (undefined) is not valid for type long"},headers:{"x-ovh-queryid":"123456789"}}},W={title:"Manager UI Kit/Components/Errors",decorators:[g=>s.jsx("div",{children:g()})],component:a,tags:["autodocs"],argTypes:{},args:l,parameters:{layout:"centered"}},r=()=>s.jsx(a,{...l});r.parameters={docs:{source:{code:"<Error error={{}} />"}}};const e=()=>s.jsx(a,{...x});e.parameters={docs:{source:{code:`<Error 
  error={{
    status: 404,
  }} 
