...
}`,...(W=(B=d.parameters)==null?void 0:B.docs)==null?void 0:W.source}}};var U,Z,q;m.parameters={...m.parameters,docs:{...(U=m.parameters)==null?void 0:U.docs,source:{originalSource:`(args: DatagridProps<DatagridStoryData>) => {
  const [sorting, setSorting] = useState<SortingState>([]);
  const [searchInput, setSearchInput] = useState('');
  const sortAttrs = {
    sorting,
...
}`,...(q=(Z=m.parameters)==null?void 0:Z.docs)==null?void 0:q.source}}};var G,Q,X;u.parameters={...u.parameters,docs:{...(G=u.parameters)==null?void 0:G.docs,source:{originalSource:`(args: DatagridProps<DatagridStoryData>) => {
  const [sorting, setSorting] = useState<SortingState>([]);
  const [searchInput, setSearchInput] = useState('');
  const sortAttrs = {
    sorting,
...
}`,...(jn=(On=v.parameters)==null?void 0:On.docs)==null?void 0:jn.source}}};const wt=["Default","Size","Variant","Sorting","Loading","LoadMore","LoadAllAndLoading","SubComponent","Expandable","VisibilityColumns","Filtering","Search","RowSelection","HideHeader","Topbar","TotalCount","ResourceType","FullFooter"];export{g as Default,b as Expandable,y as Filtering,v as FullFooter,A as HideHeader,S as LoadAllAndLoading,p as LoadMore,h as Loading,C as ResourceType,w as RowSelection,f as Search,d as Size,u as Sorting,x as SubComponent,F as Topbar,H as TotalCount,m as Variant,I as VisibilityColumns,wt as __namedExportsOrder,ft as default};
