...
`,n.jsx(s,{data:{columns:["key","interaction"],rows:[{key:"Tab",interaction:"Focus on the Action Menu trigger element. Can move forward through the list of actions and focus on one of them"},{key:"Enter or Space while Action Menu is focused",interaction:"List of actions will be displayed"},{key:"Enter or Space while an action is focused",interaction:"Trigger the expected behavior from the selected action and close the Action Menu"},{key:"Escape",interaction:"Close the Action Menu"}]}})]})}function ln(o={}){const{wrapper:e}={...a(),...o.components};return e?n.jsx(e,{...o,children:n.jsx(r,{...o})}):r(o)}export{ln as default};
