...
import { useState } from 'react';`},parameters:{docs:{source:{...r()}}},tags:["!dev"],render:({})=>{const[a,s]=V.useState([30,70]);return e.jsxs(j,{children:[e.jsx(S,{id:"range-label",children:"Price range"}),e.jsxs(de,{"aria-live":"polite",id:"range-sublabel",preset:ce.caption,children:["Selected values: ",a[0]," - ",a[1],"€"]}),e.jsx(n,{"aria-labelledby":["range-label","range-sublabel"],onDragging:({value:h})=>s(h),value:a})]})}};var C,T,w;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
