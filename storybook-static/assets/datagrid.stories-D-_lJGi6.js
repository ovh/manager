import{j as a}from"./jsx-runtime-BRNY0I4F.js";import{K as O}from"./index-BIUBuyTh.js";import{E as z,L as W,e as N,n as q,i as G,j as H}from"./manager-react-components-lib.es-XHmROoQx.js";import{c as l,a as Q}from"./datagrid.mock-D3tg5wjE.js";import"./index-Bnop-kX6.js";import"./iframe-AYzKZ5zH.js";import"./QueryClientProvider-BkgfFh-U.js";import"./index-BA2H_d3W.js";import"./context-BVP_XnaJ.js";import"./index-D0sJu8id.js";import"./index-PzEU9Mdi.js";function U(e,n){if(!n)return e;const p=n.desc?-1:1;return n.id==="label"?e.sort((t,s)=>p*t.label.localeCompare(s.label)):n.id==="price"?e.sort((t,s)=>p*(t.price-s.price)):e}const d=({items:e,isPaginated:n,isSortable:p,isLoading:t=!1,columns:s=l,getRowCanExpand:j,renderSubComponent:M})=>{const[u]=N(),{pagination:c,setPagination:T,sorting:S,setSorting:_}=q({id:"validityTo",desc:!1}),h=n?c.pageIndex*c.pageSize:0,J=n?h+c.pageSize:e.length,X=n&&{pagination:c,onPaginationChange:T},k=p&&{sorting:S,onSortChange:_},{filters:b,addFilter:B,removeFilter:K}=G();return a.jsxs(a.Fragment,{children:[`${u}`&&a.jsxs(a.Fragment,{children:[a.jsxs("pre",{children:["Search params: ?",`${u}`]}),a.jsx("hr",{})]}),a.jsx(z,{columns:s,items:H(U(e,S).slice(h,J),b),totalItems:e.length,isLoading:t,...X,...k,filters:{filters:b,add:B,remove:K},getRowCanExpand:j,renderSubComponent:M})]})},o=d.bind({});o.args={columns:l,items:[...Array(50).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100)})),isPaginated:!0,isSortable:!0};const r=d.bind({});r.args={columns:l,items:[],isLoading:!0};const i=d.bind({});i.args={columns:l,items:[...Array(8).keys()].map((e,n)=>({label:`Service #${n}`,price:Math.floor(1+Math.random()*100)})),isSortable:!0};const g=d.bind({});g.args={items:[...Array(50).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100)})),isPaginated:!0,isSortable:!0,columns:Q};const m=d.bind({});m.args={columns:l,items:[...Array(10).keys()].map((e,n)=>({label:`Item #${n}`,price:Math.floor(1+Math.random()*100)})),getRowCanExpand:()=>!0,renderSubComponent:e=>a.jsx(W,{children:JSON.stringify(e.original)})};const mn={title:"Manager React Components/Components/Datagrid Paginated",component:z,decorators:[O],parameters:{status:{type:"deprecated"},docs:{description:{component:"The `Datagrid` component in pagination mode is now `deprecated`. Please switch to the cursor navigation mode"}}}};var P,C,f;o.parameters={...o.parameters,docs:{...(P=o.parameters)==null?void 0:P.docs,source:{originalSource:`({
  items,
  isPaginated,
  isSortable,
  isLoading = false,
...
}`,...(v=(I=g.parameters)==null?void 0:I.docs)==null?void 0:v.source}}};var L,$,D;m.parameters={...m.parameters,docs:{...(L=m.parameters)==null?void 0:L.docs,source:{originalSource:`({
  items,
  isPaginated,
  isSortable,
  isLoading = false,
...
}`,...(D=($=m.parameters)==null?void 0:$.docs)==null?void 0:D.source}}};const ln=["Basic","Loading","Sortable","Filters","WithSubComponent"];export{o as Basic,g as Filters,r as Loading,i as Sortable,m as WithSubComponent,ln as __namedExportsOrder,mn as default};
