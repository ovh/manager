...
}`,...(x=(b=s.parameters)==null?void 0:b.docs)==null?void 0:x.source}}};var N,h,F;i.parameters={...i.parameters,docs:{...(N=i.parameters)==null?void 0:N.docs,source:{originalSource:`args => {
  const [, updateArgs] = useArgs();
  return <TilesInputGroupComponent<TCountry, string, {
    continent: string;
    key: string;
...
}`,...(F=(h=i.parameters)==null?void 0:h.docs)==null?void 0:F.source}}};const Mn=["LanguagesEnum","ContinentsEnum","allCountries","DemoSimple","DemoStack","DemoGroup","DemoGroupStack"];export{O as ContinentsEnum,s as DemoGroup,i as DemoGroupStack,r as DemoSimple,o as DemoStack,G as LanguagesEnum,Mn as __namedExportsOrder,a as allCountries,On as default};
