import{j as t}from"./jsx-runtime-BRNY0I4F.js";import{r as I}from"./index-Bnop-kX6.js";import{b as oe,c as ce}from"./index-vm89uYmh.js";import{O as ie,a as le}from"./index-C7RZ_VRQ.js";import{K as me,u as pe}from"./index-DJAo1xlC.js";import{D as x,a as he}from"./datagrid.component-BFJ5vDX6.js";import{u as de,a as D,F as ue}from"./useColumnFilters-DGJVzBm2.js";import{c as r,a as ge,b as Se}from"./datagrid.mock-BQoU64uf.js";import"./card.component-C1_2bJfS.js";import{A as be}from"./action.component-CL6APHGo.js";import"./guide.component-BdJJ292a.js";import"./changelog.component-DirU89AS.js";import"./index-4pTrEEYx.js";import"./index-DHSIHcaZ.js";import"./clsx-B-dksMZM.js";import"./useTranslation-I4D8sCWp.js";import"./i18next-DdipboBq.js";import"./title.component-ucIeg-_K.js";import"./links.component-DBbFpAyB.js";import"./translation-Bzcle6L7.js";import"./ManagerButton-BJqNRrkz.js";import"./useOvhIam-4UIu5qrD.js";import"./QueryClientProvider-Y_fKerI5.js";import"./useOvhTracking-DR3F_7di.js";const s=e=>{const[a,P]=I.useState(),[n,c]=I.useState(e.items),[y]=pe(),{filters:f,addFilter:ee,removeFilter:ae}=de(),[C,te]=I.useState(""),ne=()=>{const o=n==null?void 0:n.length,i=[...Array(10).keys()].map((v,se)=>({label:`Item #${se+o}`,price:Math.floor(1+Math.random()*100)}));c(v=>[...v,...i])},F=I.useMemo(()=>{var o;return(o=e==null?void 0:e.columns)==null?void 0:o.find(i=>Object.prototype.hasOwnProperty.call(i,"isSearchable"))},[r]),re=o=>{if(F){const i=D(e.items,!o||o.length===0?f:[{key:F.id,value:C,comparator:ue.Includes},...f]);c(i)}};return t.jsxs(t.Fragment,{children:[`${y}`&&t.jsxs(t.Fragment,{children:[t.jsxs("pre",{children:["Search params: ?",`${y}`]}),t.jsx(oe,{})]}),t.jsx(x,{items:D(n,f),columns:e.columns,hasNextPage:(n==null?void 0:n.length)>0&&n.length<30,onFetchNextPage:ne,totalItems:n==null?void 0:n.length,filters:{filters:f,add:ee,remove:ae},topbar:e.topbar,isLoading:e.isLoading,...e.search?{search:{searchInput:C,setSearchInput:te,onSearch:re}}:{},getRowCanExpand:e.getRowCanExpand,renderSubComponent:e.renderSubComponent,...e.isSortable?{sorting:a,onSortChange:P,manualSorting:!1}:{}})]})},l=s.bind({});l.args={columns:r,items:[...Array(10).keys()].map((e,a)=>({label:`Item #${a}`,price:Math.floor(1+Math.random()*100)})),totalItems:20,isSortable:!1,onFetchNextPage:!0};const m=s.bind({});m.args={columns:r,items:[]};const p=s.bind({});p.args={columns:r,items:[],isLoading:!0};const h=s.bind({});h.args={columns:r,items:[...Array(10).keys()].map((e,a)=>({label:`Item #${a}`,price:Math.floor(1+Math.random()*100)})),isSortable:!0};const fe={id:"actions",cell:e=>e.actions,label:""},d=s.bind({});d.args={columns:[...r,fe],items:[...Array(8).keys()].map((e,a)=>({label:`Service #${a}`,price:Math.floor(1+Math.random()*100),actions:t.jsx("div",{className:"flex items-center justify-center",children:t.jsx("div",{children:t.jsx(be,{isCompact:!0,variant:ie.ghost,id:a.toString(),items:[{id:1,target:"_blank",label:"Action 1",urn:"urn:v9:eu:resource:manatestkds-fdsfsd",iamActions:["vrackServices:apiovh:iam/resource/update"]},{id:2,target:"_blank",label:"Action 2",urn:"urn:v9:eu:resource:manate",iamActions:["vrackServices:apiovh:iam/resource/delete"]}]})})})})),isSortable:!0};const u=s.bind({});u.args={items:[...Array(10).keys()].map((e,a)=>({label:`Item #${a}`,price:Math.floor(1+Math.random()*100)})),columns:ge};const g=s.bind({}),Ie=()=>t.jsx(ce,{label:"Add item",icon:le.plus});g.args={items:[...Array(10).keys()].map((e,a)=>({label:`Item #${a}`,price:Math.floor(1+Math.random()*100)})),columns:Se,search:{searchInput:"",setSearchInput:()=>{},onSearch:()=>{}},topbar:t.jsx(Ie,{})};const S=s.bind({});S.args={columns:r,items:[...Array(10).keys()].map((e,a)=>({label:`Item #${a}`,price:Math.floor(1+Math.random()*100)})),getRowCanExpand:()=>!0,renderSubComponent:e=>t.jsx(he,{children:JSON.stringify(e.original)})};const b=s.bind({});b.args={columns:r,items:[...Array(10).keys()].map((e,a)=>({label:`Item #${a}`,price:Math.floor(1+Math.random()*100)})),getRowCanExpand:()=>!0,renderSubComponent:(e,a)=>{const P=r.map(c=>({...c,size:a.current[c.id].clientWidth}));return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
    ...
    `}),t.jsx(x,{columns:P,items:[{label:"sub component label",price:10},{label:"sub component label #2",price:100}],totalItems:2,hideHeader:!0,tableLayoutFixed:!0})]})}};const Ge={title:"Components/Datagrid Cursor",component:x,decorators:[me]};var M,N,w;l.parameters={...l.parameters,docs:{...(M=l.parameters)==null?void 0:M.docs,source:{originalSource:`args => {
...
}`,...(Z=(Y=b.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};const He=["Basic","Empty","Loading","Sortable","WithActions","Filters","Topbar","WithSubComponent","WithDatagridSubComponent"];export{l as Basic,m as Empty,u as Filters,p as Loading,h as Sortable,g as Topbar,d as WithActions,b as WithDatagridSubComponent,S as WithSubComponent,He as __namedExportsOrder,Ge as default};
