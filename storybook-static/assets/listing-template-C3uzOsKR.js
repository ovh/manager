import{j as e}from"./jsx-runtime-BRNY0I4F.js";import{u as s}from"./index-g6nCrg6v.js";import{M as t}from"./index-CFQnl7m9.js";import"./index-Bnop-kX6.js";import"./iframe-CaW5sJsF.js";import"./index-4pTrEEYx.js";import"./index-DOoWsluG.js";import"./index-DrFu-skq.js";const o=""+new URL("listing-actions-DrDD_OS1.png",import.meta.url).href,c=""+new URL("listing-headers-BCMbmhZ9.png",import.meta.url).href,a=""+new URL("listing-cta-pCi5eUVW.png",import.meta.url).href;function r(i){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Guidelines/React Templates/Listing page"}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"useResourcesIcebergV6"})," (by default), ",e.jsx(n.a,{href:"?path=/docs/manager-ui-kit-hooks-useresourcesicebergv6--technical-information",children:"documentation"})," :"]}),`
...
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"useResourcesV6"})," ",e.jsx(n.a,{href:"?path=/docs/manager-ui-kit-hooks-useresourcesv6--technical-information",children:"documentation"})," :"]}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"useResourcesIcebergV2"})," ",e.jsx(n.a,{href:"?path=/docs/manager-ui-kit-hooks-useresourcesicebergv2--technical-information",children:"documentation"})," :",`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.p,{children:["When you want to trigger action from a service, you can use ",e.jsx(n.code,{children:"ActionMenu"})," component from ",e.jsx(n.code,{children:"manager-ui-kit"})]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { ActionMenu } from '@ovh-ux/muk';
...
`,e.jsxs(n.p,{children:["In case of API V6 or V2, response error for the main request, app will be display ",e.jsx(n.code,{children:"ErrorBanner"})," from ",e.jsx(n.code,{children:"manager-ui-kit"}),"."]}),`
...
`,e.jsxs(n.p,{children:["The CTA button is alway at datagrid top left, you need to fill ",e.jsx(n.code,{children:"topbar"})," attributes of ",e.jsx(n.code,{children:"datagrid"})," component from ",e.jsx(n.code,{children:"manager-ui-kit"})]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["[ ] Use ",e.jsx(n.code,{children:"BaseLayout"})," Component from ",e.jsx(n.code,{children:"manager-ui-kit"})]}),`
