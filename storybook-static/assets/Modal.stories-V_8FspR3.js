...
>
  <div>Example of content</div>
</Modal>`}}};t.args={...r,...d,...H};const a=p.bind({});a.parameters={controls:{include:["step"]},docs:{source:{code:`<Modal
  heading="Example of modal"
  open={true}
  step={{
    current: 1,
...
>
  <div>Example of content</div>
</Modal>`}}};a.args={...r,...d,...D};const i=p.bind({});i.args={...r,...A,...d,...J,...D};const Hn={title:"Manager UI Kit/Components/Modal",component:_,tags:["autodocs"]};var m,u,g;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`({
  heading,
...
}`,...(v=(E=i.parameters)==null?void 0:E.docs)==null?void 0:v.source}}};const Jn=["Basic","Actions","Type","Loading","Step","Full"];export{e as Actions,n as Basic,i as Full,t as Loading,a as Step,o as Type,Jn as __namedExportsOrder,Hn as default};
