...
}`,...(c=(d=s.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};var u,m,O;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`(props: UpdateNameModalProps) => {
  const [isOpen, setIsOpen] = useState(props.isOpen);
  const handleOpenChange = useCallback(() => {
    setIsOpen(!isOpen);
  }, [isOpen]);
...
}`,...(O=(m=r.parameters)==null?void 0:m.docs)==null?void 0:O.source}}};const U=["UpdateNameModalDefault","UpdateNameModalWithError"];export{s as UpdateNameModalDefault,r as UpdateNameModalWithError,U as __namedExportsOrder,b as default};
