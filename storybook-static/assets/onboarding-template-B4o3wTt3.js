import{j as e}from"./jsx-runtime-BRNY0I4F.js";import{u as i}from"./index-BfqaEpqY.js";import{M as t}from"./index-BxLe8RGf.js";import"./index-Bnop-kX6.js";import"./iframe-lMOw8NAl.js";import"./index-4pTrEEYx.js";import"./index-DOoWsluG.js";import"./index-DrFu-skq.js";const s=""+new URL("onboarding-flow-D0mxfsrf.png",import.meta.url).href;function r(o){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...i(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Guidelines/React Templates/Onboarding page"}),`
...
`,e.jsxs(n.p,{children:["The onboarding page uses the ",e.jsx(n.code,{children:"OnboardingLayout"})," component from ",e.jsx(n.code,{children:"manager-ui-kit"})," as its main container. This provides consistent styling and structure across the application."]}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { OnboardingLayout, LinkCard } from '@ovh-ux/muk';
...
`,e.jsx(n.li,{children:"[ ] TrackClick - LinkCard external links"}),`
`]}),`
`,e.jsx(n.h3,{id:"code-review-checklist",children:"Code Review Checklist"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["[ ] Use ",e.jsx(n.code,{children:"OnboardingLayout"})," component from ",e.jsx(n.code,{children:"manager-ui-kit"})]}),`
`,e.jsxs(n.li,{children:["[ ] Use ",e.jsx(n.code,{children:"LinkCard"})," component from ",e.jsx(n.code,{children:"manager-ui-kit"})]}),`
...
`]})]})}function x(o={}){const{wrapper:n}={...i(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(r,{...o})}):r(o)}export{x as default};
