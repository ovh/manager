...
`,e.jsx(d,{data:{columns:["key","interaction"],rows:[{key:"Tab",interaction:"Move focus to the edit/add tags link"},{key:"Enter",interaction:"Activate the edit/add tags link when focused"},{key:"Arrow Keys",interaction:"Navigate through scrollable tag list when focused"}]}})]})}function H(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{H as default};
