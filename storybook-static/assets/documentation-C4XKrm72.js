...
`,e.jsxs(a,{aliases:["Dashboard Tile","Manager Tile"],githubUrl:o.github.tile,name:"Tile",relatedComponents:[{name:"Card",href:o.ods.card},{name:"Text",href:o.ods.text},{name:"Divider",href:o.ods.divider},{name:"Section",href:o.nativeElements.section},{name:"Description List",href:o.nativeElements.descriptionList}],children:[e.jsx(i.p,{children:"It facilitates:"}),e.jsxs(i.ul,{children:[`
...
`]})]})}function ge(t={}){const{wrapper:i}={...s(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(r,{...t})}):r(t)}export{ge as default};
