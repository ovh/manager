import{j as e}from"./jsx-runtime-BRNY0I4F.js";import{a as n}from"./ods-react236-aAAP9SXj.js";import{a as C}from"./MessageIcon-yhpEHWAg-CXHPnT2G.js";import{Y as s}from"./lib-D44cvI9Y-BwqRLB_Z.js";import"./index-Bnop-kX6.js";import"./index-2w0W-O47-BJ19ihbZ.js";import"./Icon-DrfG5m-t-DQEf1CkA.js";import"./ods-react60-0db41gCx.js";import"./iframe-Bmn67lXx.js";import"./QueryClientProvider-BPX08D6Z.js";import"./with-selector-CbDTc_Tw.js";import"./index-4pTrEEYx.js";import"./Link-BWQEuWpd-B5_veLQO.js";import"./Text-CcNd6qQr-D2KuMUPS.js";import"./ComboboxControl-sJOkWHeT-DJbuE-Pm.js";import"./Divider-THit99OS-BLm7oKDW.js";const o={args:{message:"This is a test message. <strong>This message is in bold.</strong>",variant:C.default,color:n.information,dismissible:!0},parameters:{docs:{source:{code:`<ActionBanner
  message="This is a test message. <strong>This message is in bold.</strong>"
  color={MESSAGE_COLOR.information}
  dismissible={true}
/>`}}}},y={title:"Manager UI Kit/Components/Action Banner",component:s,tags:["autodocs"]},r={decorators:[h=>e.jsx("div",{style:{display:"inline-flex",flexFlow:"column",gap:"8px"},children:h()})],render:()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{message:"Critical message",color:n.critical}),e.jsx(s,{message:"Danger message",color:n.danger}),e.jsx(s,{message:"Information message",color:n.information}),e.jsx(s,{message:"Success message",color:n.success}),e.jsx(s,{message:"Warning message",color:n.warning})]})},a={title:"Manager UI Kit/Components/ActionBanner",args:{...o.args,label:"Click Me!",onClick:()=>{}},component:s},t={title:"Manager UI Kit/Components/ActionBanner",args:{...o.args,label:"Click Me!",href:"https://www.ovhcloud.com/"},component:s};var i,c,m;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    message: 'This is a test message. <strong>This message is in bold.</strong>',
...
/>\`
  ...
  component: ActionBanner
}`,...(B=(S=t.parameters)==null?void 0:S.docs)==null?void 0:B.source}}};const D=["Default","ActionBannerWithMessageVariants","ActionBannerWithButton","ActionBannerWithLink"];export{a as ActionBannerWithButton,t as ActionBannerWithLink,r as ActionBannerWithMessageVariants,o as Default,D as __namedExportsOrder,y as default};
