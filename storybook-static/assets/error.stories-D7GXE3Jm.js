import{j as s}from"./jsx-runtime-BRNY0I4F.js";import{x as a}from"./lib-sJyaz0Xv-BlWaqhkt.js";import"./index-Bnop-kX6.js";import"./iframe-C-_YPmA_.js";import"./QueryClientProvider-C1FTVqK-.js";import"./index-ChsYPcXR.js";import"./index-4pTrEEYx.js";const l={error:{}},g={error:{status:404}},f={error:{status:401,data:{message:"[serviceId] Given data (undefined) is not valid for type long"},headers:{"x-ovh-queryid":"123456789"}}},I={title:"Manager UI Kit/Components/Errors",decorators:[x=>s.jsx("div",{children:x()})],component:a,tags:["autodocs"],argTypes:{},args:l,parameters:{layout:"centered"}},r=()=>s.jsx(a,{...l});r.parameters={docs:{source:{code:"<Error error={{}} />"}}};const e=()=>s.jsx(a,{...g});e.parameters={docs:{source:{code:`<Error 
  error={{
    status: 404,
  }} 
