...
`,e.jsx(c,{data:{columns:["key","interaction"],rows:[{key:"Tab",interaction:"Move between interactive elements (Input, Buttons"},{key:"Enter or Space while Action Menu is focused",interaction:"Activate the focused Button"},{key:"Escape",interaction:"Dismiss the modal"}]}})]})}function fe(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(o,{...s})}):o(s)}export{fe as default};
