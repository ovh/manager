import{j as e}from"./jsx-runtime-BRNY0I4F.js";import{u as a}from"./index-CUIskjj6.js";import{M as s}from"./index-BRK_XPYQ.js";import"./index-Bnop-kX6.js";import"./iframe-Bmn67lXx.js";import"./index-4pTrEEYx.js";import"./index-DOoWsluG.js";import"./index-DrFu-skq.js";function o(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Guidelines/React Templates/Modal Templates"}),`
`,e.jsx(n.h1,{id:"how-to-implement-modal",children:"How to implement Modal"}),`
`,e.jsxs(n.p,{children:["This guide explains how to implement different types of modals in the OVHcloud Manager using the ",e.jsx(n.code,{children:"@ovh-ux/muk"})," library."]}),`
...
<Route path=":id/modal" element={<ResourceModal />} />
`})}),`
`,e.jsx(n.h2,{id:"modal-from-manager-ui-kit",children:"Modal from manager-ui-kit"}),`
`,e.jsx(n.p,{children:"The Modal component provides a consistent interface for displaying modal dialogs. Here's how to use it:"}),`
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"?path=/docs/manager-ui-kit-components-modal-documentation--technical-information",children:"Here"}),", the component"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Modal } from '@ovh-ux/muk';
import { Link, ICON_NAME, MODAL_COLOR } from '@ovhcloud/ods-react';
...
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"?path=/story/manager-ui-kit-templates-update-name-modal--update-name-modal",children:"Here"}),", the component"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { UpdateNameModal } from '@ovh-ux/muk';
...
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"?path=/story/manager-ui-kit-templates-delete-modal--delete-modal",children:"Here"}),", the component"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Modal } from '@ovh-ux/muk';
