...
`,e.jsx(a,{aliases:["Rename Modal","Edit Name Modal"],githubUrl:i.github.updateNameModal,name:"Update Name Modal",relatedComponents:[{name:"ods-button",href:i.ods.button},{name:"ods-form-field",href:i.ods.formField},{name:"ods-message",href:i.ods.message},{name:"ods-modal",href:i.ods.modal},{name:"ods-input",href:i.ods.input},{name:"ods-text",href:i.ods.text}],children:e.jsx(n.p,{children:"It uses ODS Modal from OVHcloud Design System."})}),`
...
`,e.jsx(t,{label:"Api Service",level:2}),`
...
`,e.jsx(c,{data:{columns:["key","interaction"],rows:[{key:"Tab",interaction:"Move between interactive elements (Input, Buttons)"},{key:"Enter or Space while Action Menu is focused",interaction:"Activate the focused Button"},{key:"Escape",interaction:"Dismiss the modal"}]}})]})}function fe(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(o,{...s})}):o(s)}export{fe as default};
