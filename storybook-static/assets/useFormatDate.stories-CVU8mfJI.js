import{j as o}from"./jsx-runtime-BRNY0I4F.js";import{O as n,t as S}from"./manager-react-components-lib.es-BMosqPZd.js";import"./index-Bnop-kX6.js";import"./iframe-Rtr6Tjyu.js";import"./QueryClientProvider-DbnhbVMg.js";import"./index--O_fOgGV.js";import"./context-Cuu9iSAu.js";import"./index-D0sJu8id.js";const H=({date:v,format:b,invalidDateDisplayLabel:h})=>{const P=S({invalidDateDisplayLabel:h});return o.jsxs(o.Fragment,{children:[o.jsx("strong",{children:"Date :"})," ",P({date:v,format:b})]})},e={args:{date:new Date}},a={args:{date:new Date,format:"dd/MM/yyyy"}},t={args:{date:new Date,format:"dd/MM/yyyy HH:mm"}},r={args:{date:new Date,format:"PPpp"}},s={args:{date:"invalid-date",invalidDateDisplayLabel:"Date inconnue"}},R={title:"Manager React Components/Hooks/useFormatDate",component:H,argTypes:{invalidDateDisplayLabel:{control:"text",value:n,description:"Label used when the date is invalid or missing.",table:{defaultValue:{summary:n},type:{summary:"string"}}},date:{control:"date",description:"Date to format",table:{defaultValue:{summary:"undefined"},type:{summary:"date | string"}}},format:{control:"text",description:"Format of date expected see : https://date-fns.org/docs/format",table:{defaultValue:{summary:"PP"}}}}};var m,d,i;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    date: new Date()
  }
...
}`,...(M=(F=s.parameters)==null?void 0:F.docs)==null?void 0:M.source}}};const U=["Default","CustomFormat","WithTime","FullDateTime","UnknownDate"];export{a as CustomFormat,e as Default,r as FullDateTime,s as UnknownDate,t as WithTime,U as __namedExportsOrder,R as default};
