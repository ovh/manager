angular.module('Module.exchange.controllers').controller(
  'ExchangeRemoveManagerCtrl',
  class ExchangeRemoveManagerCtrl {
    ...
    submit() {
      ...
      this.services.Exchange.removeManager(
        ...
        .then((success) => {
          this.services.messaging.writeSuccess(
            this.services.$translate.instant('exchange_GROUPS_remove_manager_success_message', {
        ...
        .catch((failure) => {
          this.services.messaging.writeError(
            this.services.$translate.instant('exchange_GROUPS_remove_manager_error_message', {
              t0: this.manager.primaryEmailAddress,
              t1: this.group.mailingListDisplayName,
            }),
            failure,
