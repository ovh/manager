angular.module('App').controller(
  ...
  class DomainOperationUpdateCtrl {
    ...
    $onInit() {
      ...
      this.baseArgs = [];
      this.canContinue = this.operation.canAccelerate
          ...
          const promises = _.map(argumentIds, key => this.domainOperationService
            ...
            .then((originalArgument) => {
              ...
              if (argument.type === '/me/document') {
                ...
                this.constraints[argument.key].template = argument.template || false;
                this.constraints[argument.key].maximumSize = argument.maximumSize || false;
                this.constraints[argument.key].minimumSize = argument.minimumSize || false;
                ...
                if (argument.value) {
                  this.User.getDocument(argument.value).then((documentInfo) => {
                    ...
                    this.previousValue[argument.key] = argument.value !== null;
