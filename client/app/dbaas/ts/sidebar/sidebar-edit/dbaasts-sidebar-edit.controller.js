...
angular.module('managerApp').controller('DBaasTsSidebarEditCtrl', [
  ...
  'Toast',
  function DBaasTsSidebarEditCtrl($rootScope, $scope, $timeout, $translate,
    managerSidebarMenuItemController, DBaasTsSidebarEditMediator, locals, OvhApiDBaasTsProject,
    Toast) {
    const self = this;
