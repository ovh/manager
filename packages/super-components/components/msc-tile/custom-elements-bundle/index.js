...
class OdsIconController {
  ...
  validateAttributes() {
    ...
    OdsWarnComponentAttribute({
      logger,
      attributeValues: ODS_ICON_SIZE$1,
      attributeName: 'size',
...
const OsdsIcon$1 = class extends HTMLElement {
  constructor() {
    ...
    this.ariaName = DEFAULT_ATTRIBUTE$6.ariaName;
    ...
    this.hoverable = DEFAULT_ATTRIBUTE$6.hoverable;
    /** @see OdsIconAttributes.name */
    this.name = DEFAULT_ATTRIBUTE$6.name;
...
const MscTile$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    const content = (h("osds-tile", { class: "msc-ods-tile", color: ODS_THEME_COLOR_INTENT$1.primary, hoverable: true, rounded: true, inline: true }, h("div", { class: "tile-content" }, this.imgSrc && (h("img", { class: "tile-img", src: this.imgSrc, alt: this.imgAlt })), h("osds-text", { class: "tile-type", level: ODS_THEME_TYPOGRAPHY_LEVEL.heading, size: ODS_THEME_TYPOGRAPHY_SIZE._200, color: ODS_THEME_COLOR_INTENT$1.primary }, this.category, h("span", { class: "tile-badge-list" }, h("slot", { name: "badges" }))), h("osds-text", { class: "tile-title", level: ODS_THEME_TYPOGRAPHY_LEVEL.heading, size: ODS_THEME_TYPOGRAPHY_SIZE._400, color: ODS_THEME_COLOR_INTENT$1.text }, this.tileTitle), h("osds-text", { class: "tile-description", level: ODS_THEME_TYPOGRAPHY_LEVEL.body, size: ODS_THEME_TYPOGRAPHY_SIZE._400, color: ODS_THEME_COLOR_INTENT$1.default }, this.tileDescription), h("osds-link", { tabIndex: this.hasFooterContent ? 0 : -1, "data-tracking": this.dataTracking, color: ODS_THEME_COLOR_INTENT$1.primary, href: this.href, target: OdsHTMLAnchorElementTarget$1._blank }, (_a = this.localeStrings) === null || _a === void 0 ? void 0 :
      _a.see_more_label, h("osds-icon", { slot: "end", class: "link-icon", "aria-hidden": "true", size: ODS_ICON_SIZE$1.xxs, name: this.isExternalHref
        ? ODS_ICON_NAME$1.EXTERNAL_LINK
        : ODS_ICON_NAME$1.ARROW_RIGHT, color: ODS_THEME_COLOR_INTENT$1.primary })), h("slot", { name: "footer", onSlotchange: this.handleFooterSlotChange }))));
    return (h(Host, { tabIndex: this.tabIndex }, this.hasFooterContent ? (h("div", { class: "msc-tile-wrapper" }, content)) : (h("a", { class: "msc-tile-wrapper", target: OdsHTMLAnchorElementTarget$1._blank, rel: OdsHTMLAnchorElementRel$1.noopener, href: this.href, onFocus: () => {
        this.tabIndex = -1;
      }, onBlur: () => {
        this.tabIndex = 0;
      } }, content))));
...
const OsdsChip$1 = class extends HTMLElement {
  constructor() {
    ...
    this.removable = DEFAULT_ATTRIBUTE$3.removable;
    /** @see OdsChipAttributes.selectable */
    this.selectable = DEFAULT_ATTRIBUTE$3.selectable;
...
const MscTile = /*@__PURE__*/proxyCustomElement(MscTile$1, [1,"msc-tile",{"href":[1],"isExternalHref":[4,"is-external-href"],"category":[1],"tileTitle":[1,"tile-title"],"tileDescription":[1,"tile-description"],"imgSrc":[1,"img-src"],"imgAlt":[1,"img-alt"],"dataTracking":[1,"data-tracking"],"hoverable":[4],"locale":[1],"localeStrings":[32],"tabIndex":[32],"hasFooterContent":[32]},[[0,"focus","onFocus"],[0,"blur","onBlur"]]]);
...
export { MscTile, OsdsButton, OsdsChip, OsdsIcon, OsdsLink, OsdsSkeleton, OsdsText, OsdsTile, defineCustomElements };
