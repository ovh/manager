    ...
    return (
      <>
        <osds-link
          ...
          href={`https://www.ovh.com/manager/#/dedicated/contacts/services?serviceName=${this.serviceName}`}
          ...
          <osds-link
            ...
            href={
              this.isDomainServiceType()
                ? `https://www.ovh.com/fr/order/domain/#/legacy/domain/trade/informations?options=~~(domain~~'${this.serviceName})`
        ...
        {this.isDomainServiceType() && this.domainProperties?.whoisOwner && (
          <osds-link
            ...
            href={`https://www.ovh.com/manager/#/dedicated/contact/${this.serviceName}/${this.domainProperties?.whoisOwner}`}
            color={OdsThemeColorIntent.primary}
            target={OdsHTMLAnchorElementTarget._blank}
          >
            {
