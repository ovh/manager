      ...
      case RenewalStatus.EXPIRED:
        return (
          <osds-link
            ...
            href={`https://eu.ovh.com/fr/cgi-bin/order/renew.cgi?domainChooser=${this.serviceName}`}
        ...
        return (
          <>
            <osds-link
              ...
              target={OdsHTMLAnchorElementTarget._blank}
              href={`https://www.ovh.com/manager/#/dedicated/billing/autorenew/delete?serviceId=${this.serviceName}&serviceType=${this.serviceType}`}
              color={OdsThemeColorIntent.primary}
            >
