...
import { O as OdsLogger, a as OdsWarnComponentAttribute } from './ods-html-anchor-element-target.js';
...
const OsdsChip = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  components.forEach(tagName => { switch (tagName) {
    case "osds-chip":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, OsdsChip);
      }
      break;
    case "osds-icon":
      if (!customElements.get(tagName)) {
...
export { ODS_CHIP_SIZE as O, ODS_CHIP_VARIANT as a, OsdsChip as b, defineCustomElement as d };
