...
import { d as defineCustomElement$7, O as ODS_THEME_COLOR_INTENT } from './msc-tail-logs-code2.js';
import { O as ODS_THEME_TYPOGRAPHY_LEVEL, a as ODS_THEME_TYPOGRAPHY_SIZE } from './ods-theme-typography-size.js';
import { d as defineCustomElement$3 } from './osds-text2.js';
import { d as defineCustomElement$6 } from './osds-code2.js';
import { d as defineCustomElement$5 } from './osds-icon2.js';
import { d as defineCustomElement$4 } from './osds-skeleton2.js';
import { d as defineCustomElement$2 } from './osds-toggle2.js';
...
const mscTailLogsCss = ".msc-tail-logs-wrapper{display:block}";

const DEFAULT_LOGS_REFRESH_INTERVAL = 30000;
const DEFAULT_LOGS_LIMIT = 500;
const DEFAULT_SORT = 'asc';
const MscTailLogs$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.sort = DEFAULT_SORT;
    this.limit = DEFAULT_LOGS_LIMIT;
    this.apiVersion = 'v6';
    this.refreshInterval = DEFAULT_LOGS_REFRESH_INTERVAL;
  ...
  render() {
    ...
    if (!this.localeStrings) {
      return (h(Host, null, h("osds-skeleton", null)));
    }
    return (h(Host, null, h("section", { class: "msc-tail-logs-wrapper" }, h("osds-toggle", { color: ODS_THEME_COLOR_INTENT.primary, onClick: () => {
        if (this.logEntryList !== null) {
          this.autoRefresh = !this.autoRefresh;
        }
      }, disabled: this.logEntryList === null, checked: this.autoRefresh }, h("osds-text", { slot: "start", level: "heading", color: ODS_THEME_COLOR_INTENT.text }, this.localeStrings.refresh_button_label)), !this.hasError && this.logEntryList === null ? (h("osds-skeleton", { flex: true })) : (h("osds-code", null, this.hasError && (h("osds-text", { level: ODS_THEME_TYPOGRAPHY_LEVEL.caption, size: ODS_THEME_TYPOGRAPHY_SIZE._400, color: ODS_THEME_COLOR_INTENT.error }, this.localeStrings.service_error_message)), ((_a = this.logEntryList) === null || _a === void 0 ? void 0 : _a.length) === 0 && this.localeStrings.empty_logs, this.logEntryList && this.logEntryList.length > 0 && (h("msc-tail-logs-code", { logs: this.logEntryList })))))));
  }
  get host() { return this; }
  static get watchers() { return {
    "locale": ["updateTranslations"],
    "autoRefresh": ["setupRefresh"]
  }; }
  static get style() { return mscTailLogsCss; }
}, [1, "msc-tail-logs", {
    "source": [1],
    "sort": [1],
    "limit": [2],
    "apiVersion": [1, "api-version"],
    "refreshInterval": [2, "refresh-interval"],
    "locale": [1],
    "autoRefresh": [1028, "auto-refresh"],
    "localeStrings": [32],
    "logEntryList": [32],
    "intervalId": [32],
    "hasError": [32]
...
function defineCustomElement$1() {
  ...
  const components = ["msc-tail-logs", "msc-tail-logs-code", "osds-code", "osds-icon", "osds-skeleton", "osds-text", "osds-toggle"];
  components.forEach(tagName => { switch (tagName) {
    case "msc-tail-logs":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, MscTailLogs$1);
      }
      break;
...
const MscTailLogs = MscTailLogs$1;
const defineCustomElement = defineCustomElement$1;

export { MscTailLogs, defineCustomElement$1 as d, defineCustomElement };
