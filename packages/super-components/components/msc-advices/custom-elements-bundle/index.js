...
const OsdsButton$1 = class extends HTMLElement {
  constructor() {
    ...
    this.disabled = DEFAULT_ATTRIBUTE$3.disabled;
    /** @see OdsButtonAttributes.rel */
    this.download = DEFAULT_ATTRIBUTE$3.download;
    /** @see OdsButtonAttributes.inline */
    this.inline = DEFAULT_ATTRIBUTE$3.inline;
    /** @see OdsButtonAttributes.rel */
    this.rel = DEFAULT_ATTRIBUTE$3.rel;
    /** @see OdsButtonAttributes.size */
    this.size = DEFAULT_ATTRIBUTE$3.size;
    /** @see OdsButtonAttributes.target */
    this.target = DEFAULT_ATTRIBUTE$3.target;
    /** @see OdsButtonAttributes.type */
    this.type = DEFAULT_ATTRIBUTE$3.type;
    /** @see OdsButtonAttributes.variant */
    this.variant = DEFAULT_ATTRIBUTE$3.variant;
    /** @see OdsButtonAttributes.textAlign */
    this.textAlign = DEFAULT_ATTRIBUTE$3.textAlign;
    /** @see OdsButtonAttributes.circle */
    this.circle = DEFAULT_ATTRIBUTE$3.circle;
  }
  handleKey(event) {
...
const OsdsTile$1 = class extends HTMLElement {
  constructor() {
    ...
    this.checked = DEFAULT_ATTRIBUTE$2.checked;
    /** @see OdsTileAttributes.checking */
    this.checking = DEFAULT_ATTRIBUTE$2.checking;
...
const mscAdvicesCss = ".msc-advices-wrapper{display:block;text-decoration:none;padding:var(--ods-size-01)}.msc-advices-wrapper .msc-advices-tile{background:var(--ods-color-primary-050)}.msc-advices-wrapper .msc-advices-tile .msc-advices-content{display:flex;flex-direction:column;width:100%;padding:var(--ods-size-01);line-height:2}.msc-advices-wrapper .msc-advices-tile .msc-advices-content .link-icon{margin-left:var(--ods-size-03)}.msc-advices-wrapper .msc-advices-tile .block{position:relative}";

const MscAdvices$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  getRecommandationBlock() {
    return (h(Fragment, null, h("osds-divider", { separator: true }), this.adviceGroups ? (this.adviceGroups.adviceGroups.map((adviceGroup, index) => (h("div", { key: adviceGroup.localizedDescription }, h("osds-text", { class: "tile-title", level: ODS_THEME_TYPOGRAPHY_LEVEL.body, size: ODS_THEME_TYPOGRAPHY_SIZE._200, color: ODS_THEME_COLOR_INTENT$1.text }, adviceGroup.localizedDescription), adviceGroup.advices &&
      adviceGroup.advices.length > 0 &&
      adviceGroup.advices.map((advice) => (h("osds-button", { key: advice.name, "data-tracking": this.dataTracking, href: advice.href, color: ODS_THEME_COLOR_INTENT$1.primary, variant: ODS_BUTTON_VARIANT.ghost }, h("span", { slot: "start" }, advice.localizedName, advice.external && (h("osds-icon", { class: "link-icon", size: ODS_ICON_SIZE.xxs, name: ODS_ICON_NAME.EXTERNAL_LINK, color: ODS_THEME_COLOR_INTENT$1.primary }))), h("span", { slot: "end" }, h("osds-icon", { class: "link-icon", size: ODS_ICON_SIZE.xxs, name: ODS_ICON_NAME.CHEVRON_RIGHT, color: ODS_THEME_COLOR_INTENT$1.primary }))))), index < this.adviceGroups.adviceGroups.length - 1 && (h("osds-divider", { separator: true })))))) : (h("osds-skeleton", null))));
  }
  render() {
    if (!this.localeStrings || !this.adviceGroups) {
      return (h("osds-tile", { rounded: true, inline: true }, h("osds-skeleton", null)));
    }
    return (h(Host, null, h("div", { class: "msc-advices-wrapper" }, h("osds-tile", { class: "msc-advices-tile", color: ODS_THEME_COLOR_INTENT$1.info, variant: ODS_TILE_VARIANT.stroked, rounded: true }, h("div", { class: "msc-advices-content" }, h("osds-text", { level: ODS_THEME_TYPOGRAPHY_LEVEL.heading, size: ODS_THEME_TYPOGRAPHY_SIZE._500, color: ODS_THEME_COLOR_INTENT$1.text }, this.localeStrings.advices_heading), this.getRecommandationBlock())))));
  }
  get host() { return this; }
  static get watchers() { return {
    "locale": ["updateTranslations"]
  }; }
  static get style() { return mscAdvicesCss; }
};
...
const OsdsDivider$1 = class extends HTMLElement {
  constructor() {
    ...
    this.separator = DEFAULT_ATTRIBUTE$1.separator;
...
const MscAdvices = /*@__PURE__*/proxyCustomElement(MscAdvices$1, [1,"msc-advices",{"locale":[1],"serviceType":[1,"service-type"],"serviceName":[1,"service-name"],"dataTracking":[1,"data-tracking"],"adviceGroups":[32],"localeStrings":[32]}]);
...
export { MscAdvices, OsdsButton, OsdsDivider, OsdsIcon, OsdsSkeleton, OsdsText, OsdsTile, defineCustomElements };
