...
const MscAdvices$1 = class extends HTMLElement {
  ...
  getRecommandationBlock() {
    return (h(Fragment, null, h("osds-divider", { separator: true }), this.adviceGroups ? (this.adviceGroups.adviceGroups.map((adviceGroup, index) => (h("div", { key: adviceGroup.localizedDescription }, h("osds-text", { class: "tile-title", level: ODS_THEME_TYPOGRAPHY_LEVEL.body, size: ODS_THEME_TYPOGRAPHY_SIZE._200, color: ODS_THEME_COLOR_INTENT.text }, adviceGroup.localizedDescription), adviceGroup.advices &&
      adviceGroup.advices.length > 0 &&
      adviceGroup.advices.map((advice) => (h("osds-button", { key: advice.name, "data-tracking": this.dataTracking, href: advice.href, color: ODS_THEME_COLOR_INTENT.primary, variant: ODS_BUTTON_VARIANT.ghost }, h("span", { slot: "start" }, advice.localizedName, advice.external && (h("osds-icon", { class: "link-icon", size: ODS_ICON_SIZE.xxs, name: ODS_ICON_NAME.EXTERNAL_LINK, color: ODS_THEME_COLOR_INTENT.primary }))), h("span", { slot: "end" }, h("osds-icon", { class: "link-icon", size: ODS_ICON_SIZE.xxs, name: ODS_ICON_NAME.CHEVRON_RIGHT, color: ODS_THEME_COLOR_INTENT.primary }))))), index < this.adviceGroups.adviceGroups.length - 1 && (h("osds-divider", { separator: true })))))) : (h("osds-skeleton", null))));
  }
  render() {
    if (!this.localeStrings || !this.adviceGroups) {
      return (h("osds-tile", { rounded: true, inline: true }, h("osds-skeleton", null)));
    }
    return (h(Host, null, h("div", { class: "msc-advices-wrapper" }, h("osds-tile", { class: "msc-advices-tile", color: ODS_THEME_COLOR_INTENT.info, variant: ODS_TILE_VARIANT.stroked, rounded: true }, h("div", { class: "msc-advices-content" }, h("osds-text", { level: ODS_THEME_TYPOGRAPHY_LEVEL.heading, size: ODS_THEME_TYPOGRAPHY_SIZE._500, color: ODS_THEME_COLOR_INTENT.text }, this.localeStrings.advices_heading), this.getRecommandationBlock())))));
  }
