...
import { d as defineCustomElement$5, O as ODS_ICON_SIZE } from './osds-icon2.js';
import { d as defineCustomElement$7, O as ODS_BUTTON_VARIANT } from './osds-button2.js';
import { d as defineCustomElement$2, O as ODS_TILE_VARIANT } from './osds-tile2.js';
import { d as defineCustomElement$6 } from './osds-divider2.js';
...
const MscAdvices$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  getRecommandationBlock() {
    return (h(Fragment, null, h("osds-divider", { separator: true }), this.adviceGroups ? (this.adviceGroups.adviceGroups.map((adviceGroup, index) => (h("div", { key: adviceGroup.localizedDescription }, h("osds-text", { class: "tile-title", level: ODS_THEME_TYPOGRAPHY_LEVEL$1.body, size: ODS_THEME_TYPOGRAPHY_SIZE$1._200, color: ODS_THEME_COLOR_INTENT.text }, adviceGroup.localizedDescription), adviceGroup.advices &&
...
function defineCustomElement$1() {
  ...
  const components = ["msc-advices", "osds-button", "osds-divider", "osds-icon", "osds-skeleton", "osds-text", "osds-tile"];
  components.forEach(tagName => { switch (tagName) {
    case "msc-advices":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, MscAdvices$1);
      }
      break;
    case "osds-button":
      if (!customElements.get(tagName)) {
...
const MscAdvices = MscAdvices$1;
const defineCustomElement = defineCustomElement$1;

export { MscAdvices, defineCustomElement$1 as d, defineCustomElement };
