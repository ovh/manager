...
import { TRefetchInterval } from './adapters/common.types';
import { UseQueryResult } from './adapters/use-query';
import { UseInifiniteQueryResult } from './adapters/use-infinite-query';
