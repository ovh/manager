...
1 - In your columns definition, fill `isSearchable` attribute, it will display the search bearch in datagrid topbar.
...
2 - `search` object return by `useResourcesIcebergV6` must be use in your datagrid component
