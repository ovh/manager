...
function addTranslations() {
  i18next.addResources('de_DE', 'buttons', de_DE);
  i18next.addResources('en_GB', 'buttons', en_GB);
  i18next.addResources('es_ES', 'buttons', es_ES);
  i18next.addResources('fr_CA', 'buttons', fr_CA);
  i18next.addResources('fr_FR', 'buttons', fr_FR);
  i18next.addResources('it_IT', 'buttons', it_IT);
  i18next.addResources('pl_PL', 'buttons', pl_PL);
  i18next.addResources('pt_PT', 'buttons', pt_PT);
}
