...
import meta, { Demo } from './price.stories';
import Links from '../../../../.storybook/docs/external-links';

<Meta title="Components/Price/Documentation" />

<StoryBookBanner of={meta} />

<Canvas of={Demo} sourceState="none" />
...
- **Default**:
  - Displays the price with pre-tax and post-tax amounts, currency, and any nterval unit (none by default)
...
- Use aria-label ? to clarify the context of displayed prices?
