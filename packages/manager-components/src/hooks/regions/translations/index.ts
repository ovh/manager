...
function addTranslations() {
  i18next.addResources('de_DE', 'regions', de_DE);
  i18next.addResources('en_GB', 'regions', en_GB);
  i18next.addResources('es_ES', 'regions', es_ES);
  i18next.addResources('fr_CA', 'regions', fr_CA);
  i18next.addResources('fr_FR', 'regions', fr_FR);
  i18next.addResources('it_IT', 'regions', it_IT);
  i18next.addResources('pl_PL', 'regions', pl_PL);
  i18next.addResources('pt_PT', 'regions', pt_PT);
}
