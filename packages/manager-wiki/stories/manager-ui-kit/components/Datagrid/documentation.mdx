...
<Meta title="Manager UI Kit/Components/Datagrid Cursor/Documentation" />
...
<Source
  code={`
import { useResourcesV6, useResourcesIcebergV6 } from '@ovh-ux/manager-ui-kit';
...
<Source
  code={`
import { useColumnFilters } from '@ovh-ux/manager-ui-kit';
