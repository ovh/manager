...
The `useResourcesIcebergV2` hook is a data fetching utility designed to work with OVHcloud's Iceberg API v2. It provides a solution for handling paginated data with cursor-based pagination and sorting capabilities.
...
- The hook uses cursor-based pagination, which is different from offset-based pagination used in V6
