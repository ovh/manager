...
<Meta title="Manager UI Kit/Guidelines/New component ?" />

# How to add a new component

This guide will walk you through the process of creating and integrating a new component into the Manager UI Kit library.
