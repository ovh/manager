...
<img src={dashboardOverviewImg} alt="Create mrc issues" />

## 👨‍💻 As a developer

When you generate a project, you have to choose your **dashboard endpoint**, its mainly `/mainEndpoint/{id}`.

Once the project generated, in you folder app generated, you will find `src/pages/dashboard/index.tsx` file.
