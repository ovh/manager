...
This guide explains how to implement different types of modals in the OVHcloud Manager using the `@ovh-ux/muk` library.
...
```tsx
import { Modal, MODAL_TYPE } from '@ovh-ux/muk';
