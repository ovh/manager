    ...
    compile() {
      return {
        ...
        post: ($scope, $element, attr, switchPageCtrl) => {
          ...
          $scope.getResponsiveSwitchMode = () =>
            switchPageCtrl.getDisplayMode();

          $scope.getResponsiveSwitchActivePage = () =>
            switchPageCtrl.getActivePage();
        },
      };
    },
  };
