/* global describe:true, beforeEach:true, afterEach:true, it:true, expect: true, require: true */
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        srcdir: "src",
        builddir: ".work/.tmp",
        name: grunt.file.readJSON("package.json").name || "ovh-angular-slider", // module name
