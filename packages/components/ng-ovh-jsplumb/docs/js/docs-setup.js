NG_DOCS={
  ...
  "pages": [
    {
      "section": "api",
      "id": "ovh-angular-jsplumb.directive:jsplumbEndpoint",
      "shortName": "jsplumbEndpoint",
      "type": "directive",
    ...
    {
      "section": "api",
      "id": "ovh-angular-jsplumb.directive:jsplumbInstance",
    ...
    {
      "section": "api",
      "id": "ovh-angular-jsplumb.jsPlumbService",
      "shortName": "ovh-angular-jsplumb.jsPlumbService",
      "type": "service",
      "moduleName": "ovh-angular-jsplumb",
      "shortDescription": "Main service",
      "keywords": "api configure function importdefaults initialize jsplumb jsplumbinit jsplumbservice main ovh-angular-jsplumb service"
    }
  ],
  "apis": {
    "api": true
