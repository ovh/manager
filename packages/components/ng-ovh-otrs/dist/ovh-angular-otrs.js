...
angular.module('ovh-angular-otrs').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/module-otrs/otrs-popup/otrs-popup.html',
    ...
    "                                           OtrsPopupCtrl.loaders.intervention\" data-track-on=click data-track-type=action data-track-name=assistance_requests::validation_create_assistance_request><span data-translate=otrs_popup_add_ticket></span><oui-spinner data-ng-if=OtrsPopupCtrl.loaders.send data-size=s></oui-spinner></button></div></form></div></div></div>"
  );
