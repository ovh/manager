...
angular.module('ovh-utils-angular').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('js/ovh-utils-angular/wizard/wizardStep/wizardStep.html',
    "<div class=wizard-step-container data-ng-show=\"getCurrentStep() === stepNumber\"><div id=wizard-step-content-help-{{stepNumber}} class=helpTrigger data-ng-show=hasHelp()><a href=javascript:void(0) class=helpButton data-i18n-static=wizard_help></a></div><div class=\"wizard-step-content-container modal-body\" data-ng-transclude></div><div class=\"wizard-btn-container modal-footer\" data-ng-hide=\"getCurrentStep() === 1 && stepCount === 1 && !cancelButton && !confirmButton\"><button class=\"btn btn-default\" type=button data-ng-bind=wizardCancelButtonText data-ng-click=onCancel() data-ng-show=cancelButton></button> <button class=btn type=button data-ng-bind=wizardPreviousButtonText data-ng-click=previousStep() data-ng-show=\"getCurrentStep() > 1 && wizardPreviousButton\"></button> <button class=\"btn btn-primary\" type=button data-ng-bind=wizardNextButtonText data-ng-click=nextStep() data-ng-disabled=!stepValid data-ng-show=\"getCurrentStep() < stepCount\"></button> <button class=\"btn btn-primary\" type=button data-ng-bind=wizardConfirmButtonText data-ng-click=nextStep() data-ng-disabled=!stepValid data-ng-show=\"getCurrentStep() == stepCount && confirmButton\"></button></div></div>"
  );
