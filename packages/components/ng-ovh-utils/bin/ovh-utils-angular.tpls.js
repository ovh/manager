...
angular.module('ovh-utils-angular').run(['$templateCache', function($templateCache) {
  'use strict';

  $templateCache.put('js/ovh-utils-angular/agreements/agreements.html',
    "<div class=agreements><a data-ng-transclude data-ng-click=getAgreements() data-role=button data-toggle=modal data-target=#agreements-modal></a><div id=agreements-modal class=\"modal hide fade\" tabindex=-1 role=dialog aria-labelledby=agreementsLabel aria-hidden=true><div class=modal-header><button type=button class=close data-dismiss=modal aria-hidden=true>&times;</button><h3 class=modal-agreements-title data-ng-bind=agreements.title></h3></div><div class=modal-body data-ng-hide=loading><pre class=modal-agreements-body data-ng-hide=loading data-ng-bind=agreements.text></pre></div><div class=modal-body data-ng-show=loading><pre class=modal-agreements-body-loader data-ng-bind=i18n.loading></pre></div><div class=modal-footer data-ng-show=\"paginator.length > 1\"><a class=\"btn modal-agreements modal-agreements-paginator-btn-previous\" data-ngs-how=!isFirstPage() data-ng-disabled=\"isFirstPage() || loading\" data-ng-click=decPage()>&lt;</a> <span class=modal-footer-paginator-current data-ng-bind=\"paginator.currentPage + 1\"></span>/<span class=modal-footer-paginator-total data-ng-bind=numberOfPages()></span> <a class=\"btn modal-agreements modal-agreements-paginator-btn-next\" data-ng-click=incPage() data-ng-disabled=\"isLastPage() || loading\">&gt;</a></div></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/alerter/alerter.html',
    "<div class=\"alert mb-0\" data-ng-class=ovhAlertType data-ng-if=ovhAlertMessage><span class=\"fa fa-times close\" data-ng-if=!ovhAlertHideRemoveButton data-ng-click=resetMessages()></span> <span data-ng-bind-html=ovhAlertMessage></span><div data-ng-if=ovhAlertMessageDetails><a class=text-underline data-tooltip-box data-tb-unique=true data-tb-content-template=components/ovh-utils-angular/alerter/tooltipErrorMessages.html data-tb-hide-on-blur=true data-tb-placement=bottom data-i18n-static=common_alerts_message_see_more></a></div></div>"
  );
  ...
  $templateCache.put('js/ovh-utils-angular/contracts/contracts.html',
    "<div><div data-ng-show=\"fullText == false\"><ul class=list-unstyled><li class=\"clearfix mb-3\" data-ng-repeat=\"contract in contracts track by $index\"><a class=\"d-block font-weight-bold blue\" target=_blank data-ng-href={{contract.url}}><span data-ng-bind=contract.name></span> <span class=\"fa fa-file-pdf-o pull-right\" aria-hidden=true></span></a></li></ul><div class=\"checkbox mt-4\"><label><input type=checkbox id=validateContracts name=validateContract value=false data-ng-model=agree> <span data-ng-bind=\"contracts.length > 1 && tr('contracts_agree') || tr('contract_agree')\"></span></label></div></div><div data-ng-show=\"fullText == true\"><p class=\"font-weight-bold text-center black\" data-ng-bind=\"contracts.length > 1 && tr('contracts_list_title', [contracts.length]) || tr('contract_list_title')\"></p><div class=\"accordion contracts-list\"><div data-ng-repeat=\"contract in contracts track by $index\" id=contract-{{$index}}><div class=accordion-group><div class=accordion-heading><a class=\"accordion-toggle contracts-toggle font-weight-bold blue\" data-ng-bind=contract.name></a></div><div id={{$index}} class=\"accordion-body in collapse\"><div class=accordion-inner><pre class=contracts-content>{{contract.content}}</pre></div></div></div></div></div><div class=accordion-footer><div class=contracts-breadcrumb-container role=navigation><div class=contracts-breadcrumb><a class=\"pull-left contracts-breadcrumb-navigate contracts-breadcrumb-navigate-previous\"><span class=\"fa fa-chevron-left\" aria-hidden=true></span> <span data-i18n-static=contract_previous></span></a><ul id=contracts-menu><li class=contracts-breadcrumb-navigate data-ng-repeat=\"contract in contracts track by $index\"><a title={{contract.name}} data-fake-href=#contract-{{$index}} data-ng-class=\"{\n" +
    "                                    'active' : currentContract.name == contract.name\n" +
    "                               }\"></a></li></ul><a class=\"pull-right contracts-breadcrumb-navigate contracts-breadcrumb-navigate-next\"><span data-i18n-static=contract_next></span> <span class=\"fa fa-chevron-right\" aria-hidden=true></span></a></div></div><br><a class=\"accordion-toggle contracts-toggle-icon center\" title={{contract.name}} target=_blank data-ng-href={{currentContract.url}}><span data-ng-bind=\"tr('download_contract', [currentContract.name])\"></span><br><span class=\"fa fa-file-pdf-o\" aria-hidden=true></span></a><br><div class=checkbox><label class=pull-right for=validateContract data-ng-show=\"disabled == false\"><input type=checkbox id=validateContract name=validateContract data-ng-model=agree value=false> <span data-ng-bind=\"contracts.length > 1 && tr('contracts_agree', [currentContract]) || tr('contracts_agree')\"></span></label><span class=\"font-weight-bold pull-right red\" data-i18n-static=ontract_help data-ng-show=\"disabled == true\"></span></div></div></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/grid/grid.html',
    "<div data-ng-class=options.css.container.css data-ng-style=options.css.container.style><div data-ng-class=options.css.header.class data-ng-style=options.css.header.style><div data-ng-class=col.css.class data-ng-style=col.css.style data-ng-repeat=\"col in columns\"><input name=gridSelectAll type=checkbox data-ng-class=options.css.selectableCol.class data-ng-style=options.css.selectableCol.style data-ng-click=toggleSelectAll() data-ng-model=\"allChecked['allChecked']\" data-ng-show=\"options.selectable == 'multi' && $index == 0\"><a data-ng-show=options.sortable data-ng-click=sort(col.field);>{{col.displayName}} <i data-ng-show=\"predicateSortOrder == col.field\" data-ng-class=\"{\n" +
    "                       &quot;sort-ico-up&quot;: orderReverseSort && predicateSortOrder == col.field,\n" +
    "                       &quot;sort-ico-down&quot;: !orderReverseSort && predicateSortOrder == col.field\n" +
    "                       }\"></i></a> <span data-ng-show=!options.sortable>{{col.displayName}}</span></div></div><div data-ng-class=options.css.body.class data-ng-style=options.css.body.style><div data-ng-class=options.css.row.class data-ng-style=options.css.row.style data-ng-repeat=\"row in rows|orderBy:predicateSortOrder:orderReverseSort|filter:search\"><div data-ng-class=col.css.class data-ng-style=col.css.style data-ng-repeat=\"col in columns\"><input type=radio data-ng-class=options.css.selectableCol.class data-ng-style=options.css.selectableCol.style data-ng-show=\"options.selectable == 'single' && $index == 0\" data-ng-model=selectedItem.items value={{row[options.identifierField]}}><input type=checkbox data-ng-class=options.css.selectableCol.class data-ng-style=options.css.selectableCol.style data-ng-show=\"options.selectable == 'multi' && $index == 0\" data-ng-model=selectedItem[row[options.identifierField]]>{{row[col.field]}}</div></div></div><div data-ng-class=options.css.footer.class data-ng-style=options.css.footer.style data-ng-show=options.showFooter></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/inputNumber/inputNumber.html',
    "<div class=\"btn-group btn-group-vertical input-number-btn-container\"><button type=button class=\"btn input-number-btn input-number-btn-up\"><i class=icon-chevron-up></i></button> <button type=button class=\"btn input-number-btn input-number-btn-down\"><i class=icon-chevron-down></i></button></div><div class=clearfix></div>"
  );


  $templateCache.put('js/ovh-utils-angular/paginationServerSide/paginationServerSide.html',
    "<div class=ua-pagination-container><div class=\"ua-pagination d-flex\"><ul class=\"pagination my-0\"><li data-ng-class=getPaginationPreviousClasses()><a href=\"javascript:return false;\" data-ng-click=loadPage(1)><i class=\"fa fa-angle-double-left\"></i></a></li><li data-ng-class=getPaginationPreviousClasses()><a href=\"javascript:return false;\" data-ng-click=\"loadPage(currentPage - 1)\"><i class=\"fa fa-angle-left\"></i></a></li><li data-ng-repeat=\"page in paginationServerSidePaginatedStuff.pagination\" data-ng-class=getPaginationNumbersClasses(page)><a href=\"javascript:return false;\" data-ng-bind=page data-ng-click=loadPage(page)></a></li><li data-ng-class=getPaginationNextClasses()><a href=\"javascript:return false;\" data-ng-click=\"loadPage(currentPage + 1)\"><i class=\"fa fa-angle-right\"></i></a></li><li data-ng-class=getPaginationNextClasses()><a href=\"javascript:return false;\" data-ng-click=loadPage(getLastPageNumber())><i class=\"fa fa-angle-double-right\"></i></a></li></ul><form class=\"form-inline ml-auto\"><div class=form-group><select class=\"form-control pagination-page-size\" data-ng-model=pageSize data-ng-options=\"getSizeLabel(size) for size in pageSizeAvailable\" data-ng-disabled=paginationServerSideTableLoading><option value=\"\" disabled data-ng-bind=\"tr('pagination_display')\" selected></option></select></div><div class=form-group><input class=\"form-control pagination-page-input\" data-ng-model=goToPage data-ng-class=getGoToPageClasses() data-ng-disabled=paginationServerSideTableLoading placeholder=\"{{tr('pagination_page', [currentPage, getLastPageNumber()])}}\"></div><button class=\"btn btn-primary\" data-ng-bind=\"tr('pagination_go')\" data-ng-class=getGoToPageClasses() data-ng-disabled=paginationServerSideTableLoading data-ng-click=loadPage(goToPage)></button></form></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/popover/simplepopover/simplepopover.html',
    "<div class=\"popover {{popoverTooltipPlacement}} fade\" ng-class=\"{ in: popoverTooltipIsOpen }\" id={{popoverTooltipId}}><div class=arrow></div><div class=popover-inner><div class=\"popover-title popover-title-input\" data-ng-bind=popoverTooltipTitle></div><div class=popover-content><div data-ng-if=\"popoverTooltipRemote === true\" data-ng-include=popoverTooltipContent></div><div data-ng-if=\"popoverTooltipRemote !== true\" data-ng-bind-html=popoverTooltipContent></div></div></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/productList/productList.html',
    "<div class=sidebar><div id=navigation-left-search-form class=navigation-left-form-container><form class=form-search><div class=input-append><input placeholder={{i18n.navigation_left_search}} data-ng-model=\"searchProduct.$\"> <span class=add-on><i data-ng-show=searchProduct.$ data-ng-click=\"searchProduct.$ = ''\" class=icon-remove></i> <i data-ng-show=!searchProduct.$ class=icon-search></i></span></div></form></div><div data-extended-accordion class=\"accordion productList\" style=\"height: 675px\" data-ng-transclude></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/productList/productListEntry/productListEntry.html',
    "<div class=navigation><div class=navigation-left-title><span data-extended-accordion-toggle=#navigation-left-{{$id}} data-ng-bind=productListTitle></span></div><div id=navigation-left-{{$id}} class=\"navigation-left-list-container extended-accordion-inner extended-accordion-in\"><div class=accordion-inner><div data-ng-repeat=\"product in productListEntry | filter:searchProduct | orderBy:'formattedName'\" data-ng-class=\"{\n" +
    "                'active' : product.name == selected.name\n" +
    "            }\" data-ng-click=selectProduct(product) data-ng-class-odd=\"'odd'\" data-ng-class-even=\"'even'\" title={{product.displayName}}><i data-ng-class=\"'icon-' + product.type\"></i> <span data-ng-bind-html=\"product.displayName | highlighter:searchProduct.$\"></span></div></div></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/stargate/stargate.html',
    "<li data-ng-repeat=\"gate in gates\" data-ng-class=\"{'selected': gate.selected}\" data-ng-class-odd=\"'odd'\" data-ng-class-even=\"'even'\" class=\"{{ gate.name | lowercase }}\"><a href={{gate.targetEndpoint}} title=\"{{::tr('universe_' + gate.name + '_name')}}\" data-ng-bind=\"::tr('universe_' + gate.name + '_name')\"></a></li>"
  );


  $templateCache.put('js/ovh-utils-angular/wizard/wizard.html',
    "<div class=wizard-container tabindex=-1><div class=\"wizard-title-container modal-header\"><button class=\"oui-icon oui-icon-close_thin oui-modal__close-button\" type=button aria-label={{wizard_close}} data-ng-click=onCancel() data-ng-show=wizardCloseButton></button></div><div class=\"d-flex mb-3\" style=\"padding: 2rem 2rem 0 2rem\"><h1 class=\"wizard-title d-inline-block\" data-ng-bind=wizardTitle></h1><div class=\"wizard-breadcrumb-container d-inline-block ml-auto my-auto text-muted text-nowrap pl-3 font-italic\" data-ng-show=\"stepCount > 1\"><span data-i18n data-key=wizard_breadcrumb data-vars={{currentStep}}|{{stepCount}} data-ng-show=wizardBreadCrumb></span></div></div><div data-ng-transclude></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/wizard/wizardStep/wizardStep.html',
    "<div class=wizard-step-container data-ng-show=\"getCurrentStep() === stepNumber\"><div id=wizard-step-content-help-{{stepNumber}} class=helpTrigger data-ng-show=hasHelp()><a href=javascript:void(0) class=helpButton data-i18n-static=wizard_help></a></div><div class=\"wizard-step-content-container modal-body\" data-ng-transclude></div><div class=\"wizard-btn-container modal-footer\" data-ng-hide=\"getCurrentStep() === 1 && stepCount === 1 && !cancelButton && !confirmButton\"><button class=\"btn btn-default\" data-ng-click=onCancel() data-ng-show=cancelButton><span data-ng-bind=wizardCancelButtonText></span></button> <button class=btn data-ng-click=previousStep() data-ng-show=\"getCurrentStep() > 1 && wizardPreviousButton\"><span data-ng-bind=wizardPreviousButtonText></span></button> <button class=\"btn btn-primary\" data-ng-click=nextStep() data-ng-disabled=!stepValid data-ng-show=\"getCurrentStep() < stepCount\"><span data-ng-bind=wizardNextButtonText></span></button> <button class=\"btn btn-primary\" data-ng-click=nextStep() data-ng-disabled=!stepValid data-ng-show=\"getCurrentStep() == stepCount && confirmButton\"><span data-ng-bind=wizardConfirmButtonText></span></button></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/wizardForm/wizardForm.html',
    "<div class=wizard-form-container><div data-ng-transclude></div><div class=wizard-form-btn-container data-ng-show=\"confirmButton || cancelButton\"><button class=\"btn wizard-form-btn-cancel\" data-ng-click=onCancel() data-ng-show=cancelButton><span data-ng-bind=wizardCancelButtonText></span></button> <button class=\"btn wizard-form-btn-confirm\" data-ng-class=\"{ 'disabled': !stepFormValid }\" data-ng-disabled=!stepFormValid data-ng-show=confirmButton data-ng-click=onFinish()><span data-ng-bind=wizardConfirmButtonText></span></button></div></div>"
  );


  $templateCache.put('js/ovh-utils-angular/wizardForm/wizardFormStep/wizardFormStep.html',
    "<div class=wizard-form-step-container data-ng-class=\"{ 'wizard-form-step-valid': stepValid, 'wizard-form-step-shown': stepShown }\"><div class=\"page-header wizard-form-step-title\" data-ng-show=\"stepTitle != null\"><h2><span class=glyphicon data-ng-class=stepTitleIcon data-ng-show=stepTitleIcon></span> <span class=muted data-ng-show=stepTitleCount>{{stepNumber}}.</span> {{stepTitle}} <span class=\"glyphicon pull-right\" data-ng-class=\"{ 'glyphicon-ok': stepValid && stepShown, 'glyphicon-remove': !stepValid || !stepShown }\" data-ng-show=stepTitleCheck></span></h2></div><div class=wizard-form-step-content-container data-ng-show=stepShown data-ng-transclude></div><div class=\"wizard-form-step-content-hidden muted\" data-ng-show=!stepShown data-ng-bind=stepHiddenText></div></div>"
  );
