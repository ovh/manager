NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$scope actions actions-menu-options actions-menu-popover-settings actionsmenu actionsmenuitem actionsoptions add angular beautiful bootstrap bottom-right button class console controller creating data-actions-menu-on-select-option data-actions-menu-options data-actions-menu-popover-settings desired directive displayed docs example factory feel filled-check filled-error free function github google googlebutton href html http icon informations inside io isopen list log main module my-custom-class my-font my-font-actions my-manager mymanagermodule mytestcontroller onselectoption open option options otherbutton placement popover popover-class popover-placement popoversettings selected state1 supported title trigger view"
    },
    {
      "section": "docs",
