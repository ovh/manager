NG_DOCS={
  ...
  "pages": [
    {
      "section": "api",
      "id": "ovh-angular-mondial-relay.directive:mondialRelay",
      "shortName": "mondialRelay",
      "type": "directive",
    ...
    {
      "section": "api",
      "id": "ovh-angular-mondial-relay.service:mondialRelay",
      "shortName": "mondialRelay",
      "type": "service",
      "moduleName": "ovh-angular-mondial-relay",
    ...
    {
      "section": "api",
      "id": "ovh-angular-mondial-relay.service:mondialRelayProvider",
      "shortName": "mondialRelayProvider",
      "type": "service",
      "moduleName": "ovh-angular-mondial-relay",
  ...
  "html5Mode": false,
  "editExample": true,
  "startPage": "/api/ovh-angular-mondial-relay.directive:mondialRelay",
  "scripts": [
    "angular.min.js"
  ]
};