...
angular.module("ovh-angular-mondial-relay")
    .directive("mondialRelay", ["MONDIAL_RELAY_PICS", "MONDIAL_RELAY", function (MONDIAL_RELAY_PICS, MONDIAL_RELAY) {
        ...
        return {
            ...
            controllerAs: "$ctrl",
            controller: ["$scope", "$q", "$translate", "$timeout", "$http", "mondialRelay", "OvhApiSupplyMondialRelay", "leafletBoundsHelpers", "leafletEvents", "leafletData", "$injector", function ($scope, $q, $translate, $timeout, $http, mondialRelay, OvhApiSupplyMondialRelay, leafletBoundsHelpers, leafletEvents, leafletData, $injector) {
