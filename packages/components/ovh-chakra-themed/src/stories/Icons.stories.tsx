...
const TemplateSystemIcons: ComponentStory<typeof Icon> = (args) => (
  <Flex flexWrap='wrap'>
    <IconCard
      iconProps={args}
      iconName={'AddIcon'}
...
function IconCard({ iconProps, iconName, Icon }: any) {
  return (
    <Box textAlign='center' minW='10rem' my='1rem'>
      <Box h='4rem' w='4rem' p='1em' borderWidth='1px' textAlign='center' bg='uikit.50' boxShadow='secondary' m='auto' mb='.5rem'>
        <Icon {...iconProps}/>
      </Box>
      <div>{iconName}</div>
    </Box>
