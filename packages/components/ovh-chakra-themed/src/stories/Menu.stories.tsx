...
import { Menu, MenuButton, Button, IconButton, MenuList, MenuGroup, MenuItem, MenuDivider } from '@chakra-ui/react';
...
const TemplateMenu = () => (
  <Menu>
    <MenuButton as={Button} variant={'menu'} rightIcon={<ChevronDownIcon boxSize={'1.5rem'} />}>
      Actions
    </MenuButton>
    <MenuList>
...
const TemplateCompact = () => (
  <Menu>
    <MenuButton as={IconButton} variant={'iconMenu'} icon={<EllipsisIcon boxSize={'1.5rem'} />}>
      Actions
    </MenuButton>
    <MenuList>
      <MenuGroup title='Lorem ipsum'>
