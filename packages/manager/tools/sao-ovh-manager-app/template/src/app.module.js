...
// TODO: Change to '@ovh-ux/manager-<%= name %>' when module is deployed
// import <%= pascalcasedName %> from '@ovh-ux/manager-<%= name %>';
import <%= pascalcasedName %> from '../../../modules/<%= name %>/src';
...
export default async (containerEl, shellClient) => {
  ...
  const trackingConfig = /* @ngInject */ (atInternetConfigurationProvider) => {
    ...
    atInternetConfigurationProvider.setPrefix('<%= pascalcasedName %>App');
  };
