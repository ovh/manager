...
vi.mock('react-router-dom', async (importOriginal) => {
  return {
    ...
    useHref: vi.fn(
      (text) =>
        `#/00000000-0000-0000-0000-000000000001/web-domains/domain/example.com/${text.slice(
          2,
        )}`,
    ),
  };
...
describe('useGenerateUrl', () => {
  it('should return url href', async () => {
    ...
    expect(result.current).toBe(
      '#/00000000-0000-0000-0000-000000000001/web-domains/domain/example.com/add',
    );
  });
  ...
  it('should return url href with params', async () => {
    ...
    expect(result.current).toBe(
      '#/00000000-0000-0000-0000-000000000001/web-domains/domain/example.com/delete?zoneName=example.com',
    );
  });
