...
describe('HostForm', () => {
  ...
  it('displays hostname error when validation fails in Add mode', async () => {
    ...
    const hostField = hostInput.closest('[data-ods="form-field"]');
    ...
    await waitFor(() => {
      const errorElement = hostField?.querySelector('[data-ods="form-field-error"]');
  ...
  it('displays ips error when validation fails', async () => {
    ...
    const ipsField = ipsInput.closest('[data-ods="form-field"]');
    ...
    await waitFor(() => {
      const errorElement = ipsField?.querySelector('[data-ods="form-field-error"]');
      expect(errorElement).toBeInTheDocument();
      expect(errorElement).toHaveTextContent(
        'domain_tab_hosts_drawer_add_invalid_ips_format',
      );
