...
describe('HostsIpsSupportedMessage', () => {
  ...
  it('Display well the text for IpsSupportedEnum.OnlyIPv4', () => {
    render(
      <HostsIpsSupportedMessage ipsSupported={IpsSupportedEnum.OnlyIPv4} />,
    );
    expect(
  ...
  it('Display well the text for IpsSupportedEnum.OnlyIPv6', () => {
    render(
      <HostsIpsSupportedMessage ipsSupported={IpsSupportedEnum.OnlyIPv6} />,
    );
    expect(
  ...
  it('Display well the text for IpsSupportedEnum.OnlyIPv4IPv6', () => {
    render(
      <HostsIpsSupportedMessage ipsSupported={IpsSupportedEnum.OnlyIPv4IPv6} />,
    );
    expect(
      screen.getByText(
