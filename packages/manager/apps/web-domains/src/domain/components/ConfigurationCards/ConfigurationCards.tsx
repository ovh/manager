...
export default function ConfigurationCards({
  ...
  const [dnssecModalOpenned, setDnssecModalOpenned] = React.useState<boolean>(
    false,
  );
  ...
  const updateDnssec = () => {
    updateServiceDnssec();
    setDnssecModalOpenned(!setDnssecModalOpenned);
  };
  ...
  return (
    <ManagerTile>
      ...
      <ManagerTile.Divider />
      <DnssecToggleStatus
        dnssecModalOpenned={dnssecModalOpenned}
      ...
      <DnssecModal
        ...
        open={dnssecModalOpenned}
        updateDnssec={updateDnssec}
        onClose={() => setDnssecModalOpenned(!setDnssecModalOpenned)}
      />
    </ManagerTile>
  );
}
