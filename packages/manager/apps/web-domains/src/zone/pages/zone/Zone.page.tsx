...
import ZoneBanners from '@/zone/pages/zone/components/ZoneBanners';
...
import { DeleteEntriesModal } from '@/zone/pages/zone/delete/DeleteEntries.modal';
  ...
  const columns: DatagridColumn<ZoneRecord>[] = useMemo(
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) =>
          row.original.ttl ? row.original.ttl : t('zone_page_ttl_default'),
      },
      {
        id: 'actions',
        cell: ({ row }) => (
