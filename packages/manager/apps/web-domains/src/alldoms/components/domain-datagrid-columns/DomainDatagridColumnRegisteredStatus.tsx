...
import { OdsBadge, OdsIcon, OdsText, OdsTooltip } from '@ovhcloud/ods-components/react';
...
export default function DomainDatagridColumnRegisteredStatus({
  ...
  const isRegistered = registrationStatus === DomainRegistrationStateEnum.Registered;

  return (
    <div className="flex items-center gap-x-3">
      <OdsBadge
        color={isRegistered ? ODS_BADGE_COLOR.success : ODS_BADGE_COLOR.neutral}
        label={t(`allDom_domain_table_registration_status_${registrationStatus}`)}
