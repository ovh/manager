...
import ServiceActionMenu from '@/alldoms/components/action-menu/ServiceActionMenu';
import ServiceDetailSubscribingRenewDate from '@/alldoms/components/service-detail/service-detail-subscribing/ServiceDetailSubscribingRenewDate';
...
export default function ServiceDetailSubscribing({ alldomService }: ServiceDetailSubscribingProps) {
  ...
  return (
    <OdsCard color={ODS_CARD_COLOR.neutral} className="w-full p-6">
      ...
      <OdsDivider color={ODS_DIVIDER_COLOR.light} spacing={ODS_DIVIDER_SPACING._24} />
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-y-2">
          ...
          <ul className="flex flex-col gap-y-2 p-0 m-0 text-[var(--ods-color-text)]">
            <li className="list-none">{`${t('allDom_page_detail_subscribing_contact_admin', {
              nic: nicAdmin,
            })}`}</li>
            <li className="list-none">{`${t('allDom_page_detail_subscribing_contact_tech', {
              nic: nicTechnical,
            })}`}</li>
            <li className="list-none">{`${t('allDom_page_detail_subscribing_contact_billing', {
              nic: nicBilling,
            })}`}</li>
          </ul>
        </div>
