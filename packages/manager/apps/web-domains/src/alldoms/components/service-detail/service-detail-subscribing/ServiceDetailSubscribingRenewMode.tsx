...
export default function ServiceDetailSubscribingRenewMode({
  ...
  return (
    <div className="flex flex-col gap-y-2">
      <OdsText preset={ODS_TEXT_PRESET.heading6}>{t('allDom_table_header_renewMode')}</OdsText>
      <OdsText preset={ODS_TEXT_PRESET.paragraph}>
        {lifecycleCapacities.includes(LifecycleCapacitiesEnum.TerminateAtExpirationDate)
