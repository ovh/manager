...
import DatagridColumnContact from '@/alldoms/components/alldom-datagrid-columns/DatagridColumnContact';
import { DatagridColumnDate } from '@/alldoms/components/alldom-datagrid-columns/DatagridColumnDate';
import DatagridColumnDomainRegisteredAuthorized from '@/alldoms/components/alldom-datagrid-columns/DatagridColumnDomainRegisteredAuthorized';
import DatagridColumnRenewMode from '@/alldoms/components/alldom-datagrid-columns/DatagridColumnRenewMode';
import DatagridColumnServiceName from '@/alldoms/components/alldom-datagrid-columns/DatagridColumnServiceName';
import DatagridColumnSkeleton from '@/alldoms/components/alldom-datagrid-columns/DatagridColumnSkeleton';
...
export const useAllDomDatagridColumns = () => {
  ...
  const columns = [
    ...
    },
    {
      id: 'type',
      cell: (props: AlldomService) => (
        <DataGridTextCell>{t(`allDom_table_type_${props.currentState.type}`)}</DataGridTextCell>
      ),
      ...
      cell: (props: AlldomService) => (
        <DatagridColumnSkeleton serviceId={props.serviceId}>
          <DatagridColumnContact
            ...
            url={props.nicAdmin === nichandle && `${accountUrl as string}/useraccount/infos`}
          />
        </DatagridColumnSkeleton>
      ),
      ...
      cell: (props: AlldomService) => (
        <DatagridColumnSkeleton serviceId={props.serviceId}>
          <DatagridColumnContact
            ...
            url={props.nicTechnical === nichandle && `${accountUrl as string}/useraccount/infos`}
          />
        </DatagridColumnSkeleton>
      ),
      ...
      cell: (props: AlldomService) => (
        <DatagridColumnSkeleton serviceId={props.serviceId}>
          <DatagridColumnContact
            ...
            url={props.nicBilling === nichandle && `${accountUrl as string}/useraccount/infos`}
          />
        </DatagridColumnSkeleton>
      ),
