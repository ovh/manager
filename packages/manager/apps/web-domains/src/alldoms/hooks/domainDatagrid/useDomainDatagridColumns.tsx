...
import DomainDatagridColumnDomain from '@/alldoms/components/DomainDatagridColumns/DomainDatagrodColumnDomain';
...
export const useDomainDatagridColumns = () => {
  ...
  return useMemo(
    () => [
      ...
      {
        id: 'dns_server',
        cell: () => <DataGridTextCell>Dns serveur</DataGridTextCell>,
      ...
      {
        id: 'DNSSEC',
        cell: () => <DataGridTextCell>DNSSEC</DataGridTextCell>,
