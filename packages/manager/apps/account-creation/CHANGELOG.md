...
## [0.16.1](https://github.com/ovh/manager/compare/@ovh-ux/manager-account-creation-app@0.16.0...@ovh-ux/manager-account-creation-app@0.16.1) (2026-09-08)


### Bug Fixes

* update legal form code for administration ([0f2c897](https://github.com/ovh/manager/commit/0f2c89779674e92a664709e04693cfaf3c20e196)), closes [#MANAGER-22371](https://github.com/ovh/manager/issues/MANAGER-22371)
...
## [0.11.2](https://github.com/ovh/manager/compare/@ovh-ux/manager-account-creation-app@0.11.1...@ovh-ux/manager-account-creation-app@0.11.2) (2026-02-05)
...
## [0.11.1](https://github.com/ovh/manager/compare/@ovh-ux/manager-account-creation-app@0.11.0...@ovh-ux/manager-account-creation-app@0.11.1) (2026-02-04)
...
# [0.4.0](https://github.com/ovh/manager/compare/@ovh-ux/manager-account-creation-app@0.3.2...@ovh-ux/manager-account-creation-app@0.4.0) (2025-11-27)


### Bug Fixes

* **account-creation:** query params persistence ([d295238](https://github.com/ovh/manager/commit/d295238d975daccf817cdd90d4912be23379a1d9)), closes [#MANAGER-17394](https://github.com/ovh/manager/issues/MANAGER-17394)
...
* **account-creation:** remove mock and link api for settings page ([89b9d7b](https://github.com/ovh/manager/commit/89b9d7b7e1f02a5878d892133d4a3c5c11cda78e)), closes [#MANAGER-19878](https://github.com/ovh/manager/issues/MANAGER-19878)
...
# [0.3.0](https://github.com/ovh/manager/compare/@ovh-ux/manager-account-creation-app@0.2.3...@ovh-ux/manager-account-creation-app@0.3.0) (2025-11-17)


### Features

* **account-creation:** manage redirection from settings page ([68b8c3f](https://github.com/ovh/manager/commit/68b8c3fe3308b7ab9cfaa256fa7cbed850023081)), closes [#MANAGER-17394](https://github.com/ovh/manager/issues/MANAGER-17394)
...
## [0.2.1](https://github.com/ovh/manager/compare/@ovh-ux/manager-account-creation-app@0.2.0...@ovh-ux/manager-account-creation-app@0.2.1) (2025-11-13)
...
## [0.1.1](https://github.com/ovh/manager/compare/@ovh-ux/manager-account-creation-app@0.1.0...@ovh-ux/manager-account-creation-app@0.1.1) (2025-11-06)
...
# [0.1.0](https://github.com/ovh/manager/compare/@ovh-ux/manager-account-creation-app@0.0.0...@ovh-ux/manager-account-creation-app@0.1.0) (2025-11-05)


### Bug Fixes

* **account-creation:** add siren field in account creation ([4368721](https://github.com/ovh/manager/commit/43687217445936f8081f3f4209483a9c9571cc53)), closes [#MANAGER-20005](https://github.com/ovh/manager/issues/MANAGER-20005)
* **account-creation:** fix translation on siret page ([9f6d376](https://github.com/ovh/manager/commit/9f6d3761b8fd6438be0fa0a8fcc1b1b520658bcf)), closes [#MANAGER-20004](https://github.com/ovh/manager/issues/MANAGER-20004)
* **i18n:** add missing translations [CDS 675] ([d984286](https://github.com/ovh/manager/commit/d984286361b19b2a0165bb7992ac00f7f1481838))


### Features

* **account-creaction:** add account details form ([0ba9c10](https://github.com/ovh/manager/commit/0ba9c10983dd611ba38f5da1b3f64090a26a8f02)), closes [#MANAGER-17337](https://github.com/ovh/manager/issues/MANAGER-17337)
* **account-creation:** add navigation between steps ([4fac486](https://github.com/ovh/manager/commit/4fac4861db0c1c8faf49e16640eb8142e87e0f57)), closes [#MANAGER-19260](https://github.com/ovh/manager/issues/MANAGER-19260)
...
* **account-creation:** add privacy policy footer ([cfa06c2](https://github.com/ovh/manager/commit/cfa06c2a20c608f287b4e031924a0167601b5a5a)), closes [#MANAGER-18584](https://github.com/ovh/manager/issues/MANAGER-18584)
* **account-creation:** add smsm consent ([5827d6a](https://github.com/ovh/manager/commit/5827d6a98e5c4cd976f2adf9d13f051f35fb95f3)), closes [#MANAGER-19805](https://github.com/ovh/manager/issues/MANAGER-19805)
* **account-creation:** added user and redirection management ([27d992a](https://github.com/ovh/manager/commit/27d992a0511f87676465c53c492a149aedcfa390)), closes [#MANAGER-17333](https://github.com/ovh/manager/issues/MANAGER-17333)
* **account-creation:** created account type selection page ([720a62a](https://github.com/ovh/manager/commit/720a62a34dfc61e54751cfac9401c5a455835ee8)), closes [#MANAGER-17336](https://github.com/ovh/manager/issues/MANAGER-17336)
* **account-creation:** created company search page ([381cf27](https://github.com/ovh/manager/commit/381cf27ddaaef4cb0e13fca474a812d0e50d61b0)), closes [#MANAGER-17336](https://github.com/ovh/manager/issues/MANAGER-17336)
* **account-creation:** created the new µapp ([421f584](https://github.com/ovh/manager/commit/421f5843811f8aefb71befb19af0aa705cd32198)), closes [#MANAGER-17333](https://github.com/ovh/manager/issues/MANAGER-17333)
* **account-creation:** fix design and route parameters ([b2a01e8](https://github.com/ovh/manager/commit/b2a01e8bcf1615f6552983be992f0f9c349b3992)), closes [#MANAGER-17337](https://github.com/ovh/manager/issues/MANAGER-17337)
...
* **account-creation:** legal form specific wording and flow ([635e872](https://github.com/ovh/manager/commit/635e872dfdd942ea583f38d879aa2db3a414da18)), closes [#MANAGER-19260](https://github.com/ovh/manager/issues/MANAGER-19260)
* **account-creation:** migrate to new types from manager-config ([686db9d](https://github.com/ovh/manager/commit/686db9d7fd777362524114af660868e20d7f39e5)), closes [#MANAGER-17337](https://github.com/ovh/manager/issues/MANAGER-17337)
* **account-creation:** redirect non GB user to legacy signup ([f58bc91](https://github.com/ovh/manager/commit/f58bc916a9b81ad2611c38fed5886234d1da3bbe)), closes [#MANAGER-17392](https://github.com/ovh/manager/issues/MANAGER-17392)
* **account-creation:** refactor accountd details page ([42916c7](https://github.com/ovh/manager/commit/42916c78d1e78d2667c77873e4c5f5e5a8bdb341)), closes [#MANAGER-17337](https://github.com/ovh/manager/issues/MANAGER-17337)
* **account-creation:** refactor zod hook and file structure ([e2da469](https://github.com/ovh/manager/commit/e2da4694642888bc4a39fadd8eb89c773dc9ce2f)), closes [#MANAGER-17337](https://github.com/ovh/manager/issues/MANAGER-17337)
* **account-creation:** set up settings page ([ae72a47](https://github.com/ovh/manager/commit/ae72a47f75bce00be12826b9f3c6c63a30c59a1a)), closes [#MANAGER-17334](https://github.com/ovh/manager/issues/MANAGER-17334)
* **account-creation:** setup application layout ([028dbb3](https://github.com/ovh/manager/commit/028dbb38f9dd5cf7947c8180ad79ab9a5f94090a)), closes [#MANAGER-17333](https://github.com/ovh/manager/issues/MANAGER-17333)
* **account-creation:** update corportation field name ([#18719](https://github.com/ovh/manager/issues/18719)) ([c92004c](https://github.com/ovh/manager/commit/c92004cd5445ce68d788e5fa04579ac1fa7ee4f0)), closes [#MANAGER-19354](https://github.com/ovh/manager/issues/MANAGER-19354)
* **account-creation:** update tracking config on legal form change ([01b75e0](https://github.com/ovh/manager/commit/01b75e0ca5da78011f98a5afd045b12d6b4cb8e3)), closes [#MANAGER-17746](https://github.com/ovh/manager/issues/MANAGER-17746)
