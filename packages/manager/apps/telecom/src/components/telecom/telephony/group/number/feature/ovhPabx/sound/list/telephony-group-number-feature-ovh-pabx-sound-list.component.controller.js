...
angular.module('managerApp').controller('telephonyNumberOvhPabxSoundListCtrl', function telephonyNumberOvhPabxSoundListCtrl($timeout, $translate, $translatePartialLoader) {
  const self = this;
