...
angular.module('managerApp').controller('TelephonyNumberRedirectCtrl', function TelephonyNumberRedirectCtrl($q, $translate, TelephonyMediator, tucVoipServiceTask, TucToast) {
  const self = this;
