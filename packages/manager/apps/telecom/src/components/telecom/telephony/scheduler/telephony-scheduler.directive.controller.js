...
angular
  .module('managerApp')
  .controller('TelephonySchedulerCtrl', function TelephonySchedulerCtrl(
    $anchorScroll,
    $locale,
    $location,
    $q,
    ...
    self.getCalendarTitle = function getCalendarTitle() {
      return $(uiCalendarConfig.calendars.eventsCalendar).fullCalendar(
        'getView',
      ).title;
    };
    ...
    self.manageImport = function manageImport() {
      const importModal = $uibModal.open({
        ...
        backdrop: 'static',
        templateUrl:
          'components/telecom/telephony/scheduler/actions/import/telephony-scheduler-import.html',
    ...
    self.manageExport = function manageExport() {
      const exportModal = $uibModal.open({
        ...
        backdrop: 'static',
        templateUrl:
          'components/telecom/telephony/scheduler/actions/export/telephony-scheduler-export.html',
    ...
    self.manageBankHolidays = function manageBankHolidays() {
      const bankHolidaysModal = $uibModal.open({
        ...
        backdrop: 'static',
        templateUrl:
          'components/telecom/telephony/scheduler/actions/bankHolidays/telephony-scheduler-bank-holidays.html',
    ...
    self.manageDeleteAll = function manageDeleteAll() {
      ...
      $uibModal
        .open({
          templateUrl:
            'components/telecom/telephony/scheduler/actions/deleteAll/telephony-scheduler-delete-all.html',
