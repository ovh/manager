...
angular
  .module('managerApp')
  .factory(
    'TelephonyGroupNumberEasyPabx',
    ($q, VoipScheduler, VoipTimeCondition, OvhApiTelephonyEasyPabx) => {
      /*= ==================================
    =            CONSTRUCTOR            =
    =================================== */
    ...
    ========================================= */
      ...
      TelephonyGroupNumberEasyPabx.prototype.hasChange = function hasChange(
        attr,
      ) {
        const self = this;
