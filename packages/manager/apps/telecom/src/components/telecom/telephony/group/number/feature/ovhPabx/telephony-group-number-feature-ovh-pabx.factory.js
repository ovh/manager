...
angular
  ...
  .factory(
    ...
    ========================================= */
      ...
      TelephonyGroupNumberOvhPabx.prototype.hasChange = function hasChange(
        attr,
      ) {
        const self = this;
      ...
      TelephonyGroupNumberOvhPabx.prototype.getSound = function getSound(
        soundId,
      ) {
        const self = this;
       ...
       */
      TelephonyGroupNumberOvhPabx.prototype.removeMenu = function removeMenu(
        menu,
      ) {
        const self = this;
      ...
      TelephonyGroupNumberOvhPabx.prototype.getQueue = function getQueue(
        queueId,
      ) {
        const self = this;
      ...
      TelephonyGroupNumberOvhPabx.prototype.removeTts = function removeTts(
        tts,
      ) {
        const self = this;
