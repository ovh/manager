...
angular
  .module('managerApp')
  .controller(
    'voipTimeConditionConditionCtrl',
    function voipTimeConditionConditionCtrl($scope, $timeout, $translate) {
      const self = this;
    ...
    ============================== */
      ...
      self.updateRepeaterChoices = function updateRepeaterChoices(
        dayActive,
        day,
      ) {
        if (day.id < 7) {
