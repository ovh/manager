...
angular
  .module('managerApp')
  .controller(
    'telephonyNumberOvhPabxMenuEntryEditCtrl',
    function telephonyNumberOvhPabxMenuEntryEditCtrl(
      $scope,
      $q,
      $timeout,
      $translate,
        ...
        self.menuEntryCtrl.menuEntry.menuSub = self.menuEntryCtrl.menuCtrl.ovhPabx.addMenu(
          {
            ...
            oldParent: angular.copy(
              self.menuEntryCtrl.menuEntry.saveForEdition,
            ),
            status: 'DRAFT',
          },
        );
        ...
        return TelephonyMediator.getApiModelEnum(
          ...
          self.availableActions = map(
            filter(enumValues, (enumVal) => {
              if (
                self.menuEntryCtrl.menuCtrl.ovhPabx.featureType === 'cloudIvr'
              ) {
