...
angular
  .module('managerApp')
  .controller(
    'telephonyNumberOvhPabxMenuListCtrl',
    function telephonyNumberOvhPabxMenuListCtrl(
      $q,
      $timeout,
      $filter,
      $translate,
    ...
    =============================== */
        ...
        return some(
          ...
          (entry) =>
            ...
            (entry.actionParam === self.disableMenuId ||
              isDisabledMenuUsedInEntry(
                self.ovhPabx.getMenu(entry.actionParam),
              )),
        );
      }
      ...
      self.isMenuChoiceDisabled = function isMenuChoiceDisabled(menu) {
        return (
          self.disableMenuId &&
          (self.disableMenuId === menu.menuId ||
            isDisabledMenuUsedInEntry(menu))
        );
      };
