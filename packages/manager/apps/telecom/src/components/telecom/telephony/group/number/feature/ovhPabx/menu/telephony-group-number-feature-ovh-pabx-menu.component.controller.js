...
angular
  .module('managerApp')
  .controller(
    'telephonyNumberOvhPabxMenuCtrl',
    function telephonyNumberOvhPabxMenuCtrl(
      $q,
      $scope,
      $timeout,
      $translate,
      ...
      self.popoverStatus = {
        ...
        move: false,
        templateUrl:
          'components/telecom/telephony/group/number/feature/ovhPabx/menu/edit/telephony-group-number-feature-ovh-pabx-menu-edit.html',
    ...
    ============================== */
      ...
      self.onEditMenuEntryBtnClick = function onEditMenuEntryBtnClick() {
        self.popoverStatus.templateUrl =
          'components/telecom/telephony/group/number/feature/ovhPabx/menu/entry/edit/telephony-group-number-feature-ovh-pabx-menu-entry-edit.html';
        self.popoverStatus.isOpen = true;
      };

      self.onDialplanRuleEditBtnClick = function onDialplanRuleEditBtnClick() {
        self.popoverStatus.templateUrl =
          'components/telecom/telephony/group/number/feature/ovhPabx/dialplan/extension/rule/edit/telephony-group-number-feature-ovh-pabx-dialplan-extension-rule-edit.html';
        self.popoverStatus.isOpen = true;
      };
      ...
      self.onMenuOutsideClick = function onMenuOutsideClick() {
        if (
          ...
          (self.dialplanRule &&
            self.dialplanRule.status === 'DELETE_PENDING') ||
    ...
    ====================================== */
      ...
      self.$onInit = function $onInit() {
        ...
        // set controller uuid
        self.uuid = uniqueId(
          'ovhPabx_menu_'.concat(get(self.menu, 'menuId', '')),
        );
