...
angular
  .module('managerApp')
  .factory(
    'TelephonyGroupNumberMiniPabx',
    ($q, VoipScheduler, VoipTimeCondition, OvhApiTelephonyMiniPabx) => {
      /*= ==================================
    =            CONSTRUCTOR            =
    =================================== */
    ...
    ========================================= */
      ...
      TelephonyGroupNumberMiniPabx.prototype.hasChange = function hasChange(
        attr,
      ) {
        const self = this;
