...
angular.module('managerApp').controller('TelephonyNumberConferenceCtrl', function TelephonyNumberConferenceCtrl($q, $translate, TelephonyMediator, telephonyGroupNumberConferencePolling, TucToast, TucToastError) {
  const self = this;
