...
angular
  .module('managerApp')
  .controller(
    'TelephonyNumberConferenceCtrl',
    function TelephonyNumberConferenceCtrl(
      $q,
      $translate,
      TelephonyMediator,
    ...
    ============================================ */
      ...
      self.manageSoundParticipant = function manageSoundParticipant(
        participant,
      ) {
    ...
    ============================== */
      ...
      self.togglePopover = function togglePopover() {
        ...
        if (self.popoverOpen) {
          ...
          assign(
            self,
            pick(self.numberCtrl.number.feature, settingsAttributes),
          );
        } else {
          self.numberCtrl.number.feature.stopEdition(true);
