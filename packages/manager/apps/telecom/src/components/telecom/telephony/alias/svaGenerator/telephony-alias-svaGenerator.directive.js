...
angular
  ...
  .directive(
    'svaGenerator',
    ($q, $translatePartialLoader, $translate, $timeout, SvaGeneratorConfig) => {
      ...
      function formatNumber(n, format) {
        switch (format) {
          case '0 8AB XXX XXX':
            return `${n[0]} ${n.slice(1, 4)} ${n.slice(4, 7)} ${n.slice(
              7,
              10,
            )}`;
          case '0 8AB XX XX XX':
          ...
          case '0 8AB XXXX XX':
            return `${n[0]} ${n.slice(1, 4)} ${n.slice(4, 8)} ${n.slice(
              8,
              10,
            )}`;
          case '08 AB XX XX XX':
      ...
      return {
        ...
        templateUrl:
          'components/telecom/telephony/alias/svaGenerator/telephony-alias-svaGenerator.html',
        link(scope, element) {
          ...
          $translatePartialLoader.addPart(
            '../components/telecom/telephony/alias/svaGenerator',
          );
