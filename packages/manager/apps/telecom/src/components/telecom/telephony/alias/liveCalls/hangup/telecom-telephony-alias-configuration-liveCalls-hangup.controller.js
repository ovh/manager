...
angular.module('managerApp').controller('TelecomTelephonyAliasConfigurationLiveCallsHangupCtrl', function TelecomTelephonyAliasConfigurationLiveCallsHangupCtrl($uibModalInstance, $translate, TucToast, params) {
  const self = this;
