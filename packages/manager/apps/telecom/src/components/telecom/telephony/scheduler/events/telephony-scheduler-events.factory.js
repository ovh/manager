...
angular
  ...
  .factory(
    'VoipSchedulerEvent',
    (OvhApiTelephony, SCHEDULER_CATEGORY_TO_ICS_VEVENT_CATEGORY) => {
    ...
    ========================================= */
      ...
      VoipSchedulerEvent.prototype.toIcsVEvent = function toIcsVEvent(
        ...
        const convertToVEventEntry = function convertToVEventEntry(
          ...
          switch (attribute) {
            case 'categories':
              attributeValue =
                SCHEDULER_CATEGORY_TO_ICS_VEVENT_CATEGORY[get(self, attribute)];
              break;
            case 'dateEnd':
            case 'dateStart':
      ...
      VoipSchedulerEvent.prototype.isFullDay = function isFullDay() {
        ...
        return (
          ...
          durationCheck(
            moment.duration(
              momentEndDate.add(1, 'seconds').diff(momentStartDate),
            ),
          )
        );
      };
