...
angular
  .module('managerApp')
  .controller(
    'telephonyNumberOvhPabxDialplanExtensionEditCtrl',
    function telephonyNumberOvhPabxDialplanExtensionEditCtrl(
      $scope,
      $q,
      telephonyScheduler,
      voipTimeCondition,
    ...
    =============================== */
      ...
      self.isConditionGroupValid = function isConditionGroupValid(
        conditionGroup,
      ) {
        return (
          ...
          self.availableHours.indexOf(conditionGroup.slotTimeModel.timeFrom) !==
            -1 &&
          self.availableHours.indexOf(conditionGroup.slotTimeModel.timeTo) !==
            -1
        );
      };
      ...
      function hasConditionCollision(
        timeConditions,
        timeFromParam,
        timeToParam,
      ) {
