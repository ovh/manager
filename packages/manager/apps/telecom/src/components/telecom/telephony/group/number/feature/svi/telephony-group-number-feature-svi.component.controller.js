...
angular
  .module('managerApp')
  .controller('TelephonyNumberSviCtrl', function TelephonyNumberSviCtrl(
    $q,
    $translate,
    tucValidator,
    TucToast,
    ...
    self.urlRecordModel = function urlRecordModel(newUrl) {
      ...
      return self.numberCtrl.number.feature.urlRecord.replace(
        protocolRegexp,
        '',
      );
    };
    ...
    self.togglePopover = function togglePopover() {
      ...
      if (self.popoverOpen) {
        ...
        self.model.urlProtocol = getProtocol(
          self.numberCtrl.number.feature.url,
        );
