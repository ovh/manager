...
angular
  .module('managerApp')
  .controller(
    'telephonyNumberOvhPabxMenuEntryCtrl',
    function telephonyNumberOvhPabxMenuEntryCtrl($q) {
      const self = this;
    ...
    =============================== */
      ...
      self.getEntryAttribute = function getEntryAttribute(attr) {
        ...
        return get(
          self.menuEntry.inEdition
            ? self.menuEntry.saveForEdition
            : self.menuEntry,
          attr,
        );
      };
    ...
    ====================================== */
      ...
      self.$onInit = function $onInit() {
        ...
        self.uuid = uniqueId(
          'ovhPabx_menu_entry_'.concat(self.menuEntry.entryId),
        ); // set controller unique id
