...
export default /* @ngInject */ function PackExchangeIndividualEmailAddCtrl(
  $q,
  $scope,
  $stateParams,
  ...
  this.add = function add() {
    ...
    return OvhApiPackXdslExchangeIndividual.v6()
      .save(
        {
  ...
  this.init = function init() {
    ...
    OvhApiPackXdslExchangeIndividual.v6().getDomains(
      { packId: $stateParams.packName },
      (domains) => {
