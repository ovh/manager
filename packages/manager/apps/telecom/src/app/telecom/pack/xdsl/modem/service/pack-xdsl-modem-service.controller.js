angular.module('managerApp').controller('XdslModemServiceCtrl', class XdslModemServiceCtrl {
  /* @ngInject */
  constructor($q, $stateParams, $translate, $uibModal, OvhApiXdsl, TucPackXdslModemMediator,
    TucToast) {
    this.$q = $q;
  ...
  getBlocIP() {
    ...
    return this.OvhApiXdsl.Modem().BlocIp().v6().get({
  ...
  updateBlocIp(status) {
    return this.OvhApiXdsl.Modem().BlocIp().v6().post({
      xdslId: this.$stateParams.serviceName,
    },
    {
      status,
      ...
      .then((xdslTask) => {
        ...
        this.TucToast.success(this.$translate.instant('xdsl_modem_service_bloc_ip_doing'));
        return xdslTask;
      }).catch((err) => {
        const blocip = this.getService('blocIP');
        blocip.value = !blocip.value;
        this.TucToast.error(this.$translate.instant('xdsl_modem_service_bloc_ip_an_error_ocurred'));
  ...
  getCallWaiting() {
    ...
    return this.OvhApiXdsl.Modem().CallWaiting().v6().get({
      xdslId: this.$stateParams.serviceName,
    }).$promise
      .then(({ xdslTask }) => {
  ...
  updateCallWaiting(status) {
    return this.OvhApiXdsl.Modem().CallWaiting().v6().post({
      xdslId: this.$stateParams.serviceName,
    },
    {
      callWaiting: status,
      ...
      .then((xdslTask) => {
        ...
        this.TucToast.success(this.$translate.instant('xdsl_modem_service_call_waiting_doing'));
        return xdslTask;
      }).catch((err) => {
        const callWaiting = this.getService('callWaiting');
        callWaiting.value = !callWaiting.value;
        this.TucToast.error(this.$translate.instant('xdsl_modem_service_call_waiting_an_error_ocurred'));
        return this.$q.reject(err);
      });
  }
  ...
  getContentSharing() {
    ...
    return this.OvhApiXdsl.Modem().ContentSharing().v6().get({
      xdslId: this.$stateParams.serviceName,
    }).$promise
      .then(({ xdslTask }) => {
  ...
  updateContentSharing(status) {
    return this.OvhApiXdsl.Modem().ContentSharing().v6().post({
      xdslId: this.$stateParams.serviceName,
    },
    {
      ...
      .then((xdslTask) => {
        ...
        this.TucToast.success(this.$translate.instant('xdsl_modem_service_content_sharing_doing'));
        return xdslTask;
      }).catch((err) => {
        const contentSharing = this.getService('contentSharing');
        contentSharing.value = !contentSharing.value;
        this.TucToast.error(this.$translate.instant('xdsl_modem_service_content_sharing_an_error_ocurred'));
        return this.$q.reject(err);
      });
  }
  ...
  getFTP() {
    ...
    return this.OvhApiXdsl.Modem().Ftp().v6().get({
      xdslId: this.$stateParams.serviceName,
    }).$promise
      .then(({ xdslTask }) => {
  ...
  updateFTP(status) {
    return this.OvhApiXdsl.Modem().Ftp().v6().post({
      xdslId: this.$stateParams.serviceName,
    },
    {
      ftp: status,
      ...
      .then((xdslTask) => {
        ...
        this.TucToast.success(this.$translate.instant('xdsl_modem_service_ftp_doing'));
        return xdslTask;
      }).catch((err) => {
        const ftp = this.getService('ftp');
        ftp.value = !ftp.value;
        this.TucToast.error(this.$translate.instant('xdsl_modem_service_ftp_an_error_ocurred'));
        return this.$q.reject(err);
      });
  }
  ...
  getIpsecAlg() {
    ...
    return this.OvhApiXdsl.Modem().IpsecAlg().v6().get({
      xdslId: this.$stateParams.serviceName,
    }).$promise
      .then(({ xdslTask }) => {
  ...
  updateIpsecAlg(status) {
    return this.OvhApiXdsl.Modem().IpsecAlg().v6().post({
      xdslId: this.$stateParams.serviceName,
    },
    {
      ipsecAlg: status,
      ...
      .then((xdslTask) => {
        ...
        this.TucToast.success(this.$translate.instant('xdsl_modem_service_ipsec_alg_doing'));
        return xdslTask;
      }).catch((err) => {
        const ipsecAlg = this.getService('ipsecAlg');
        ipsecAlg.value = !ipsecAlg.value;
        this.TucToast.error(this.$translate.instant('xdsl_modem_service_ipsec_alg_an_error_ocurred'));
        return this.$q.reject(err);
      });
  }
  ...
  getSipAlg() {
    ...
    return this.OvhApiXdsl.Modem().SipAlg().v6().get({
      xdslId: this.$stateParams.serviceName,
    }).$promise
      .then(({ xdslTask }) => {
  ...
  updateSipAlg(status) {
    return this.OvhApiXdsl.Modem().SipAlg().v6().post({
      xdslId: this.$stateParams.serviceName,
    },
    {
      sipAlg: status,
      ...
      .then((xdslTask) => {
        ...
        this.TucToast.success(this.$translate.instant('xdsl_modem_service_sip_alg_doing'));
        return xdslTask;
      }).catch((err) => {
        const sipAlg = this.getService('sipAlg');
        sipAlg.value = !sipAlg.value;
        this.TucToast.error(this.$translate.instant('xdsl_modem_service_sip_alg_an_error_ocurred'));
        return this.$q.reject(err);
      });
  }
  ...
  getUPnP() {
    ...
    return this.OvhApiXdsl.Modem().Upnp().v6().get({
      xdslId: this.$stateParams.serviceName,
    }).$promise
      .then(({ xdslTask }) => {
  ...
  updateUPnP(status) {
    return this.OvhApiXdsl.Modem().Upnp().v6().post({
      xdslId: this.$stateParams.serviceName,
    },
    {
      upnp: status,
      ...
      .then((xdslTask) => {
        ...
        this.TucToast.success(this.$translate.instant('xdsl_modem_service_upnp_doing'));
        return xdslTask;
      }).catch((err) => {
        const upnp = this.getService('upnp');
        upnp.value = !upnp.value;
        this.TucToast.error(this.$translate.instant('xdsl_modem_service_upnp_an_error_ocurred'));
        return this.$q.reject(err);
      });
  }
  ...
  changeValue(name, value) {
    switch (name) {
      ...
      case 'contentSharing':
        this.$uibModal.open({
          animation: true,
          templateUrl: 'app/telecom/pack/xdsl/modem/service/modal/pack-xdsl-modem-service-modal.html',
