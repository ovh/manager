...
angular.module('managerApp').controller('XdslModemPortsCtrl', function XdslModemPortsCtrl($stateParams, $translate, $scope, OvhApiXdslModemPort, TucToast, PackXdslModemPortObject, tucValidator, TucPackXdslModemMediator) {
  const self = this;
  self.loader = true;
