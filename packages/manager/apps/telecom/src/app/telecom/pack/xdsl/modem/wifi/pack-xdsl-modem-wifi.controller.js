...
angular.module('managerApp').controller('XdslModemWifiCtrl', function XdslModemWifiCtrl($stateParams, $translate, $q, OvhApiXdsl, TucToast, TucPackXdslModemMediator) {
  const self = this;
  this.loader = true;
