...
angular.module('managerApp').controller('XdslAccessProfileCtrl', function XdslAccessProfileCtrl($stateParams, $scope, $translate, OvhApiXdslLinesDslamPort, TucToast, TucToastError) {
  const self = this;
