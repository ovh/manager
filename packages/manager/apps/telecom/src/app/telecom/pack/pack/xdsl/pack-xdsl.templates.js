...
export default /* @ngInject */ ($templateCache) => {
  ...
  $templateCache.put(
    'app/telecom/pack/pack/xdsl/access/ipv6/pack-xdsl-access-ipv6.html',
    packXdslAccessIpv6,
  );
  $templateCache.put(
    'app/telecom/pack/pack/xdsl/access/profil/pack-xdsl-access-profil.html',
    packXdslAccessProfil,
  );
  $templateCache.put(
    'app/telecom/pack/pack/xdsl/access/rateLimit/xdsl-access-lns-ratelimit.html',
    xdslAccessLnsRatelimit,
  );
  $templateCache.put(
    'app/telecom/pack/pack/xdsl/access/portReset/pack-xdsl-access-port-reset.html',
    packXdslAccessPortReset,
  );
  $templateCache.put(
    'app/telecom/pack/pack/xdsl/access/statistics/pack-xdsl-statistics.html',
    packXdslStatistics,
  );
};
