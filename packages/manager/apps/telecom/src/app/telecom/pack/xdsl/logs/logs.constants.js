export const XDSL_LOG_KEYS = ['message'];
...
const logsPrefix = 'telecom::pack::xdsl::logs';
export const XDSL_LOGS_TRACKING_HITS = {
...
export const XDSL_DATA_STREAMS_TRACKING_HITS = {
