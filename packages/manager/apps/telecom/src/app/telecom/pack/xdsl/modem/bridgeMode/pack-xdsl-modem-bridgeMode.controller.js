...
angular
  .module('managerApp')
  .controller('XdslModemBridgeModeCtrl', function XdslModemBridgeModeCtrl(
    $stateParams,
    $q,
    $translate,
    OvhApiXdsl,
      ...
      OvhApiXdsl.Modem()
        ...
        .$promise.then((data) => {
          ...
          if (self.isBridged) {
            TucToast.success(
              $translate.instant(
                'xdsl_modem_bridge_mode_success_validation_on',
              ),
            );
          } else {
            TucToast.success(
              $translate.instant(
                'xdsl_modem_bridge_mode_success_validation_off',
              ),
            );
          }
          return data;
