...
export default /* @ngInject */ ($templateCache) => {
  ...
  $templateCache.put(
    'app/telecom/pack/pack/slots/voipLine/pack-voipLine.html',
    packVoipLine,
  );
  $templateCache.put(
    'app/telecom/pack/pack/slots/task/pack-task.html',
    packTask,
  );
  $templateCache.put(
    'app/telecom/pack/pack/slots/voipEcoFax/pack-voipEcoFax.html',
    packVoipEcoFax,
  );
  $templateCache.put(
    'app/telecom/pack/pack/slots/hubic/pack-hubic.html',
    packHubic,
  );
  $templateCache.put(
    'app/telecom/pack/pack/slots/exchangeAccount/pack-exchangeAccount.html',
    packExchangeAccount,
  );
  $templateCache.put(
    'app/telecom/pack/pack/slots/xdslAccess/pack-xdslAccess.html',
    packXdslAccess,
  );
  $templateCache.put(
    'app/telecom/pack/pack/slots/informations/pack-informations.html',
    packInformations,
  );
  $templateCache.put(
    'app/telecom/pack/pack/slots/promotionCode/pack-promotionCode.html',
    packPromotionCode,
  );
  $templateCache.put(
    'app/telecom/pack/pack/slots/domain/pack-domain.html',
    packDomain,
  );
};
