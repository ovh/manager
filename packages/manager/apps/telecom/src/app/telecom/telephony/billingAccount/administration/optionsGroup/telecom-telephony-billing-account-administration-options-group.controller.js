...
angular
  ...
  .controller(
    ...
    function TelecomTelephonyBillingAccountAdministrationOptionsGroup(
      $q,
      $state,
      $stateParams,
      $translate,
    ...
    =============================== */
      ...
      self.hasChanges = function hasChanges() {
        return !(
          angular.equals(
            self.telephonySettings,
            self.optionsGroupForm.telephony,
    ...
    =============================== */
      ...
      self.changeSettings = function changeSettings() {
        ...
        return $q
          ...
          .then(() => {
            self.telephonySettings = angular.copy(
              self.optionsGroupForm.telephony,
            );
      ...
      function init() {
        ...
        return fetchSettings()
          .then((settings) => {
            ...
            self.optionsGroupForm.telephony = angular.copy(
              self.telephonySettings,
            );
            self.optionsGroupForm.user = angular.copy(self.userSettings);
          })
