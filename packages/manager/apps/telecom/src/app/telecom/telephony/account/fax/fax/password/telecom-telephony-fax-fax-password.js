  ...
  $stateProvider.state('telecom.telephony.billingAccount.fax.fax.password', {
    ...
    views: {
      'telephonyView@telecom.telephony': {
        templateUrl:
          'app/telecom/telephony/account/fax/fax/password/telecom-telephony-fax-fax-password.html',
        noTranslations: true,
      },
      'faxPasswordView@telecom.telephony.billingAccount.fax.fax.password': {
        templateUrl:
          'app/telecom/telephony/account/service/fax/password/telecom-telephony-service-fax-password.html',
