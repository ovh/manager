...
import removeUserTemplate from './remove-user/remove-user.html';
import removeUserController from './remove-user/remove-user.controller';

export default /* @ngInject */ function TelecomTelephonyLineClick2CallCtrl(
  $stateParams,
  $state,
  TelephonyMediator,
  TucToast,
