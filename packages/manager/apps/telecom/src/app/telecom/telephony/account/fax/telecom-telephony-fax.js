  ...
  $stateProvider.state('telecom.telephony.billingAccount.fax', {
    ...
    views: {
      'telephonyView@telecom.telephony': {
        templateUrl:
          'app/telecom/telephony/account/fax/telecom-telephony-fax.html',
      },
      'faxView@telecom.telephony.billingAccount.fax': {
        templateUrl:
          'app/telecom/telephony/account/fax/telecom-telephony-fax-main-view.html',
        controller: 'TelecomTelephonyFaxCtrl',
        controllerAs: '$ctrl',
      },
      'faxInnerView@telecom.telephony.billingAccount.fax': {
        templateUrl:
          'app/telecom/telephony/account/fax/management/telecom-telephony-fax-management.html',
