...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyAliasOrderInternationalCtrl',
    function TelecomTelephonyAliasOrderInternationalCtrl(
      $q,
      $translate,
      $stateParams,
      OvhApiTelephony,
        ...
        OvhApiOrder.Telephony()
          ...
          .$promise.then(
            (response) => {
              ...
              TucToast.success(
                $translate.instant(
                  'telephony_order_international_order_success',
                ),
              );
              self.orderDone = true;
              return response;
    ...
    ====================================== */
      ...
      function init() {
        ...
        $q.all([
          TelecomTelephonyBillingAccountOrderAliasService.getUser().then(
            (user) => {
              self.user = user;
          ...
          TelecomTelephonyBillingAccountOrderAliasService.getForeignCountries().then(
            ...
            (err) => {
              TucToastError(
                $translate.instant(
                  'telephony_order_international_countries_error',
                ),
              );
              return $q.reject(err);
            },
