  ...
  $stateProvider.state('telecom.telephony.billingAccount.orderAlias', {
    ...
    views: {
      'groupInnerView@telecom.telephony.billingAccount': {
        templateUrl:
          'app/telecom/telephony/account/billingAccount/orderAlias/telecom-telephony-billing-account-orderAlias.html',
      },
      'telecomTelephonyBillingAccountOrderAliasView@telecom.telephony.billingAccount.orderAlias': {
        templateUrl:
          'app/telecom/telephony/account/billingAccount/orderAlias/telecom-telephony-billing-account-orderAlias-main.view.html',
