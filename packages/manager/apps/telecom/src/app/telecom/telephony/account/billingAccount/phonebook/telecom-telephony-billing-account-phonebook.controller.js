...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyBillingAccountPhonebookCtrl',
    function TelecomTelephonyBillingAccountPhonebookCtrl(
      $document,
      $filter,
      $q,
      $scope,
              ...
              .then((chunkResult) => {
                ...
                return forEach(result, (contact) => {
                  ...
                  set(
                    contact,
                    'homePhone',
                    contact.homePhone === emptyPhoneNumber
                      ? ''
                      : contact.homePhone,
                  );
                  set(
                  ...
                  set(
                    contact,
                    'workPhone',
                    contact.workPhone === emptyPhoneNumber
                      ? ''
                      : contact.workPhone,
                  );
                });
    ...
    =============================== */
      ...
      self.deletePhonebook = function deletePhonebook() {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/account/billingAccount/phonebook/remove/telecom-telephony-billing-account-phonebook-remove.html',
      ...
      self.addPhonebookContact = function addPhonebookContact() {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/account/billingAccount/phonebook/contact-add/telecom-telephony-billing-account-phonebook-contact-add.html',
      ...
      self.importPhonebookContact = function importPhonebookContact() {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/account/billingAccount/phonebook/contact-import/telecom-telephony-billing-account-phonebook-contact-import.html',
          controller:
            'TelecomTelephonyBillingAccountPhonebookContactImportCtrl',
        ...
        modal.result
          ...
          .catch((err) => {
            if (err && err.type === 'API') {
              TucToast.error(
                $translate.instant(
                  'telephony_phonebook_contact_action_import_ko',
      ...
      self.exportPhonebookContact = function exportPhonebookContact() {
        ...
        return tryGetCsvExport()
          .then((phonebook) => {
            ...
            TucToast.success(
              $translate.instant(
                'telephony_phonebook_contact_action_export_ok',
              ),
            );
          })
          .catch((err) => {
            TucToast.error(
              [
                $translate.instant(
                  'telephony_phonebook_contact_action_export_ko',
                ),
                (err.data && err.data.message) || '',
              ].join(' '),
            );
      ...
      self.updatePhonebookContact = function updatePhonebookContact(contact) {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/account/billingAccount/phonebook/contact-update/telecom-telephony-billing-account-phonebook-contact-update.html',
          controller:
            'TelecomTelephonyBillingAccountPhonebookContactUpdateCtrl',
