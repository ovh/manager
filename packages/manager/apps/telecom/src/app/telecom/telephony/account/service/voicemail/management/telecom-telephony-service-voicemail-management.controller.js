...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyServiceVoicemailManagementCtrl',
    function TelecomTelephonyServiceVoicemailManagementCtrl(
      $scope,
      $stateParams,
      $q,
      $translate,
              ...
              .then((chunkResult) => {
                ...
                return map(result, (message) => {
                  set(
                    message,
                    'durationAsDate',
                    new Date(message.duration * 1000),
                  );
      ...
      this.getSelection = function getSelection() {
        return filter(
          ...
          (message) =>
            ...
            self.messages.selected[message.id],
        );
      };
