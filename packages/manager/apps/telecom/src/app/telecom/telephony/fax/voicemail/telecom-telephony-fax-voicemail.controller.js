...
angular.module('managerApp').controller('TelecomTelephonyFaxVoicemailCtrl', function TelecomTelephonyFaxVoicemailCtrl($q, $stateParams, $translate, TelephonyMediator, TucToast) {
  const self = this;
