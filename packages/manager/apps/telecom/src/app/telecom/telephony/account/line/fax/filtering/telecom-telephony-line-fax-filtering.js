  ...
  $stateProvider.state('telecom.telephony.billingAccount.line.fax.filtering', {
    ...
    views: {
      'lineView@telecom.telephony.billingAccount.line': {
        templateUrl:
          'app/telecom/telephony/account/line/fax/filtering/telecom-telephony-line-fax-filtering.html',
        noTranslations: true,
      },
      'faxFilteringView@telecom.telephony.billingAccount.line.fax.filtering': {
        templateUrl:
          'app/telecom/telephony/account/service/fax/filtering/telecom-telephony-service-fax-filtering.html',
