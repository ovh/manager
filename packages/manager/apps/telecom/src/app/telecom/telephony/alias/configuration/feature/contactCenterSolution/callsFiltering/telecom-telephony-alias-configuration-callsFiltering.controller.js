  ...
  class TelecomTelephonyAliasConfigurationCallsFilteringCtrl {
    ...
    deleteConditions(conditions) {
      this.$uibModal
        .open({
          templateUrl:
            'app/telecom/telephony/alias/configuration/feature/contactCenterSolution/callsFiltering/delete/telecom-telephony-alias-configuration-calls-filtering-delete.html',
          controller:
