...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyAliasConfigurationTonesOldPabxCtrl',
    function TelecomTelephonyAliasConfigurationTonesOldPabxCtrl(
      $q,
      $stateParams,
      $translate,
      $timeout,
  ...
  =============================== */
      ...
      self.checkValidSound = function checkValidSound(file, toneType) {
        ...
        return (
          !self.formErrors[toneType].format && !self.formErrors[toneType].size
        );
      };
