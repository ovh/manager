    ...
    openManageSoundsHelper(modelToUpdate) {
      this.$uibModal
        .open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/alias/configuration/feature/contactCenterSolution/sounds/add/telecom-telephony-alias-configuration-contactCenterSolution-sounds-add.html',
          controller:
