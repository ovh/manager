  ...
  $stateProvider.state('telecom.telephony.billingAccount.line.fax.campaigns', {
    ...
    views: {
      'lineView@telecom.telephony.billingAccount.line': {
        templateUrl:
          'app/telecom/telephony/account/line/fax/campaigns/telecom-telephony-line-fax-campaigns.html',
        noTranslations: true,
      },
      'faxCampaignsView@telecom.telephony.billingAccount.line.fax.campaigns': {
        templateUrl:
          'app/telecom/telephony/account/service/fax/campaigns/telecom-telephony-service-fax-campaigns.html',
