...
angular.module('managerApp').controller('TelecomTelephonyBillingAccountAdministrationAddGroup', function TelecomTelephonyBillingAccountAdministrationAddGroup($stateParams, $translate, $timeout, OvhApiOrderTelephony, TucToastError) {
  const self = this;
