...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyBillingAccountManageContactsCtrl',
    function TelecomTelephonyBillingAccountManageContactsCtrl(
      $stateParams,
      $q,
      $translate,
      OvhApiTelephony,
      ...
      function init() {
        ...
        return $q
          .all({
            billingAccount: TelephonyMediator.getGroup(
      ...
      self.submitChanges = function submitChanges(contact) {
        ...
        return promise
          ...
          .then((tasks) => {
            ...
            TucToast.success(
              $translate.instant(
                'telephony_group_manage_contacts_change_success',
              ),
            );
          })
          .catch((err) => new TucToastError(err))
