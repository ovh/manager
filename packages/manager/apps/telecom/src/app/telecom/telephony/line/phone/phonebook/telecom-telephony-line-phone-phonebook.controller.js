    ...
    =============================== */
      ...
      self.deletePhonebook = function deletePhonebook() {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/line/phone/phonebook/remove/telecom-telephony-line-phone-phonebook-remove.html',
      ...
      self.addPhonebookContact = function addPhonebookContact() {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/line/phone/phonebook/contact-add/telecom-telephony-line-phone-phonebook-contact-add.html',
      ...
      self.importPhonebookContact = function importPhonebookContact() {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/line/phone/phonebook/contact-import/telecom-telephony-line-phone-phonebook-contact-import.html',
      ...
      self.updatePhonebookContact = function updatePhonebookContact(contact) {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/line/phone/phonebook/contact-update/telecom-telephony-line-phone-phonebook-contact-update.html',
