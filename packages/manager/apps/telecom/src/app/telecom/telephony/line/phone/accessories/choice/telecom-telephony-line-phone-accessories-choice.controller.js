...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyLinePhoneAccessoriesChoiceCtrl',
    function TelecomTelephonyLinePhoneAccessoriesChoiceCtrl(
      $q,
      $translate,
    ...
    =============================== */
      ...
      self.updateOrderTotal = function updateOrderTotal() {
        ...
        self.orderTotal = TucTelephonyAccessoriesOrderProcess.getPriceStruct(
          total,
        );
    ...
    ====================================== */
      ...
      function init() {
        ...
        return TucTelephonyAccessoriesOrderProcess.getAvailableAccessories()
          .then(
            (orderProcess) => {
