...
angular.module('managerApp').controller(
  'TelecomTelephonyAliasSpecialRsvaCtrl',
  class TelecomTelephonyAliasSpecialRsvaCtrl {
    constructor(
      $q,
      $state,
      $stateParams,
    ...
    $onInit() {
      ...
      return this.$q
        ...
        .then(({ directory, rateCodeInfos, rsvaInfos, schema }) => {
          ...
          this.pricingType =
            this.rateCode.pricePerMinuteWithoutTax.value > 0
              ? 'minute'
              : 'call';
          ...
          if (
            has(schema, "models['telephony.NumberSpecialTypologyEnum'].enum")
          ) {
