...
angular.module('managerApp').controller(
  'TelecomTelephonyLineTrunkSimultaneousLines',
  class TelecomTelephonyLineTrunkSimultaneousLines {
    constructor(
      $q,
      $stateParams,
      $translate,
    ...
    buildChart() {
      ...
      this.chart = new this.TucChartjsFactory(
        angular.copy(this.TRUNK_PACK_DETAILS.chart),
      );
