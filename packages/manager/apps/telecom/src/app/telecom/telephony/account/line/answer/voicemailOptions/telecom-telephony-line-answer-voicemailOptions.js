    ...
    'telecom.telephony.billingAccount.line.voicemailOptions',
    {
      ...
      views: {
        'lineView@telecom.telephony.billingAccount.line': {
          templateUrl:
            'app/telecom/telephony/account/line/answer/voicemailOptions/telecom-telephony-line-answer-voicemailOptions.html',
          noTranslations: true,
        },
        'voicemailView@telecom.telephony.billingAccount.line.voicemailOptions': {
          templateUrl:
            'app/telecom/telephony/account/service/voicemail/options/telecom-telephony-service-voicemail-options.html',
