export default /* @ngInject */ function TelecomTelephonyLineFaxCtrl(
  ...
  function init() {
    self.actions = [
      {
        name: 'line_password',
        sref: 'telecom.telephony.billingAccount.line.dashboard.fax.password',
        text: $translate.instant('telephony_line_fax_action_line_password'),
      },
      {
        name: 'line_settings',
        sref: 'telecom.telephony.billingAccount.line.dashboard.fax.settings',
      ...
      {
        name: 'line_filtering',
        sref: 'telecom.telephony.billingAccount.line.dashboard.fax.filtering',
        text: $translate.instant('telephony_line_fax_action_line_filtering'),
      },
      {
        name: 'line_campaign_management',
        sref: 'telecom.telephony.billingAccount.line.dashboard.fax.campaigns',
