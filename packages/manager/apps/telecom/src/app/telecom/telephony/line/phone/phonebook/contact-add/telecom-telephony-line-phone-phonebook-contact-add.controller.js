...
angular.module('managerApp').controller('TelecomTelephonyLinePhonePhonebookContactAddCtrl', function TelecomTelephonyLinePhonePhonebookContactAddCtrl($q, $stateParams, $timeout, $uibModalInstance, TelephonyMediator, OvhApiTelephony, TucPhonebookcontact, data) {
  const self = this;
