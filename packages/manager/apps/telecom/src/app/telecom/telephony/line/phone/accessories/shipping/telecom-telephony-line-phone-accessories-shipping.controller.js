...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyLinePhoneAccessoriesShippingCtrl',
    function TelecomTelephonyLinePhoneAccessoriesShippingCtrl(
      $q,
    ...
    =============================== */
      ...
      function initComponentsOptions() {
        ...
        self.shippingOptions.disableMondialRelay =
          getTotalAccessoriesQuantity() > 1;

        // contact options
        self.contactDeferred.promise.then(() =>
          TucTelephonyAccessoriesOrderProcess.getOrderCheckout()
            .then((order) => {
              each(
