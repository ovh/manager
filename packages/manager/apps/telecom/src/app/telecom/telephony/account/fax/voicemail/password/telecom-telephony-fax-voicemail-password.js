    ...
    'telecom.telephony.billingAccount.fax.voicemail.password',
    {
      ...
      views: {
        'faxView@telecom.telephony.billingAccount.fax': {
          templateUrl:
            'app/telecom/telephony/account/fax/voicemail/password/telecom-telephony-fax-voicemail-password.html',
          noTranslations: true,
        },
        'voicemailView@telecom.telephony.billingAccount.fax.voicemail.password': {
          templateUrl:
            'app/telecom/telephony/account/service/voicemail/password/telecom-telephony-service-voicemail-password.html',
