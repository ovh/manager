  ...
  =============================== */
      ...
      self.addCampaign = function addCampaign() {
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/service/fax/campaigns/add/telecom-telephony-service-fax-campaigns-add.html',
      ...
      self.readCampaign = function readCampaign(campaign) {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/service/fax/campaigns/read/telecom-telephony-service-fax-campaigns-read.html',
      ...
      self.removeCampaign = function removeCampaign(campaign) {
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/service/fax/campaigns/remove/telecom-telephony-service-fax-campaigns-remove.html',
