    ...
    function TelecomTelephonyLineAssistTroubleshootingCtrl(
      ...
      const commonSteps = {
        ...
        contactStep: {
          name: 'contact',
          templateUrl:
            'app/telecom/telephony/account/line/assist/troubleshooting/contact/telecom-telephony-line-assist-troubleshooting-contact.html',
        },
        autoConfigStep: {
          name: 'autoConfig',
          isFinalized: false,
    ...
    =============================== */
      ...
      self.manageItWorks = function manageItWorks() {
        ...
        self.process.activeStep = self.addStep({
          ...
          display: true,
          templateUrl:
            'app/telecom/telephony/account/line/assist/troubleshooting/success/telecom-telephony-line-assist-troubleshooting-success.html',
        });
      };
