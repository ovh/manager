  ...
  class TelecomTelephonyAliasConfigurationLinesCtrl {
    ...
    deleteLineOpenModal(line) {
      this.$uibModal
        .open({
          templateUrl:
            'app/telecom/telephony/account/alias/configuration/feature/contactCenterSolution/lines/delete/telecom-telephony-alias-configuration-lines-delete.html',
    ...
    updateLine(lineToEdit) {
      const updateLineModel = this.$uibModal.open({
        templateUrl:
          'app/telecom/telephony/account/alias/configuration/feature/contactCenterSolution/lines/edit/telecom-telephony-alias-configuration-lines-edit.html',
