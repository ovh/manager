  ...
  $stateProvider.state('telecom.telephony.billingAccount.alias.configuration', {
    ...
    views: {
      'aliasInnerView@telecom.telephony.billingAccount.alias': {
        templateUrl:
          'app/telecom/telephony/account/alias/configuration/telecom-telephony-alias-configuration.html',
      ...
      'featureView@telecom.telephony.billingAccount.alias.configuration': {
        templateProvider: (alias) => {
          ...
          return `<div data-ng-include="::'app/telecom/telephony/account/alias/configuration/feature/${featureType}/telecom-telephony-alias-configuration-${featureType}.html'"></div>`;
        },
        controllerProvider: (alias) => {
          ...
          return isNotEmptyFeature
            ? `TelecomTelephonyAliasConfiguration${upperFirst(featureType)}Ctrl`
            : null;
        },
        controllerAs: '$ctrl',
      },
