...
angular
  .module('managerApp')
  .component('telecomTelephonyBillingAccountOrderAliasCoordinateAddress', {
    templateUrl:
      'app/telecom/telephony/billingAccount/orderAlias/coordinate/address/telecom-telephony-billing-account-orderAlias-coordinate-address.html',
    bindings: {
      ngModel: '=?',
      regionCode: '@',
      ngDisabled: '=?',
