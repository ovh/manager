...
angular.module('managerApp').controller('TelecomTelephonyLineConsumptionOutgoingFaxCtrl', function TelecomTelephonyLineConsumptionOutgoingFaxCtrl($stateParams, $q, $translate, $filter, $timeout, OvhApiTelephony, TucToastError) {
  const self = this;
