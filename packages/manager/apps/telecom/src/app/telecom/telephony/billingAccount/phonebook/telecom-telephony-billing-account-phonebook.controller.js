    ...
    =============================== */
      ...
      self.deletePhonebook = function deletePhonebook() {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/billingAccount/phonebook/remove/telecom-telephony-billing-account-phonebook-remove.html',
      ...
      self.addPhonebookContact = function addPhonebookContact() {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/billingAccount/phonebook/contact-add/telecom-telephony-billing-account-phonebook-contact-add.html',
      ...
      self.importPhonebookContact = function importPhonebookContact() {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/billingAccount/phonebook/contact-import/telecom-telephony-billing-account-phonebook-contact-import.html',
          controller:
      ...
      self.updatePhonebookContact = function updatePhonebookContact(contact) {
        ...
        const modal = $uibModal.open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/billingAccount/phonebook/contact-update/telecom-telephony-billing-account-phonebook-contact-update.html',
          controller:
