...
export default /* @ngInject */ function TelecomTelephonyAliasConfigurationTimeConditionOldPabxCtrl(
  $q,
  $stateParams,
  $translate,
  $uibModal,
  ...
  self.hasChange = function hasChange() {
    ...
    return (
      !isConditionsInEdition && self.number.feature.timeCondition.hasChange()
    );
  };
