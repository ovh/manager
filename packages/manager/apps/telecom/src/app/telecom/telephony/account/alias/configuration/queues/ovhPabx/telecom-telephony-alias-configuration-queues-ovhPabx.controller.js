...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyAliasConfigurationQueuesOvhPabxCtrl',
    function TelecomTelephonyAliasConfigurationQueuesOvhPabxCtrl(
      $stateParams,
      $q,
      $translate,
      $timeout,
      ...
      self.deleteAgentFromQueue = function deleteAgentFromQueue(
        queue,
        toDelete,
      ) {
        return OvhApiTelephony.OvhPabx()
          ...
          .change(
            ...
            },
            {
              ...
              actionOnOverflow: queue.inEdition.actionOnOverflowParam
                ...
                : null,
              actionOnOverflowParam:
                queue.inEdition.actionOnOverflowParam || null,
            },
          )
          .$promise.then(() => {
