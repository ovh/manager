...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyServiceFaxPasswordCtrl',
    function TelecomTelephonyServiceFaxPasswordCtrl(
      $stateParams,
      $translate,
      $timeout,
      TelephonyMediator,
      ...
      self.submitPasswordChange = function submitPasswordChange(form) {
        ...
        return OvhApiTelephony.Fax()
          ...
          .catch((err) => {
            TucToast.error(
              $translate.instant(
                'telephony_service_fax_password_change_error',
        ...
        tucTelephonyBulk
          .getTucToastInfos(bulkResult, {
            ...
            error: $translate.instant(
              'telephony_service_fax_password_bulk_error',
            ),
          })
          .forEach((toastInfo) => {
