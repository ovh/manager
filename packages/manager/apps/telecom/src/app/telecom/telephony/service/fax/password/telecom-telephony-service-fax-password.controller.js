...
angular.module('managerApp').controller('TelecomTelephonyServiceFaxPasswordCtrl', function TelecomTelephonyServiceFaxPasswordCtrl($stateParams, $translate, $timeout, TelephonyMediator, OvhApiTelephony, TucToast, TucToastError, tucTelephonyBulk) {
  const self = this;
