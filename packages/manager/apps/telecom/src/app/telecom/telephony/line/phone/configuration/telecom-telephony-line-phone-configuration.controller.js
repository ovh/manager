...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyLinePhoneConfigurationCtrl',
    function TelecomTelephonyLinePhoneConfigurationCtrl(
      $scope,
      $q,
      $timeout,
      $state,
      ...
      function groupConfigs() {
        ...
        self.allGroups.sort((groupA, groupB) => {
          ...
          const translatedA = $translate.instant(
            `telephony_line_phone_configuration_group_${snakeCase(
              groupA.name,
            )}`,
          );
    ...
    ============================== */
      ...
      self.defaultValues = function defaultValues() {
        ...
        if (!self.model.expertMode && self.hasExpertConfigs) {
          TucToast.info(
            $translate.instant(
              'telephony_line_phone_configuration_default_info',
            ),
          );
        }
      };
