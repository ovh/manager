...
angular.module('managerApp').controller(
  'TelecomTelephonyAliasConfigurationSoundsCtrl',
  class TelecomTelephonyAliasConfigurationSoundsCtrl {
    constructor(
      $q,
      $state,
      $stateParams,
    ...
    openManageSoundsHelper(modelToUpdate) {
      this.$uibModal
        .open({
          animation: true,
          templateUrl:
            'app/telecom/telephony/account/alias/configuration/feature/contactCenterSolution/sounds/add/telecom-telephony-alias-configuration-contactCenterSolution-sounds-add.html',
          controller:
