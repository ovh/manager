    ...
    'telecom.telephony.billingAccount.alias.configuration.timeCondition',
    {
      ...
      views: {
        'aliasInnerView@telecom.telephony.billingAccount.alias': {
          templateUrl:
            'app/telecom/telephony/account/alias/configuration/feature/contactCenterSolution/timeCondition/telecom-telephony-alias-configuration-time-condition.html',
