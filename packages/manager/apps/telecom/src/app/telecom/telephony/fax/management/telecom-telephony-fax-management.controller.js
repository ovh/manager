...
angular.module('managerApp').controller('TelecomTelephonyFaxManagementCtrl', function TelecomTelephonyFaxManagementCtrl($q, $stateParams, $translate, TelephonyMediator, TucToast) {
  const self = this;
