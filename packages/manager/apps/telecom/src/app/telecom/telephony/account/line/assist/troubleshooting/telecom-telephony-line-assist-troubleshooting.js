...
angular.module('managerApp').run(($templateCache) => {
  ...
  $templateCache.put(
    'app/telecom/telephony/account/line/assist/troubleshooting/procedure/cisco/telecom-telephony-line-assist-troubleshooting-procedure-cisco.html',
    telecomTelephonyLineAssistTroubleshootingProcedureCisco,
  );
  $templateCache.put(
    'app/telecom/telephony/account/line/assist/troubleshooting/procedure/gigaset/telecom-telephony-line-assist-troubleshooting-procedure-gigaset.html',
    telecomTelephonyLineAssistTroubleshootingProcedureGigaset,
  );
  $templateCache.put(
    'app/telecom/telephony/account/line/assist/troubleshooting/procedure/lg/telecom-telephony-line-assist-troubleshooting-procedure-lg.html',
    telecomTelephonyLineAssistTroubleshootingProcedureLg,
  );
  $templateCache.put(
    'app/telecom/telephony/account/line/assist/troubleshooting/procedure/linksys/telecom-telephony-line-assist-troubleshooting-procedure-linksys.html',
    telecomTelephonyLineAssistTroubleshootingProcedureLinksys,
  );
  $templateCache.put(
    'app/telecom/telephony/account/line/assist/troubleshooting/procedure/polycom/telecom-telephony-line-assist-troubleshooting-procedure-polycom.html',
    telecomTelephonyLineAssistTroubleshootingProcedurePolycom,
  );
  $templateCache.put(
    'app/telecom/telephony/account/line/assist/troubleshooting/procedure/siemens/telecom-telephony-line-assist-troubleshooting-procedure-siemens.html',
    telecomTelephonyLineAssistTroubleshootingProcedureSiemens,
  );
  $templateCache.put(
    'app/telecom/telephony/account/line/assist/troubleshooting/procedure/thomson/telecom-telephony-line-assist-troubleshooting-procedure-thomson.html',
    ...
    'telecom.telephony.billingAccount.line.assist.troubleshooting',
    {
      ...
      views: {
        'lineView@telecom.telephony.billingAccount.line': {
          templateUrl:
            'app/telecom/telephony/account/line/assist/troubleshooting/telecom-telephony-line-assist-troubleshooting.html',
        ...
        'procedureStepView@telecom.telephony.billingAccount.line.assist.troubleshooting': {
          templateUrl:
            'app/telecom/telephony/account/line/assist/troubleshooting/procedure/telecom-telephony-line-assist-troubleshooting-procedure.html',
        ...
        'autoConfigStepView@telecom.telephony.billingAccount.line.assist.troubleshooting': {
          templateUrl:
            'app/telecom/telephony/account/line/assist/troubleshooting/autoConfig/telecom-telephony-line-assist-troubleshooting-auto-config.html',
        ...
        'manualConfigStepView@telecom.telephony.billingAccount.line.assist.troubleshooting': {
          templateUrl:
            'app/telecom/telephony/account/line/assist/troubleshooting/manualConfig/telecom-telephony-line-assist-troubleshooting-manual-config.html',
          controller:
