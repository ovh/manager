...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyAliasAdministrationConvertToLineCtrl',
    function TelecomTelephonyAliasAdministrationConvertToLineCtrl(
      $stateParams,
      $q,
      $translate,
      OvhApiTelephony,
      ...
      self.convertToLine = function convertToLine() {
        ...
        return OvhApiTelephony.Number()
          ...
          .then(() => {
            TucToast.success(
              $translate.instant(
                'telephony_alias_administration_convert_success',
              ),
            );
          })
