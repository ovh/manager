...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyServiceConsumptionIncomingCallsCtrl',
    function TelecomTelephonyServiceConsumptionIncomingCallsCtrl(
      $stateParams,
      $q,
      $translate,
      $filter,
              ...
              .map((conso) => {
                ...
                if (/anonymous/.test(conso.calling)) {
                  set(
                    ...
                    'calling',
                    $translate.instant(
                      'telephony_service_consumption_anonymous',
                    ),
                  );
                }
                return conso;
