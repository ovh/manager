...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyLineRestrictionsCtrl',
    function TelecomTelephonyLineRestrictionsCtrl(
      $stateParams,
      $timeout,
      $q,
      $document,
      ...
      function init() {
        ...
        return $q
          ...
          .then((result) => {
            ...
            self.accountRestrictionsForm = angular.copy(
        ...
        tucTelephonyBulk
          .getTucToastInfos(bulkResult, {
            ...
            error: $translate.instant(
              'telephony_line_restrictions_ip_bulk_error',
            ),
          })
          .forEach((toastInfo) => {
