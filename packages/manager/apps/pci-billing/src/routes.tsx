...
export const ROUTE_PATHS = {
  ...
  BILLING: '',
  ACTIVATE_MONTHLY_BILLING: 'monthly',
  ESTIMATE: 'estimate',
...
const ActivateToMonthlyBillingPage = lazy(() =>
  import('@/pages/billing/consumption/ActivateMonthlyBilling.page'),
);
  ...
  <Routes>
    ...
    >
      <Route path={ROUTE_PATHS.BILLING} Component={BillingPage}>
        <Route path={ROUTE_PATHS.BILLING} Component={ConsumptionPage}>
          <Route
            path={ROUTE_PATHS.ACTIVATE_MONTHLY_BILLING}
            Component={ActivateToMonthlyBillingPage}
          />
        </Route>
