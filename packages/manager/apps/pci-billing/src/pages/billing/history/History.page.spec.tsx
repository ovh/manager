...
import * as _useHistoryHook from '@/api/hook/useHistory';
import { wrapper } from '@/wrapperRenders';
import * as _useComputeDateHook from '../../../components/history/useComputeDate.hook';
import History from './History.page';
import { TUsageHistoryPeriod } from '@/api/data/history';
...
describe('History', () => {
  ...
  it('matches snapshot when is Pending true', () => {
    vi.spyOn(_useHistoryHook, 'useGetUsageHistory').mockReturnValue({
      data: undefined,
      isPending: true,
    } as UseQueryResult<TConsumptionDetail, Error>);
  ...
  it('matches snapshot when data exist', async () => {
    ...
    vi.spyOn(_useHistoryHook, 'useUsageHistoryPeriod').mockReturnValue({
      data: undefined,
      isPending: false,
    } as UseQueryResult<TUsageHistoryPeriod, Error>);
