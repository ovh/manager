...
describe('isSnapshotConsumption', () => {
  it.each([
    ['should return true for snapshot consumption codes', 'snapshot.consumption.example', true],
    ['should return false for non-snapshot consumption codes', 'some.other.code', false],
