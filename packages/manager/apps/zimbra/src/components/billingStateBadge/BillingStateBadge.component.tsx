...
const BILLING_STATE_TOOLTIP: Record<string, string> = {
  [ServiceBillingState.AUTOMATIC_RENEWAL]:
    'service_billing_state_automatic_renewal_tooltip',
  [ServiceBillingState.CANCELATION_PLANNED]:
    'service_billing_state_cancelation_planned_tooltip',
};
