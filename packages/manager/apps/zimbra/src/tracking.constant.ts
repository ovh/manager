...
export const ONBOARDING_CONFIGURE_ORGANIZATION =
  'onboarding_welcome_configure_organization';
export const ONBOARDING_CONFIGURE_DOMAIN =
  'onboarding_welcome_configure_domain';
export const ONBOARDING_CONFIGURE_EMAIL_ACCOUNTS =
  'onboarding_welcome_configure_email_accounts';
