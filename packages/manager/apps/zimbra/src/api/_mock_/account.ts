...
export const accountMock: AccountType[] = [
  {
    ...
    targetSpec: {
      ...
      createdAt: '2024-07-09T13:27:12.776Z',
      description: 'string',
      detailedStatus: [
        {
          details: 'string',
      ...
      displayName: 'string',
      domainId: '19097ad4-2880-4000-8123-46e1342f8019',
      email: 'string',
      firstName: 'string',
      hideInGal: false,
      lastConnectionAt: '2024-07-09T13:27:12.776Z',
      lastName: 'string',
      offer: 'BUSINESS',
      organizationId: '19097ad4-2880-4000-8313-9841a7be8480',
      organizationLabel: 'string',
      quota: {
        available: 0,
        used: 0,
      },
      updatedAt: '2024-07-09T13:27:12.776Z',
    },
  },
];
