...
import { getDefaultProject, getProjects, removeProject, unFavProject } from '../projects';
...
describe('getDefaultProject', () => {
  ...
  it('should call v6.get with correct endpoint', async () => {
    ...
    expect(mockedV6Get).toHaveBeenCalledWith('me/preferences/manager/PUBLIC_CLOUD_DEFAULT_PROJECT');
  });
...
describe('removeProject', () => {
  ...
  it('should call v6.post with correct endpoint for non-US project', async () => {
    ...
    expect(mockedV6Post).toHaveBeenCalledWith('cloud/project/test-project-123/terminate');
  });
