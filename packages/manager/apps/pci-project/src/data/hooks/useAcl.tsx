...
export const useProjectAcl = (projectId?: string) => {
  return useQuery({
    queryKey: getProjectAclQueryKey(projectId as string),
    queryFn: () => getProjectAcl(projectId as string),
    enabled: !!projectId,
  });
};
...
export const useProjectAclAccountsInfo = (
  ...
  return useQueries({
    queries: (accountIds || []).map((accountId) => ({
      ...
      queryFn: () => getProjectAclAccountInfo(projectId as string, accountId),
      enabled: !!projectId,
    })),
