...
const mockGetProjectsWithServices = vi.mocked(projectsApi.getProjectsWithServices);
const mockProjectsWithServiceQueryKey = vi.mocked(projectsApi.projectsWithServiceQueryKey);
...
describe('useActiveProjects', () => {
  ...
  it('should return loading state initially', () => {
    mockGetProjectsWithServices.mockImplementation(() => Promise.resolve({ data: [] }));
    mockProjectsWithServiceQueryKey.mockReturnValue(['projects-with-services--active--loading']);
  ...
  it('should return not ready state when query fails', async () => {
    ...
    mockProjectsWithServiceQueryKey.mockReturnValue(['projects-with-services--active--error']);
