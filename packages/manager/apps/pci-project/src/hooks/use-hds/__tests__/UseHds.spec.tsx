...
import { useIsAValidHdsSupportLevel, useIsHdsFeatureAvailabilityEnabled } from '../useHds';
...
describe('useHds hooks', () => {
  ...
  it('useIsAValidHdsSupportLevel returns true for enterprise or business', () => {
    ...
    const { result: resultEnterprise } = renderHook(() => useIsAValidHdsSupportLevel(), {
    ...
    const { result: resultBusiness } = renderHook(() => useIsAValidHdsSupportLevel(), {
      wrapper: createWrapper(customContext2 as unknown as typeof shellContext),
    });
