...
describe('IncreaseQuota', () => {
  ...
  it('should display the correct Modal content message', () => {
    ...
    const contentMessage = screen.getByText('pci_project_new_error_ask_increase_projects_quota');
  ...
  it('should use correct subsidiary in support URL', () => {
    ...
    const CustomWrapper = createWrapper(customShellContext as unknown as ShellContextType);
