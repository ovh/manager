...
export default function ContactsPage() {
  ...
  const { data: serviceInfo } = useProjectService(project?.project_id);
  const { data: aclAccountIds } = useProjectAcl(project?.project_id);
  const userAcls = useProjectAclAccountsInfo(
    project?.project_id,
    aclAccountIds || [],
  );
