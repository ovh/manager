  ...
  describe('description column', () => {
    ...
    it('should render link with correct href', async () => {
      ...
      await waitFor(() => {
        ...
        expect(link).toHaveAttribute('href', 'https://example.com/project/test-id');
    ...
    it('should render default project badge when isDefault is true', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('pci_projects_project_default_project')).toBeInTheDocument();
        expect(mockTranslate).toHaveBeenCalledWith('pci_projects_project_default_project');
      });
    });
    ...
    it('should not render default project badge when isDefault is false', async () => {
      ...
      await waitFor(() => {
        expect(screen.queryByText('pci_projects_project_default_project')).not.toBeInTheDocument();
      });
    });
  });
