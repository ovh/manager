 ...
 * @param {() => void} onSuccess - Callback called when the mutation succeeds.
 * @param {(error: ApiError) => void} onError - Callback called when the mutation fails.
 *
 * @returns {UseMutationResult<void, ApiError, EditProjectParams>} The mutation object from useMutation.
 *
 */
