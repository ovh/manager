...
import { OrderedProduct } from '@/data/models/Cart.type';
import {
...
export const useHdsManagement = ({ cartId, projectItemId, setForm }: UseHdsManagementProps) => {
  ...
  const shouldDisplayHdsSection = isHdsFeatureAvailabilityEnabled && isAValidHdsSupportLevel;
  ...
  const { mutate: removeHdsFromCart, isPending: isRemovingHds } = useRemoveItemFromCart({
