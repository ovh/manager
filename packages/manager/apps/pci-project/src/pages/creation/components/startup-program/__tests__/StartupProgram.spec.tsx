...
describe('StartupProgram', () => {
  ...
  it('should render the startup program title', () => {
    ...
    expect(screen.getByText('pci_project_new_payment_startup_program_title')).toBeVisible();
  });

  it('should render the startup program info text', () => {
    renderComponent();

    expect(screen.getByText('pci_project_new_payment_startup_program_info')).toBeVisible();
  });
  ...
  it('should display the amount available text', () => {
    ...
    expect(
      screen.getByText('pci_project_new_payment_startup_program_amount_available'),
    ).toBeVisible();
  });
});
