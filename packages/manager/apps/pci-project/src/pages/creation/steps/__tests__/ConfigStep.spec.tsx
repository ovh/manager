...
describe('ConfigStep', () => {
  ...
  function mockQueryResult<T>(data: T, isFetching = false): UseQueryResult<T, Error> {
    return {
      data,
      isError: false,
  ...
  beforeEach(() => {
    ...
    vi.mocked(useGetCartSummary).mockReturnValue(mockQueryResult(mockCartSummary));
  ...
  describe('rendering', () => {
    it('should render the basic form structure', () => {
      ...
      expect(screen.getByText('pci_project_new_config_description_label')).toBeInTheDocument();

      // Check ODS input by querying the ods-input element directly
      const odsInput = document.querySelector('ods-input[name="project-description"]');
    ...
    it('should render HDS section when shouldDisplayHdsSection is true', () => {
      ...
      expect(screen.getByText('pci_projects_hds_description')).toBeInTheDocument();
    });
    ...
    it('should not render HDS section when shouldDisplayHdsSection is false', () => {
      ...
      expect(screen.queryByText('pci_projects_hds_description')).not.toBeInTheDocument();
    });
  ...
  describe('user interactions', () => {
    it('should update description when input changes', async () => {
      ...
      const input = document.querySelector('ods-input[name="project-description"]') as Element;
      ...
      const formUpdater = mockSetForm.mock.calls[0]?.[0] as
        | ((prev: typeof defaultProps.form) => typeof defaultProps.form)
        | undefined;
    ...
    it('should handle contracts checkbox change', async () => {
      ...
      const contractsCheckbox = document.querySelector('ods-checkbox[name="contracts"]') as Element;
    ...
    it('should handle HDS checkbox change', () => {
      ...
      const hdsCheckbox = document.querySelector('ods-checkbox[name="isHds"]') as Element;
    ...
    it('should handle Italy agreements checkbox change', async () => {
      ...
      const italyCheckbox = document.querySelector('ods-checkbox[name="project-italy-agreements"]');
  ...
  describe('loading states', () => {
    it('should pass loading state to contracts when cart summary is fetching', () => {
      vi.mocked(useGetCartSummary).mockReturnValue(mockQueryResult(mockCartSummary, true));
  ...
  describe('input constraints', () => {
    it('should enforce maxlength on description input', () => {
      ...
      const input = document.querySelector('ods-input[name="project-description"]');
