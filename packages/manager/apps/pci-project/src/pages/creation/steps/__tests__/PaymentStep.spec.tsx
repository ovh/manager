...
vi.mock('@/pages/creation/components/payment/WillPayment.component', () => ({
  default: vi.fn(() => <div data-testid="will-payment">Will Payment Component</div>),
}));

vi.mock('@/pages/creation/components/voucher/Voucher', () => ({
  default: vi.fn(() => <div data-testid="voucher">Voucher Component</div>),
}));

vi.mock('@/pages/creation/components/startup-program/StartupProgram', () => ({
  default: vi.fn(() => <div data-testid="startup-program">Startup Program Component</div>),
}));

describe('PaymentStep', () => {
  const mockUseIsStartupProgramAvailable = vi.mocked(useIsStartupProgramAvailable);
  const mockUseStartupProgramAmountText = vi.mocked(useStartupProgramAmountText);
  ...
  beforeEach(() => {
    ...
    mockUseStartupProgramAmountText.mockReturnValue(mockQueryResult(mockStartupProgramAmountText));
  });
  ...
  describe('PaymentStep tests', () => {
    ...
    it('should handle loading state for startup program availability', () => {
      mockUseIsStartupProgramAvailable.mockReturnValue(mockQueryResult(false, true));
