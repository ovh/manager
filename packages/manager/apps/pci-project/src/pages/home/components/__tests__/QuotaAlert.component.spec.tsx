...
describe('QuotaAlert.component', () => {
  ...
  it('renders warning message with the guide link and the project quota link', () => {
    ...
    const odsMessage = container.querySelector('[data-testid="quota-alert_message"]');
    expect(odsMessage).toBeVisible();

    const guidesLink = container.querySelector('[data-testid="quota-alert_guides-link"]');
    const quotaUrl = container.querySelector('[data-testid="quota-alert_quota-url"]');
