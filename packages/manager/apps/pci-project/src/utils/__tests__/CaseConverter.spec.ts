...
describe('camelToSnakeCase', () => {
  ...
  it('should convert complex camelCase to snake_case', () => {
    ...
    expect(camelToSnakeCase('someMethodWithManyWords')).toBe('some_method_with_many_words');
  });
  ...
  it('should handle mixed case scenarios', () => {
    expect(camelToSnakeCase('parseHTMLDocument')).toBe('parse_h_t_m_l_document');
  ...
  it('should handle strings with underscores already present', () => {
    ...
    expect(camelToSnakeCase('test_valueWithCamel')).toBe('test_value_with_camel');
  });
