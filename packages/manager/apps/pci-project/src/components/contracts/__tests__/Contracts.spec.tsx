...
describe('Contracts', () => {
  ...
  it('renders checkbox and label', () => {
    const { getByTestId } = render(
      <Contracts contracts={contracts} isChecked={false} onCheckChanged={vi.fn()} />,
    );
  ...
  it('renders contracts list when contracts are provided', () => {
    render(<Contracts contracts={contracts} isChecked={false} onCheckChanged={vi.fn()} />);
  ...
  it('disables checkbox if contracts are missing or empty', () => {
    const { getByTestId } = render(<Contracts isChecked={false} onCheckChanged={vi.fn()} />);
  ...
  it('calls onCheckChanged when checkbox is toggled', () => {
    ...
    const { getByTestId } = render(
      <Contracts contracts={contracts} isChecked={false} onCheckChanged={onCheckChanged} />,
    );
