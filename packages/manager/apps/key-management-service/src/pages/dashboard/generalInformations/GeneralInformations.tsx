...
import ServiceStatusTile from '@/components/layout-helpers/Dashboard/GeneralInformationsTiles/ServiceStatusTile';
...
function GeneralInformationsTab() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
      ...
      />
      <ServiceStatusTile okmsService={okmsService.data} />
    </div>
  );
}
