    ...
    it.each([
      {
        ...
        buttons: [
          ...
          {
            label: labels.secretManager.common.version_state_deactivate,
            shouldBeDisabled: false,
          },
          {
            label: labels.secretManager.common.version_state_delete,
      ...
      },
      {
        ...
        buttons: [
          ...
          {
            label: labels.secretManager.common.version_state_reactivate,
            shouldBeDisabled: false,
          },
          {
            label: labels.secretManager.common.version_state_delete,
