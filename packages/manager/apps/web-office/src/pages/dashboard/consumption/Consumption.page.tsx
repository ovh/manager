...
export default function Consumption() {
  ...
  const handleCheckboxChange = (
    entry: { color: string; dataKey: string; inactive: string; type: string; value: string },
  ...
  const renderLegend = ({
    ...
    payload: { color: string; dataKey: string; inactive: string; type: string; value: string }[];
  }) => {
    return (
