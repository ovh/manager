      ...
      <form onSubmit={(e) => void handleSubmit(onSubmit)(e)}>
        <div className="flex flex-wrap justify-between mb-4">
          <FormField className="w-full md:w-3/5">
            <FormFieldLabel>{t('dashboard_users_order_licences_type')}</FormFieldLabel>
            <Controller
              name="productType"
              control={control}
              rules={{ required: true }}
          ...
          <FormField>
            <FormFieldLabel>{t('dashboard_users_order_licences_quantity')}</FormFieldLabel>
            <Controller
              name="quantity"
              control={control}
        ...
        <Message className="mt-4 mb-6" dismissible={false}>
