...
describe('modal order license', () => {
  it('should render the submit button', () => {
    ...
    expect(getByTestId('primary-button')).toHaveAttribute('label', commonTranslation.cta_confirm);
  });
  ...
  it('should render the cancel button', () => {
    ...
    expect(getByTestId('secondary-button')).toHaveAttribute('label', commonTranslation.cta_cancel);
  });
