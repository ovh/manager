...
export const GeneratePasswordButton = ({
  ...
  return (
    ...
    >
      ...
      />
      <OdsTooltip strategy="fixed" role="tooltip" withArrow triggerId={id}>
        <OdsText preset={ODS_TEXT_PRESET.paragraph}>
          {t(
            generated
              ? 'dashboard_users_change_password_generated_password_tooltip'
              : 'dashboard_users_change_password_generate_password_tooltip',
          )}
        </OdsText>
      </OdsTooltip>
    </div>
