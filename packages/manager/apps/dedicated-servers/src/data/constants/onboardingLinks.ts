export const onboardingLinks = {
  FR: {
    startedDedicatedServer:
      'https://docs.ovh.com/fr/dedicated/premiers-pas-serveur-dedie/',
    backupStorage: 'https://docs.ovh.com/fr/dedicated/services-backup-storage/',
    firewallNetwork: 'https://docs.ovh.com/fr/dedicated/firewall-network/',
  },
  EN: {
    startedDedicatedServer:
      'https://docs.ovh.com/ie/en/dedicated/getting-started-dedicated-server/',
    backupStorage:
      'https://docs.ovh.com/ie/en/dedicated/services-backup-storage/',
    firewallNetwork: 'https://docs.ovh.com/ie/en/dedicated/firewall-network/',
  },
  DE: {
    startedDedicatedServer:
      'https://docs.ovh.com/de/dedicated/erste-schritte-dedicated-server/',
    backupStorage: 'https://docs.ovh.com/de/dedicated/dienste-storage-backup/',
    firewallNetwork: 'https://docs.ovh.com/de/dedicated/firewall-network/',
  },
  ES: {
    startedDedicatedServer:
      'https://docs.ovh.com/es/dedicated/primeros-pasos-servidor-dedicado/',
    backupStorage:
      'https://docs.ovh.com/es/dedicated/primeros-pasos-servidor-dedicado/',
    firewallNetwork: 'https://docs.ovh.com/es/dedicated/firewall-de-red/',
  },
  IT: {
    startedDedicatedServer:
      'https://docs.ovh.com/it/dedicated/iniziare-a-utilizzare-server-dedicato/',
    backupStorage: 'https://docs.ovh.com/it/dedicated/servizio-backup-storage/',
    firewallNetwork: 'https://docs.ovh.com/it/dedicated/firewall-network/',
  },
  PT: {
    startedDedicatedServer:
      'https://docs.ovh.com/pt/dedicated/primeiros-passos-servidor-dedicado/',
    backupStorage: 'https://docs.ovh.com/pt/dedicated/servicos-backup-storage/',
    firewallNetwork: 'https://docs.ovh.com/pt/dedicated/firewall-network/',
  },
  PL: {
    startedDedicatedServer:
      'https://docs.ovh.com/pl/dedicated/pierwsze-kroki-z-serwerem-dedykowanym/',
    backupStorage: 'https://docs.ovh.com/pl/dedicated/usluga-backup-storage/',
    firewallNetwork: 'https://docs.ovh.com/pl/dedicated/network-firewall/',
  },
  US: {
    startedDedicatedServer:
      'https://docs.ovh.com/us/en/dedicated/getting-started-dedicated-server/',
    backupStorage: 'https://docs.ovh.com/us/en/dedicated/using-backup-storage/',
    firewallNetwork: 'https://docs.ovh.com/us/en/dedicated/firewall-network/',
  },
  AU: {
    startedDedicatedServer:
      'https://docs.ovh.com/au/en/dedicated/getting-started-dedicated-server/',
    backupStorage: 'https://docs.ovh.com/au/en/dedicated/using-backup-storage/',
    firewallNetwork: 'https://docs.ovh.com/au/en/dedicated/firewall-network/',
  },
  ASIA: {
    startedDedicatedServer:
