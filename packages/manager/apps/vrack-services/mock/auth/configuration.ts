...
export const getConfigurationResponse = ({ region = defaultRegion }): any => ({
  ...
  user: {
    ...
    companyNationalIdentificationNumber: '53740792600014',
    zip: '75000',
    phoneCountry: 'FR',
    nationalIdentificationNumber: null,
    organisation: 'sdfqgf',
    spareEmail: 'tech.ux.tests@interne.ovh.net',
    name: 'CIO Digital Product QA DEV TEST Delivery',
    vat: null,
    phone: '+33.972101007',
    phoneType: 'mobile',
    email: 'squad.qa+ls@interne.ovh.net',
    area: 'IN-WB',
    corporationType: 'Société anonyme (SA)',
    firstname: 'CIO Digital Product QA DEV TEST Delivery',
    fax: null,
    ...
    auth: {
      method: 'provider',
      user: 'nicolas.pierre-charles.ext@corp.ovh.com',
      description: 'Nicolas Pierre-Charles',
      roles: ['REGULAR', 'UNPRIVILEGED'],
      allowedRoutes: null,
      account: 'ls148374-ovh',
      identities: [
        'urn:v1:eu:identity:user:ls148374-ovh/provider/nicolas.pierre-charles.ext@corp.ovh.com',
        'urn:v1:eu:identity:group:ls148374-ovh/Domain Users',
        'urn:v1:eu:identity:group:ls148374-ovh/login-manager-test-ux-fr',
      ],
    },
    enterprise: false,
  },
