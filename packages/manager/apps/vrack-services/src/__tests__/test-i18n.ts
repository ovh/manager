...
import order from '@ovh-ux/manager-common-translations/public/translations/order/Messages_fr_FR.json';
import service from '@ovh-ux/manager-common-translations/public/translations/service/Messages_fr_FR.json';
...
export const initTestI18n = (appName: string, translationEntries: TranslationObject) =>
