    ...
    >
      <OdsFormField className="block mb-4 max-w-md">
        ...
        <OdsInput
          ...
          onOdsChange={(e) => setDisplayName(e?.target.value as string)}
        />
      </OdsFormField>
      ...
      <OdsFormField className="block mb-4 max-w-md">
        ...
        <OdsInput
          ...
          onOdsChange={(e) => setCidr(e?.target.value as string)}
      ...
      <OdsFormField className="block mb-4 max-w-md">
        ...
        <OdsInput
          ...
          type={ODS_INPUT_TYPE.text}
          onOdsChange={(e) => setServiceRange(e?.target.value as string)}
        />
      </OdsFormField>
      ...
      <OdsFormField className="grid mb-4 gap-2">
        ...
        <div className="flex align-center gap-3">
          <OdsRadio
            ...
            isChecked={!hasVlan}
            onOdsChange={(event) =>
              setHasVlan(event?.target.value === vlanNumberOptionValue)
            }
          />
          <label
      ...
      {hasVlan && (
        <OdsFormField className="block ml-8 mb-4 max-w-md">
          ...
          <OdsInput
            ...
            onOdsChange={(e) => setVlan(Number(e?.target.value))}
          />
        </OdsFormField>
      )}
    </CreatePageLayout>
