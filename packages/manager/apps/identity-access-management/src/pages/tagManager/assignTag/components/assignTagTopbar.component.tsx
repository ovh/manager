...
import { ResourcesDatagridContext } from '@/components/resourcesDatagrid/resourcesDatagridContext';
...
export default function AssignTagTopbar({ tags }: AssignTagTopbarProps) {
  ...
  const { selectedResourcesList } = useContext(ResourcesDatagridContext);
