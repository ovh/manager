...
describe('ExpirationStatus', () => {
  it('should display an \'expired\' badge when token is expired', () => {
    ...
    expect(badgeElement).toHaveAttribute('label', 'iam_user_token_expiration_badge_expired');
  });
  ...
  it('should display an \'invalid\' badge when expiresAt is invalid', () => {
    ...
    expect(badgeElement).toHaveAttribute('label', 'iam_user_token_expiration_badge_invalid');
  });
});
