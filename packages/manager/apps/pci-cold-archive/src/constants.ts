...
export const STORAGE_BACKUP_LINKS = {
...
export const COLD_ARCHIVE_OVERVIEW_LINKS = {
  DEFAULT:
    'https://docs.ovh.com/us/en/storage/object-storage/cold-archive/overview/',
  FR: 'https://docs.ovh.com/fr/storage/object-storage/cold-archive/overview/',
  MA: 'https://docs.ovh.com/fr/storage/object-storage/cold-archive/overview/',
  TN: 'https://docs.ovh.com/fr/storage/object-storage/cold-archive/overview/',
  SN: 'https://docs.ovh.com/fr/storage/object-storage/cold-archive/overview/',
  QC:
  ...
  ES: 'https://docs.ovh.com/es/storage/object-storage/cold-archive/overview/',
  WS:
    'https://docs.ovh.com/us/es/storage/object-storage/cold-archive/overview/',
  PT: 'https://docs.ovh.com/pt/storage/object-storage/cold-archive/overview/',
  IT: 'https://docs.ovh.com/it/storage/object-storage/cold-archive/overview/',
  PL: 'https://docs.ovh.com/pl/storage/object-storage/cold-archive/overview/',
  DE: 'https://docs.ovh.com/de/storage/object-storage/cold-archive/overview/',
  NL:
    'https://docs.ovh.com/gb/en/storage/object-storage/cold-archive/overview/',
};

export const GETTING_STARTED_WITH_COLD_ARCHIVE_LINKS = {
  DEFAULT:
...
export const MANAGE_YOUR_DATA_LINKS = {
  DEFAULT:
    'https://docs.ovh.com/us/en/storage/object-storage/s3/getting-started-with-object-storage/',
  FR:
    'https://docs.ovh.com/fr/storage/object-storage/s3/getting-started-with-object-storage/',
