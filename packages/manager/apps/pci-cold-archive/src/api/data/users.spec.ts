...
describe('Users API', () => {
  ...
  it('should get S3 credentials', async () => {
    ...
    const result = await getS3Credentials(projectId, userId);
  ...
  it('should delete a user', async () => {
    await deleteUser(projectId, userId, accessKey);
  ...
  it('should import user policy', async () => {
    ...
    const result = await importUserPolicy(projectId, userId, policy);
