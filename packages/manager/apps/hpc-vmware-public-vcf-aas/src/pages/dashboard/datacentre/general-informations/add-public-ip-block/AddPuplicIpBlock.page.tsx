...
function AddPuplicIpBlockLoaded() {
  ...
  const [
    isBlockIpExistInVrackSegement,
    setIsBlockIpExistInVrackSegment,
  ] = useState(null);
  ...
  useEffect(() => {
    if (
      ...
      setIsBlockIpExistInVrackSegment(true);
    } else {
      setIsBlockIpExistInVrackSegment(false);
    }
  }, [selectedBlockIp]);
    ...
    <form onSubmit={onSubmit}>
      <Modal
        ...
        isPrimaryButtonDisabled={
          isUpdatePending || !selectedBlockIp || isBlockIpExistInVrackSegement
        }
