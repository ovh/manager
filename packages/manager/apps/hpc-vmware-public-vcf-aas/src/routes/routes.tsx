...
const AddPuplicIpBlockPage = React.lazy(() =>
  import(
    '@/pages/dashboard/datacentre/general-informations/add-public-ip-block/AddPuplicIpBlock.page'
  ),
);
      ...
      >
        ...
        >
          ...
          <Route
            ...
            Component={AddPuplicIpBlockPage} // here
          />
        </Route>
        <Route
          id={'vDcStorage'}
