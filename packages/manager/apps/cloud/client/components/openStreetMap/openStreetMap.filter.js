angular.module('managerApp').filter('openStreetMap', /* @ngInject */ (CucRegionService) => {
  const regionMap = {
    ...
    DE: 'https://www.openstreetmap.org/?mlat=50.11365&mlon=8.67870#map=5/50.00/8.00',
    UK: 'https://www.openstreetmap.org/?mlat=51.50073&mlon=-0.12611#map=5/50.00/0',
    SYD: 'https://www.openstreetmap.org/?mlat=-33.865143&mlon=151.209900#map=5/-33.847/151.239',
