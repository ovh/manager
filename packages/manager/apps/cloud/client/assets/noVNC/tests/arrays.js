...
let ctx; let i; let j; let randlist;


let new_normal; let new_imageData; let new_arrayBuffer;
...
let do_imageData = false;


let do_arrayBuffer = false;
...
new_imageData_createImageData = function () {
  const imageData = ctx.createImageData(1024 / 4, arraySize / 1024);
  return imageData.data;
};

new_imageData_getImageData = function () {
  const imageData = ctx.getImageData(0, 0, 1024 / 4, arraySize / 1024);
...
new_arrayBuffer = function () {
  const arr = new ArrayBuffer(arraySize);
...
function finish() {
  let totalTime; let arrayType; let testType; let
    times;
...
function run_next_iteration() {
  let arrayType; let testType; let
    deltaTime;
...
testFunc.normal_create = function () {
  let cnt; let arrNormal; let startTime; let
    endTime;
...
testFunc.imageData_create = function () {
  let cnt; let arrImage; let startTime; let
    endTime;
...
testFunc.arrayBuffer_create = function () {
  let cnt; let arrBuffer; let startTime; let
    endTime;
...
function test_sequentialRead(arr) {
  let i; let j; let cnt; let startTime; let
    endTime;
...
function test_randomRead(arr) {
  let i; let cnt; let startTime; let
    endTime;
  /* Initialize the array */
