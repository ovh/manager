angular.module('managerApp').controller('NashaPartitionDeleteCtrl', function NashaPartitionDeleteCtrl(OvhApiDedicatedNasha, $stateParams, $scope, $uibModalInstance, $translate, CucCloudMessage) {
  const self = this;
  self.loading = false;
  self.data = {
