angular.module('managerApp').factory('CloudProjectComputeFactory',
  (CloudProjectComputeInfrastructureFactory, CloudProjectComputeVolumesFactory) => {
    /**
    ...
    const ComputeFactory = (function () {
      return function CloudProjectComputeFactory(optionsParam) {
        ...
        this.infrastructure = new CloudProjectComputeInfrastructureFactory(angular.extend(
          (options.infrastructure || {}),
          { serviceName: this.serviceName },
        ));
        this.volumes = new CloudProjectComputeVolumesFactory(angular.extend(
          (options.volumes || {}),
          { serviceName: this.serviceName },
        ));
      };
