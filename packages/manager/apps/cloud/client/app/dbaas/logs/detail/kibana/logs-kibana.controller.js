class LogsKibanaCtrl {
  ...
  add(info) {
    ...
    this.CucControllerHelper.modal
      .showModal({
        modalConfig: {
          templateUrl: 'app/dbaas/logs/detail/kibana/add/logs-kibana-add.html',
...
angular.module('managerApp').controller('LogsKibanaCtrl', LogsKibanaCtrl);
