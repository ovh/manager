...
const validIdRegex = /^[a-zA-Z0-9][a-zA-Z0-9_-]{1,253}[a-zA-Z0-9]$/;

type ReplicationStatus = 'enabled' | 'disabled';

type ReplicationStorageClass = 'STANDARD' | 'STANDARD_IA' | 'HIGH_PERF';
...
export default function AddReplicationPage() {
  ...
  const isValidReplicationRulePrefix = useMemo(() => {
    return validIdRegex.test(replicationRulePrefix);
  }, [replicationRulePrefix]);

  const [destination, setDestination] = useState<
    ReplicationDestination | undefined
  >(undefined);
