...
describe('useUpdateS3', () => {
  it('should call useUpdateS3 on mutation with data', async () => {
    ...
    vi.mocked(s3StorageApi.udpateS3Storage).mockResolvedValue(
    ...
    result.current.udpateS3Storage({
      projectId: 'projectId',
      region: 'BHS',
      name: 's3Name',
    ...
    await waitFor(() => {
      expect(s3StorageApi.udpateS3Storage).toHaveBeenCalledWith({
        projectId: 'projectId',
        region: 'BHS',
        name: 's3Name',
        data: mockedUpdateS3Data,
