...
import { mockedS3CredentialsWihoutPwd } from '@/__tests__/helpers/mocks/cloudUser/user';
...
describe('useGetUserS3Credentials', () => {
  it('should fetch user S3 credentials and return data', async () => {
    ...
    await waitFor(() => {
      ...
      expect(result.current.data).toEqual([mockedS3CredentialsWihoutPwd]);
