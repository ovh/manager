...
import { IdentitiesRootAccountToggle } from './IdentitiesRootAccountToggle.component';
import { IdentitySelectionGroups } from './selection/groups/IdentitySelectionGroups.component';
import { IdentitySelectionServiceAccounts } from './selection/service-accounts/IdentitiesSelectedListServiceAccounts.component';
import { IdentitySelectionUsers } from './selection/users/IdentitySelectionUsers.component';
...
export const CreateAddIdentities = ({
  identityURNs,
  setIdentityURNs,
  prevStep,
  nextStep,
