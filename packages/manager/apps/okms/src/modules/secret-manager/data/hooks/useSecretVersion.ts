...
export const useSecretVersionWithData = (okmsId: string, secretPath: string, version: number) => {
  return useQuery<SecretVersionWithData, ApiError>({
    queryKey: secretVersionsQueryKeys.detailWithData(okmsId, secretPath, version),
