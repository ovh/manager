...
export const MOCK_PATH_INVALID_CONTAINS_TWO_CONSECUTIVE_SLASHES = 'invalid//path';
export const MOCK_PATH_INVALID_CHARACTERS_NOT_ALLOWED = 'character not allowed: !';
