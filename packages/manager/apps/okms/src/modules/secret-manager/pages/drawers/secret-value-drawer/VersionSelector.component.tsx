...
const VersionSelectorSelect = ({
  ...
  // Default value is the id of the default version
  const defaultValue: number = defaultVersion ? defaultVersion.id : 0;
  ...
  return (
    <OdsSelect
      ...
      defaultValue={valueToOdsSelectValue(defaultValue)}
