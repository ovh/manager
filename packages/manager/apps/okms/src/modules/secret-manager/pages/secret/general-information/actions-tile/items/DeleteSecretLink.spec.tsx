...
import { DELETE_SECRET_TEST_IDS, DeleteSecretLink } from './DeleteSecretLink.component';
...
const renderComponent = async () => {
  ...
  return render(<DeleteSecretLink secret={SECRET_MOCK} />, { wrapper });
};

describe('DeleteSecretLink test suite', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  describe('when data is loading', () => {
    it('should display a skeleton', async () => {
      ...
      // THEN
      expect(screen.getByTestId(DELETE_SECRET_TEST_IDS.skeleton)).toBeVisible();
    });
  });
