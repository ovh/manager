...
describe('CreateSecretBreadcrumbItem test suite', () => {
  it('should have the correct label and href link', async () => {
    ...
    // THEN
    expect(breadcrumbItem).toHaveAttribute('label', labels.secretManager.create_a_secret);
    expect(breadcrumbItem).toHaveAttribute('href', SECRET_MANAGER_ROUTES_URLS.createSecret);
  });
});
