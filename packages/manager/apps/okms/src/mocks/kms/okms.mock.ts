...
export const okmsMock: OKMS[] = [
  ...
  {
    iam: {
      displayName: 'test-kms-2',
      id: '22222222-d1b8-4b46-a584-52c8b4b0225c',
      urn: `urn:v1:eu:resource:okms:22222222-d1b8-4b46-a584-52c8b4b0225c`,
    },
    id: '22222222-a8d8-4c2a-ab0c-f6e86ddf6a7c',
    kmipEndpoint: 'eu-west-rbx.okms.ovh.net:1234',
    region: 'eu-west-rbx',
    restEndpoint: 'https://eu-west-rbx.okms.ovh.net',
    swaggerEndpoint: '"https://swagger-eu-west-rbx.okms.ovh.net',
  ...
  {
    iam: {
      displayName: 'test-kms-3',
      id: '33333333-d1b8-4b46-a584-52c8b4b0225c',
      urn: `urn:v1:eu:resource:okms:33333333-d1b8-4b46-a584-52c8b4b0225c`,
    },
    id: '33333333-a8d8-4c2a-ab0c-f6e86ddf6a7c',
    kmipEndpoint: 'eu-west-rbx.okms.ovh.net:1234',
    region: 'eu-west-rbx',
    restEndpoint: 'https://eu-west-rbx.okms.ovh.net',
    swaggerEndpoint: '"https://swagger-eu-west-rbx.okms.ovh.net',
