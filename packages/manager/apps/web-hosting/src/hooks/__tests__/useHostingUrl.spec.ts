...
describe('useHostingUrl', () => {
  ...
  it('should return the correct hosting URL without path', async () => {
    const { result } = renderHook(() => useHostingUrl('test-service'), { wrapper });
  ...
  it('should return the correct hosting URL with path', async () => {
    const { result } = renderHook(() => useHostingUrl('test-service', 'test-path'), { wrapper });
  ...
  it('should handle errors gracefully and set url to null', async () => {
    const { result } = renderHook(() => useHostingUrl('test-service'), { wrapper });
