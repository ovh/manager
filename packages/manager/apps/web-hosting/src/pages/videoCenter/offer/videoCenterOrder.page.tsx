        ...
        <div className="w-2/3 space-y-4">
          ...
          <RadioGroup>
            <div className="flex flex-row space-x-4">
              <Card onClick={() => {}} className="w-1/2 p-4">
                <div className="flex items-center gap-4">
                  <Radio value="plus">
                    <RadioControl />
                    <RadioLabel>
                      <Text preset={TEXT_PRESET.heading6}>Video Center Plus</Text>
                    </RadioLabel>
                  </Radio>
                </div>
              ...
              <Card className="w-1/2 p-4" onClick={() => {}}>
                <div className="flex items-center gap-4">
                  <Radio value="pro">
                    <RadioControl />
                    <RadioLabel>
                      <Text preset={TEXT_PRESET.heading6}>Video center Pro</Text>
                    </RadioLabel>
                  </Radio>
                </div>
                <div className="ml-8 mt-4">
