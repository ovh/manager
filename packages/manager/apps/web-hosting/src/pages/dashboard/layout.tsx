...
export default function Layout() {
  ...
  const tabs: DashboardTab[] = [
    ...
    },
    {
      ...
      to: useResolvedPath('multisite').pathname,
    },
    {
      name: 'ssl',
    ...
    },
    {
      ...
      to: useResolvedPath('module').pathname,
    },
    {
      name: 'logs',
      title: t('hosting_tab_USER_LOGS'),
      to: useResolvedPath('user-logs').pathname,
    },
    {
      name: 'ftp',
      title: t('hosting_tab_FTP'),
      to: useResolvedPath('ftp').pathname,
    },
    {
      name: 'database',
      title: t('hosting_tab_DATABASE'),
      to: useResolvedPath('database').pathname,
    },
    {
      name: 'task',
      title: t('hosting_tab_TASK'),
      to: useResolvedPath('task').pathname,
    },
    {
      name: 'automated_email',
      title: t('hosting_tab_AUTOMATED_EMAILS'),
      to: useResolvedPath('automated-emails').pathname,
    },
    {
      name: 'cron',
      title: t('hosting_tab_CRON'),
      to: useResolvedPath('cron').pathname,
    },
    {
      name: 'seo',
      title: t('hosting_tab_LOCAL_SEO'),
      to: useResolvedPath('localSeo').pathname,
    },
    {
      name: 'boost',
      title: t('hosting_tab_BOOST'),
      to: useResolvedPath('boost').pathname,
    },
  ];
  ...
  return (
    <PageLayout>
      ...
      <div className="flex items-center justify-between mt-10">
        ...
        <div className="flex flex-wrap justify-between gap-5 justify-end">
