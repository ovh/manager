...
export const CHANGELOG_LINKS: ChangelogMenuLinks = {
  changelog: 'https://github.com/orgs/ovh/projects/16/views/6?sliceBy[value]=Observability',
  roadmap: 'https://github.com/orgs/ovh/projects/16/views/1?sliceBy%5Bvalue%5D=Observability',
  'feature-request':
