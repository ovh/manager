...
const MetricPage = React.lazy(() => import('@/pages/metrics/Metrics.page'));
const TenantPage = React.lazy(() => import('@/pages/metrics/tenants/Tenants.page'));
