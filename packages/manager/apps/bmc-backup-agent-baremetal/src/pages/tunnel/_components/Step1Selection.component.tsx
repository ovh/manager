...
export const Step1Selection = ({ onCheckoutPendingChange, onComplete }: Step1SelectionProps) => {
  ...
  const isButtonDisabled =
    !watchedServerName || !watchedTermsAccepted || !cartId || cartPending || checkoutPending || isCompleted;
        ...
        render={({ field }) => (
          <OdsFormField className="w-full">
            ...
            <OdsCombobox
              ...
              name={field.name}
              value={field.value}
              isDisabled={isEmptyBaremetals || checkoutPending || isCompleted}
            ...
            {isEmptyBaremetals && (
              <div className="mt-2 flex flex-col gap-1">
                ...
                <Links
                  href={tunnelLinks.orderBaremetal}
                  target="_blank"
          ...
          render={({ field }) => (
            <div className="flex items-center gap-3">
              <OdsCheckbox
                ...
                isDisabled={checkoutPending || isCompleted}
          ...
          <div className="flex flex-col gap-2">
            {isPaymentRelated(checkoutError) ? (
              <>
                ...
                <Links
                  href={tunnelLinks.paymentSettings}
                  target="_blank"
                  type={LinkType.external}
