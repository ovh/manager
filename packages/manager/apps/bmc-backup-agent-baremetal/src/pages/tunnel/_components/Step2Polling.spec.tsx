...
describe('Step2Polling', () => {
  ...
  it('shows the indeterminate progress bar while polling', async () => {
    ...
    await waitFor(() =>
      expect(container.querySelector('.ba-step2-progress-bar-indeterminate')).toBeInTheDocument(),
    );
  ...
  it('reaches ready, shows the full bar, and invalidates the 4 caches + navigates on Continue', async () => {
    ...
    await waitFor(() =>
      expect(container.querySelector('.ba-step2-progress-bar-full')).toBeInTheDocument(),
    );
