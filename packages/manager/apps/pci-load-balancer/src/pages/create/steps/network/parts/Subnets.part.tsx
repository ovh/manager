        ...
        <>
          <OsdsFormField className="mt-8" inline>
            <OsdsText
              ...
              slot="label"
            >
              {tCreate('octavia_load_balancer_create_private_network_field_subnet')}
            </OsdsText>
            ...
            <OsdsSelect
              ...
              onOdsValueChange={(event) => {
                const targetSubnet = subnets.find((sub) => sub.id === event.target.value);
                      ...
                      dangerouslySetInnerHTML={{
                        __html: tCreate(
                          'octavia_load_balancer_create_private_network_no_subnet_text',
                          {
                            ...
                            trackLabel: LOAD_BALANCER_CREATION_TRACKING.CREATE_PRIVATE_NETWORK,
                          },
                        ),
                      }}
                    ></span>
