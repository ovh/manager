...
describe('mapLoadBalancerCatalogDTOToEntity', () => {
  it('returns empty array when no plans', () => {
    const dto: TLoadBalancerCatalogDTO = { plans: [] };
  ...
  it('maps single octavia-loadbalancer plan to catalog array', () => {
    const dto: TLoadBalancerCatalogDTO = {
      plans: [
        createPlanDTO(
  ...
  it('maps multiple octavia-loadbalancer plans to catalog array', () => {
    const dto: TLoadBalancerCatalogDTO = {
      plans: [
        createPlanDTO(
          'octavia-loadbalancer.loadbalancer-s.hour.consumption',
