    ...
    <div className={className}>
      <OsdsButton
        ...
        onClick={() => {
          ...
          trackClick({
            actions: [`${TRACKING_PREFIX}`, 'add-listener'],
            actionType: 'action',
          });
        }}
      >
              ...
              <OsdsTooltip>
                <OsdsButton
                  ...
                  onClick={() => {
                    ...
                    trackClick({
                      actions: [`${TRACKING_PREFIX}`, `delete-listener`],
                      actionType: 'action',
                    });
                  }}
                >
                    ...
                    <OsdsTooltip>
                      <OsdsButton
                        ...
                        onClick={() => {
                          ...
                          setListeners(newListeners);
                          trackClick({
                            actions: [`${TRACKING_PREFIX}`, `delete-instance`],
                            actionType: 'action',
                          });
                        }}
                      >
                    ...
                    <OsdsTooltip>
                      <OsdsButton
                        ...
                        onClick={() => {
                          ...
                          setListeners(newListeners);
                          trackClick({
                            actions: [`${TRACKING_PREFIX}`, `add-instance`],
                            actionType: 'action',
                          });
                        }}
                      >
