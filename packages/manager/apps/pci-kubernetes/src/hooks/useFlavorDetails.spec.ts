...
describe('getPriceByDesiredScale', () => {
  it('should return undefined if hour or desiredScaling is not provided', () => {
    expect(getPriceByDesiredScale(undefined, 100, 2)).toBeUndefined();
    expect(getPriceByDesiredScale(10, 100, 0)).toBeUndefined();
  });
