...
type PublicConnectivityProps = {
  ...
  price: { hour: string | null; month: string | null };
};

const PublicConnectivity = ({ disabled, checked, onChange, price }: PublicConnectivityProps) => {
      ...
      <div className="mb-6">
        ...
        {price && (
          <Text className="text-sm">
            {price.hour} / {t('kube_common_node_pool_node')}
          </Text>
        )}
      </div>
    </div>
