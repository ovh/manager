...
export const CartTotalPrice = ({
  ...
  const { getTextPrice, getFormattedHourlyCatalogPrice, getFormattedMonthlyCatalogPrice } =
    useCatalogPrice();
  ...
  return (
    <div data-testid="cart-total-price">
      ...
      <div className="flex flex-col items-end">
        {displayHourlyPrice && (
          <Text data-testid="cart-hourly-total-price">{getFormattedHourlyCatalogPrice(price)}</Text>
        )}
        {displayMonthlyPrice && (
