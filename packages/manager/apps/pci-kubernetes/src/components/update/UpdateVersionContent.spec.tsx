...
describe('UpdateVersionContent', () => {
  ...
  it('renders minor version update messages when forceVersion is false', () => {
    ...
    expect(
      getByText(/kube_service_minor_version_update_message_1/i),
    ).toBeInTheDocument();
    expect(
      getByText(/kube_service_minor_version_update_message_2/i),
    ).toBeInTheDocument();
    expect(
      getByText(/kube_service_minor_version_update_message_3/i),
    ).toBeInTheDocument();
    expect(
      getByText(/kube_service_minor_version_update_message_4/i),
    ).toBeInTheDocument();
    expect(
      getByText(/kube_service_minor_version_update_message_5/i),
    ).toBeInTheDocument();
