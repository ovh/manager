...
import { useClusterCreationStepper } from '@/pages/new/useCusterCreationStepper';
import NodePoolStep from '../pages/new/steps/NodePoolStep.component';

vi.mock('react-router-dom', () => ({
  useParams: () => ({ projectId: '12345' }),
}));

vi.mock('@/pages/new/useCusterCreationStepper', () => ({
