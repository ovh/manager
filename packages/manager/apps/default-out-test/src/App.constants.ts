...
export const appName = 'default-out-test';
...
export const APP_FEATURES = {
  listingApi: 'v6Iceberg' as ListingApi, // 'v6Iceberg' | 'v2' | 'v6'
  onboardingApi: 'v6' as OnboardingApi, // 'v2' | 'v6'
