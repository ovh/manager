...
import datacentresVrackNetwork from '../../public/translations/datacentres/vrack-network/Messages_fr_FR.json';
...
export const translations = {
  ...
  'datacentres/vrack-network': datacentresVrackNetwork,
  error,
};
