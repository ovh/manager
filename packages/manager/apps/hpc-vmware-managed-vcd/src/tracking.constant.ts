...
export const APP_NAME = 'managed_vcd';
...
const definedTrackingConfig = <T extends AppTracking>(config: T) => config;

export const TRACKING = definedTrackingConfig({
  onboarding: {
