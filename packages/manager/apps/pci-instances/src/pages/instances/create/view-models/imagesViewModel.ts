...
export const selectBackupsEligibilityContext = (
  ...
  return {
    flavorStorage: flavor.specifications.storage.value,
...
export const isBackupEligible = (
  ...
  eligibilityContext.flavorStorage > backup.minDisk &&
...
// (les sélecteurs backups sont désormais `selectBackupsEligibilityContext` et `selectEligibleBackups`)
