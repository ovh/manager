...
const Instances: FC = () => {
  ...
  const textCell = useCallback(
    (props: Instance, key: 'flavorName' | 'region' | 'imageName') =>
      isRefetching ? (
        <OsdsSkeleton />
      ) : (
  ...
  const listCell = useCallback(
    (props: Instance, key: 'public' | 'private') =>
      isRefetching ? (
        <OsdsSkeleton />
      ) : (
        <OsdsText
  ...
  const datagridColumns: DatagridColumn<Instance>[] = useMemo(
    () => [
      ...
      {
        id: 'region',
        cell: (props: Instance) => textCell(props, 'region'),
        label: t('region'),
        isSortable: false,
      },
      {
        id: 'flavor',
        cell: (props: Instance) => textCell(props, 'flavorName'),
        label: t('flavor'),
        isSortable: true,
      },
      {
        id: 'image',
        cell: (props: Instance) => textCell(props, 'imageName'),
        label: t('image'),
        isSortable: true,
      },
      {
        id: 'publicIPs',
        cell: (props: Instance) => listCell(props, 'public'),
        label: t('public_IPs'),
        isSortable: false,
      },
      {
        id: 'privateIPs',
        cell: (props: Instance) => listCell(props, 'private'),
        label: t('private_IPs'),
        isSortable: false,
      },
      {
