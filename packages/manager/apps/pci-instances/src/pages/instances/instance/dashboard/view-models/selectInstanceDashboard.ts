...
const getInternalActions = (instanceId: string, region: string) => {
...
const getExternalActions = (projectUrl: string, id: string, region: string) => {
  ...
  instance.actions
    ...
    .reduce<TInstanceActions>((acc, action) => {
      ...
      const newAction = {
        ...
        })(getInternalActions, getExternalActions),
      };
