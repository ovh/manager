...
export default [
  {
    ...
    children: [
      ...
      },
      {
        path: 'notebooks',
        id: 'notebooks',
        ...lazyRouteConfig(() => import('@/pages/notebooks/NotebookRoot.page')),
        children: [
          {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'stop/:jobId',
            id: 'training.stop',
            ...lazyRouteConfig(() => import('@/pages/jobs/kill/Kill.modal')),
          },
          {
            path: 'delete/:jobId',
            id: 'training.delete',
            ...
            children: [
              {
                ...
                ...lazyRouteConfig(() =>
                  import('@/pages/jobs/[jobId]/dashboard/delete/Delete.modal'),
                ),
              },
            ],
          },
        ...
        children: [
          {
            path: 'start/:appId',
            id: 'deploy.start',
            ...lazyRouteConfig(() => import('@/pages/apps/start/Start.modal')),
          },
          {
            path: 'stop/:appId',
            id: 'deploy.stop',
            ...lazyRouteConfig(() => import('@/pages/apps/stop/Stop.modal')),
          },
          {
            path: 'delete/:appId',
            id: 'deploy.delete',
            ...
            children: [
              {
                ...
                ...lazyRouteConfig(() =>
                  import('@/pages/apps/[appId]/dashboard/delete/Delete.modal'),
                ),
              },
              {
                path: 'update-port',
