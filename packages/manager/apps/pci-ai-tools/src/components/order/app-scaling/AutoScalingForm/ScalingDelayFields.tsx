...
export function ScalingDelayFields({
  ...
  useEffect(() => {
    ...
    validateRange('scaleDownStabilizationWindowSeconds', scaleDownValue);
    validateRange('scaleUpStabilizationWindowSeconds', scaleUpValue);
  }, [scaleDownValue, scaleUpValue, setError, clearErrors, t]);
