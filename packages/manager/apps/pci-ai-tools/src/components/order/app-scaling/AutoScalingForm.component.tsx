...
>(({ scaling, onChange, pricingFlavor, onNonValidForm }, ref) => {
  ...
  return (
    <Form {...scalingForm}>
      <div data-testid="auto-scaling-container" ref={ref} className="mx-8">
                  ...
                  >
                    <FormControl>
                      <SelectTrigger data-testid="data-format-select">
                        <SelectValue placeholder={ai.app.CustomMetricsFormatEnum.JSON} />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      step="0.5"
                      onChange={(e) => {
                        setValue('targetMetricValue', Number(e.target.value), {
                          shouldValidate: true,
                        });
                        handleChange();
                      }}
