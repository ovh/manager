...
describe('AutoScalingForm component', () => {
  ...
  const TestWrapper = ({
    resourceType = ai.app.ScalingAutomaticStrategyResourceTypeEnum.CPU as
      | typeof ai.app.ScalingAutomaticStrategyResourceTypeEnum.CPU
      | 'CUSTOM',
  }: {
    resourceType?:
      | typeof ai.app.ScalingAutomaticStrategyResourceTypeEnum.CPU
  ...
  it('should render AutoScalingForm with CUSTOM fields', async () => {
    render(<TestWrapper resourceType="CUSTOM" />, {
