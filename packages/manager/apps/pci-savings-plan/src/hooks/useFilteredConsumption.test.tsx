...
describe('useFilteredConsumption', () => {
  ...
  beforeEach(() => {
    jest.mocked(useSavingsPlanConsumption).mockReturnValue({
    ...
    jest
      .mocked(getLastXMonths)
      .mockReturnValue(['January 2023', 'December 2022']);

    jest
      .mocked(getBigestConsumption)
      .mockReturnValue(mockConsumptionData.flavors[1]);

    jest
      .mocked(isInstanceFlavor)
      .mockImplementation((flavor) => flavor.startsWith('b'));
  });
