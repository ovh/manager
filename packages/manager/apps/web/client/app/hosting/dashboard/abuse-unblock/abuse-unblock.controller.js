import {
  BEST_PRACTICES_GUIDE_URL,
  MONITORING_AUTOMATIC_EMAILS_GUIDE_URL,
} from './abuse-unblock.constants';
      ...
      .then((abuseState) => {
        ...
        if (key === MAILSOUT) {
          this.languagesHackedWebsiteUrl =
            ...
            ] || MONITORING_AUTOMATIC_EMAILS_GUIDE_URL.DEFAULT;
        } else {
          this.languagesHackedWebsiteUrl =
            BEST_PRACTICES_GUIDE_URL[this.coreConfig.getUser().ovhSubsidiary] ||
            BEST_PRACTICES_GUIDE_URL.DEFAULT;
        }
      })
      .finally(() => {
