  ...
  class PrivateDatabaseChangeRamCtrl {
    ...
    $onInit() {
      ...
      this.privateDatabaseService
        ...
        .then((result) => {
          angular.forEach(result, (e) => {
            const capacity = parseInt(e.planCode.match(/[0-9]+/)?.[0], 10);
            ...
            if (+capacity === +this.database.ram.value) {
              return;
            }
    ...
    getDurations() {
      ...
      this.privateDatabaseService
        ...
        .then((order) => {
          ...
          const details = order.details.filter((detail) => {
            return detail.detailType === 'DURATION';
          });
