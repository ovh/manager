...
export const DOMAINS_GUIDES = [
  {
    ...
    url: {
      ...
      DE: `${PREFIX_GUIDES_URL}de-documentation-web-cloud-domains-domain-names${SUFFIX_URL_GENERAL_INFORMATION}`,
      ES: `${PREFIX_GUIDES_URL}es-es-documentation-web-cloud-domains-domain-names${SUFFIX_URL_GENERAL_INFORMATION}`,
      IE: `${PREFIX_GUIDES_URL}en-ie-documentation-web-cloud-domains${SUFFIX_URL_GENERAL_INFORMATION}`,
      IT: `${PREFIX_GUIDES_URL}it-documentation-web-cloud-domains-domain-names${SUFFIX_URL_GENERAL_INFORMATION}`,
