...
angular.module('services').service('ServerFirewallAsa', function ServerFirewallAsa(OvhHttp, $q) {
  const self = this;
   ...
   * change the state
   */
  this.changeFirewallState = function changeFirewallState(serviceName, enabled) {
