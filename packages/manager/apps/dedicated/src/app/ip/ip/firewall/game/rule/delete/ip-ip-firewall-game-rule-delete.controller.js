angular.module('Module.ip.controllers').controller('RemoveGameFirewallRuleCtrl', function RemoveGameFirewallRuleCtrl($scope, $translate, Ip, $rootScope, Alerter, IpGameFirewall) {
  const self = this;
