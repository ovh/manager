...
export const VCD_MIGRATION_STATUS = {
  ENABLING: 'enabling',
  ENABLED: 'enabled',
  UNKNOWN: 'unknown',
};
...
export const PCC_MIGRATION_STATE = {
  0: PCC_MIGRATION_STATUS.NOT_ALLOWED,
  1: PCC_MIGRATION_STATUS.TO_MIGRATE,
  2: PCC_MIGRATION_STATUS.MIGRATED,
};
