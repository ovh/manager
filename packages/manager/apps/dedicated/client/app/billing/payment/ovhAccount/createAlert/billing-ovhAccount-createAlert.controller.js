angular
  ...
  .controller(
    ...
    function BillingOvhAccountCreateAlertController(
      $scope,
      $translate,
      BillingOvhAccount,
      Alerter,
      ...
      $scope.createAlert = () => {
        self.loading = true;
        BillingOvhAccount.putOvhAccountDetails(
          $scope.ovhAccount.model.accountId,
          {
            alertThreshold:
              parseInt(self.disableAlert ? 0 : self.amount, 10) * 100,
          },
        )
          .then(() => {
            ...
            Alerter.success(
              $translate.instant('ovhAccount_create_alert_success'),
            );
          })
          .catch((err) =>
