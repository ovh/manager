angular.module('UserAccount')
  .service(
    ...
    function UserAccountDoubleAuthBackupCodeService(OvhHttp) {
      /**
         * Get backupCode detail.
         * @return {Promise}
         */
      this.get = () => OvhHttp.get('/me/accessRestriction/backupCode', {
        rootPath: 'apiv6',
        returnErrorKey: '',
      });
      ...
      /**
         ...
         * @return {Promise}
         */
      this.delete = () => OvhHttp.delete('/me/accessRestriction/backupCode', {
        rootPath: 'apiv6',
      });
      ...
      /**
         ...
         * @return {Promise}
         */
      this.post = () => OvhHttp.post('/me/accessRestriction/backupCode', {
        rootPath: 'apiv6',
      });
