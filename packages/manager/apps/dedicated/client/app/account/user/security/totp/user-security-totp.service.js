angular.module('UserAccount').service('UserAccount.services.doubleAuth.totp', [
  ...
  function UserAccountDoubleAuthTotpService(OvhHttp) {
    /**
         ...
         * @return {Promise}
         */
    this.query = () => OvhHttp.get('/me/accessRestriction/totp', {
      rootPath: 'apiv6',
    });
    ...
    /**
         ...
         * @return {Promise}
         */
    this.post = () => OvhHttp.post('/me/accessRestriction/totp', {
      rootPath: 'apiv6',
    });
    ...
    /**
         ...
         * @return {Promise}
         */
    this.edit = (id, description) => OvhHttp.put('/me/accessRestriction/totp/{id}', {
      rootPath: 'apiv6',
      urlParams: {
        id,
      },
    ...
    /**
         ...
         * @return {Promise}
         */
    this.disable = (id, code) => OvhHttp.post('/me/accessRestriction/totp/{id}/disable', {
      rootPath: 'apiv6',
      urlParams: {
        id,
      },
    ...
    /**
         ...
         * @return {Promise}
         */
    this.enable = (id, code) => OvhHttp.post('/me/accessRestriction/totp/{id}/enable', {
      rootPath: 'apiv6',
      urlParams: {
        id,
      },
    ...
    /**
         ...
         * @return {Promise}
         */
    this.validate = (id, code) => OvhHttp.post('/me/accessRestriction/totp/{id}/validate', {
      rootPath: 'apiv6',
      urlParams: {
        id,
      },
