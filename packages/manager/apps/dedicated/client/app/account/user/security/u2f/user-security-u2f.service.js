...
angular.module('UserAccount').service('UserAccount.services.doubleAuth.u2f', [
  ...
  function UserAccountDoubleAuthU2fService($q, $window, OvhHttp) {
    ...
    /**
         ...
         * @return {Promise}
         */
    this.query = () => OvhHttp.get('/me/accessRestriction/u2f', {
      rootPath: 'apiv6',
    });
    ...
    /**
         ...
         * @return {Promise}
         */
    this.edit = (id, description) => OvhHttp.put('/me/accessRestriction/u2f/{id}', {
      rootPath: 'apiv6',
      urlParams: {
        id,
      },
    ...
    /**
         ...
         * @return {Promise}
         */
    this.challenge = (id, action) => OvhHttp.post('/me/accessRestriction/u2f/{id}/challenge', {
      rootPath: 'apiv6',
      urlParams: {
        id,
      },
    ...
    /**
         ...
         * @return {Promise}
         */
    this.disable = (id, clientData, signatureData) => OvhHttp.post('/me/accessRestriction/u2f/{id}/disable', {
      rootPath: 'apiv6',
      urlParams: {
        id,
      },
    ...
    /**
         ...
         * @return {Promise}
         */
    this.enable = (id, clientData, signatureData) => OvhHttp.post('/me/accessRestriction/u2f/{id}/enable', {
      rootPath: 'apiv6',
      urlParams: {
        id,
      },
    ...
    /**
         ...
         * @return {Promise}
         */
    this.validate = (id, clientData, registrationData) => OvhHttp.post('/me/accessRestriction/u2f/{id}/validate', {
      rootPath: 'apiv6',
      urlParams: {
        id,
      },
