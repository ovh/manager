angular.module('App').controller('CdnFlushRuleCtrl', ($scope, $stateParams, $translate, CdnDomain, Alerter) => {
  ...
  $scope.flushRule = function flushRule() {
    ...
    CdnDomain.flushRule($stateParams.productId, $stateParams.domain, $scope.cacheRule)
      ...
      .catch((err) => Alerter.alertFromSWS($translate.instant('cdn_configuration_add_rule_error', { t0: $scope.cacheRule.fileMatch }), err, $scope.alert));
  };
});
