angular
  .module('App')
  .controller('ovhManagerPccLicense', ($rootScope, $scope, $state, $stateParams, $translate, currentService, DedicatedCloud) => {
    $scope.licences = {
      model: null,
      spla: null,
      canActive: false,
    ...
    $scope.enableLicense = function enableLicense() {
      if (!currentService.usesLegacyOrder) {
        ...
        $scope.setAction('license/enable/legacy/dedicatedCloud-license-enableLegacy');
      }
    };
