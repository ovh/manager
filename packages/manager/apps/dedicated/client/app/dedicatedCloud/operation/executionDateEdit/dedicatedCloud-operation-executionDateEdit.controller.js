angular.module('App').controller('DedicatedCloudOperationExecutionDateEditCtrl', class {
  constructor($locale, $stateParams, $uibModalInstance, DedicatedCloud, operationToEdit) {
    this.$locale = $locale;
    ...
    this.dateFormat = this.$locale.DATETIME_FORMATS.short.replace('dd', 'd')
      .replace('MM', 'm')
      .replace('y', 'Y')
      .replace('HH', 'H')
      .replace('mm', 'i');
