...
export default /* @ngInject */ ($stateProvider) => {
  $stateProvider
    ...
    .state(
      'app.dedicatedCloud.details.datacenter.details.drp.ovh.secondPccStep.orderIp',
      {
        url: '/orderIp',
    ...
    .state(
      'app.dedicatedCloud.details.datacenter.details.drp.ovh.secondPccStep.legacyOrderIp',
      {
        url: '/legacyOrderIp',
