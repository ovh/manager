      ...
      resolve: {
        ...
        currentDrp: /* @ngInject */ (
          ...
          .then((states) => {
            ...
            const currentDrp = existingPlan
            || sortBy(states, 'datacenterId')[0];

            const drpVpnStatus = get(currentDrp, 'remoteSiteInformation.vpnConfigState');
            currentDrp.vpnStatus = drpVpnStatus;
            currentDrp.isWaitingVpnConfiguration = drpVpnStatus != null
        ...
        drpGlobalStatus: /* @ngInject */ (
          currentDrp,
          dedicatedCloudDrp,
        ) => ({
          error: dedicatedCloudDrp.constructor.isDrpNotInValidState(currentDrp.state)
            || dedicatedCloudDrp.constructor.isDrpNotInValidState(currentDrp.vpnStatus),
          warning: dedicatedCloudDrp.constructor.isDrpInChangingState(currentDrp.state)
            || dedicatedCloudDrp.constructor.isDrpInChangingState(currentDrp.vpnStatus),
          success: dedicatedCloudDrp.constructor.isDrpInValidState(currentDrp.state),
        }),
