...
describe('useLowestPriceGatewayByRegion', () => {
  it('should return size and price per hour of the lowest price gateway catalog', async () => {
    const { result } = renderHook(
      () => useLowestPriceGatewayByRegion('GRA-STAGING-A'),
      {
        wrapper: ({ children }) => (
