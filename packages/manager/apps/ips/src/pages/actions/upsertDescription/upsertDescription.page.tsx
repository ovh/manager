...
import { OdsTextareaChangeEventDetail, OdsTextareaCustomEvent } from '@ovhcloud/ods-components';
...
export default function UpsertDescriptionModal() {
  ...
  const handleDescriptionChange = (event: OdsTextareaCustomEvent<OdsTextareaChangeEventDetail>) => {
