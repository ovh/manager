    ...
    <div className="flex flex-col">
      ...
      <FormField className="w-full">
        ...
        <Combobox
          ...
          className="w-full"
          onValueChange={(event) => {
            setDestinationService(event.value?.[0]);
          ...
          items={[
            ...Object.entries(availableDestinations || [])
              ...
              .map(([key, services]) => ({
                ...
                options: services.map(({ service }) => ({
                  customerRendererData: {
                    displayName: productList?.find(
            ...
            currentService !== null && {
              label: t('service_destination_ip_parking_option_group_label'),
              options: [
                {
                  value: ipParkingOptionValue,
                  label: t('service_destination_ip_parking_option_label'),
                },
              ],
            },
          ].filter(Boolean)}
