...
import { OdsCheckbox, OdsFormField, OdsLink } from '@ovhcloud/ods-components/react';
...
export default function Step4({
  ...
  const { t } = useTranslation([TRANSLATION_NAMESPACES.importIpFromSys, NAMESPACES.CONTACT]);
