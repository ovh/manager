...
import { OdsFormField, OdsMessage, OdsRadio, OdsSpinner } from '@ovhcloud/ods-components/react';

import { NAMESPACES } from '@ovh-ux/manager-common-translations';
import { IntervalUnitType, OvhSubsidiary, useFormatDate } from '@ovh-ux/manager-react-components';
...
export default function Step3({
  ...
  const { availableDurations } = useDedicatedServerIpMigrationAvailableDurations({
    ip,
    token,
            ...
            <div className="flex items-center" key={durationString}>
              ...
              <label htmlFor={durationString} slot="label">
                ...
                {isLoading ? (
                  ...
                  <Price
                    value={data?.data?.prices?.withoutTax?.value * PRICE_MULTIPLIER}
