...
import { isAntiDdosEnabled, isGameFirewallEnabled } from '../DatagridCells/enableCellsUtils';
...
export const IpGroupDatagrid: React.FC<IpGroupDatagridProps> = ({ row, parentHeaders }) => {
  ...
  return (
    <Datagrid
      ...
      hideHeader
      tableLayoutFixed
      isLoading={isLoading || isIpDetailsLoading || isIpReverseLoading || isByoipSliceLoading}
