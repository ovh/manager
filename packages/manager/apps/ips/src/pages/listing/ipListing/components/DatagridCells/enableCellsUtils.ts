...
export const isAdditionalOrDedicated = (ipDetails?: IpDetails) =>
  ipDetails?.type === IpTypeEnum.ADDITIONAL || ipDetails?.type === IpTypeEnum.DEDICATED;

export const isLinkedServiceNameDedicated = (ipDetails?: IpDetails) =>
  getTypeByServiceName(ipDetails?.routedTo?.serviceName as string) === IpTypeEnum.DEDICATED;
...
export const isAntiDdosAvailable = (ipDetails?: IpDetails) => ipDetails?.version === 4;
