...
export const OrganisationsIdCell = ({ org }: OrganisationsCellProps) => {
  ...
  return (
    <>
      ...
      {!isLoading && !!orgDetails?.organisationId && (
        <div className="mt-2 inline-block">{orgDetails?.organisationId}</div>
      )}
    </>
  );
};
