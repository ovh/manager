...
export const OrganisationsEmailCell = ({ org }: OrganisationsCellProps) => {
  ...
  return (
    <>
      ...
      {!isLoading && !!orgDetails?.abuse_mailbox && (
        <div className="mt-2 inline-block">{orgDetails?.abuse_mailbox} </div>
      )}
    </>
  );
};
