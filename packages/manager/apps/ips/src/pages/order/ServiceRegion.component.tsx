...
export const ServiceRegion = () => {
  ...
  const { t } = useTranslation([TRANSLATION_NAMESPACES.order, NAMESPACES.REGION]);
  ...
  if (
    !region ||
    ![ServiceType.vps, ServiceType.server, ServiceType.dedicatedCloud].includes(selectedServiceType)
  ) {
    return <></>;
  }
