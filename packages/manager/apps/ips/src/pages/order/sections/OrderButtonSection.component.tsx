...
export const OrderButtonSection: React.FC = () => {
  ...
  return (
    <div className="flex gap-3">
      <OdsButton
        isDisabled={ipQuantity > MAX_IP_QUANTITY || ipQuantity < MIN_IP_QUANTITY}
        ...
        onClick={() => {
          const settings = getAdditionalIpsProductSettings({
            ...
            planCode: ipVersion === IpVersion.ipv6 ? ipv6PlanCode : selectedPlanCode,
            region: [ServiceType.ipParking, ServiceType.vrack].includes(selectedServiceType)
              ? selectedRegion
              : region,
            serviceName: selectedService,
            serviceType: selectedServiceType,
