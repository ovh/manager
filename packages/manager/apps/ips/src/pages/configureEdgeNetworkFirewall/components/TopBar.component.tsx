    ...
    <div className="mb-2 flex w-full flex-col justify-between gap-2 sm:flex-row">
      ...
      <div className="flex items-center gap-2">
        <OdsText>
          {t(
            getToggleLabelFromFirewallState({
              enabled: firewallModeEnabled as boolean,
              state: firewallState as IpEdgeFirewallStateEnum,
            }),
            {
        ...
        <OdsToggle
          ...
          isDisabled={isLoading || isRulesLoading || firewallState !== IpEdgeFirewallStateEnum.OK}
          onClick={(event) => {
