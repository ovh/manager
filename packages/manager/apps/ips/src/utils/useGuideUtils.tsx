...
const URL_LIST: {
  ...
  guideLink1: {
    links: getGuideLinks({
      link: 'public-cloud-network-configure-additional-ip?id=kb_article_view&sysparm_article=KB0050241',
      usFullLink:
  ...
  guideLink2: {
    links: getGuideLinks({
      link: 'dedicated-servers-network-ipaliasing?id=kb_article_view&sysparm_article=KB0043761',
      usFullLink:
  ...
  guideLink3: {
    links: getGuideLinks({
      link: 'dedicated-servers-proxmox-network-hg-scale?id=kb_article_view&sysparm_article=KB0043915',
      usFullLink:
  ...
  guideLink4: {
    links: getGuideLinks({
      link: 'public-cloud-network-additional-ip-vs-floating-ip?id=kb_article_view&sysparm_article=KB0050159',
      usFullLink:
  ...
  guideLink5: {
    links: getGuideLinks({
      link: 'dedicated-servers-configure-an-ipv6-in-a-vrack?id=kb_article_view&sysparm_article=KB0062825',
      usFullLink:
  ...
  configureReverseDnsGuide: {
    links: getGuideLinks({
      link: 'vps-configure-reverse-dns?id=kb_article_view&sysparm_article=KB0047603',
      usFullLink:
  ...
  configureGameFirewall: {
    links: getGuideLinks({
      link: 'dedicated-servers-game-ddos-firewall?id=kb_article_view&sysparm_article=KB0060685',
      usFullLink:
  ...
  configureEdgeNetworkFirewall: {
    links: getGuideLinks({
      link: 'dedicated-servers-firewall-network?id=kb_article_view&sysparm_article=KB0043455',
      usFullLink:
  ...
  documentationLink: {
    links: {
      ...
      DEFAULT: 'https://help.ovhcloud.com/csm?id=kb_search&query=additional%20IP&language=en',
    },
...
export const CHANGELOG_LINKS: ChangelogLinks = {
  changelog: 'https://github.com/orgs/ovh/projects/16/views/6?pane=info&sliceBy%5Bvalue%5D=IP',
  roadmap: 'https://github.com/orgs/ovh/projects/16/views/1?pane=info&sliceBy%5Bvalue%5D=IP ',
  'feature-request':
...
export function useGuideUtils(): {
  ...
  const links = useMemo(() => getUrlListLink({ subsidiary: ovhSubsidiary }), [ovhSubsidiary]);
