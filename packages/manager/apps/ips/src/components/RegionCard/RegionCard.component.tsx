...
import { OdsCard, OdsPopover, OdsRadio, OdsText } from '@ovhcloud/ods-components/react';

import { getCountryCode } from '@/utils';

import './region-card.scss';
import { getCityNameKey, getCountryKey, shadowColor } from './region-card.utils';
  ...
  return (
    <div>
      ...
      <OdsCard
        id={region}
        tabIndex={0}
        className={`flex cursor-pointer p-3 transition-shadow ${cardStyle} ${stateStyle} min-w-[300px] w-full sm:w-[311px] ${
