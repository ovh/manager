...
vi.mock('@ovhcloud/ods-components/react', () => ({
  ...
  OdsButton: (props: any) => (
    <button onClick={props.onClick} aria-label={props.icon as string}>
      {props.label}
    </button>
  ),
}));
...
describe('EditInline', () => {
  ...
  it('calls onConfirm with changed value and hides input', () => {
    ...
    const input = screen.getByTestId('edit-inline-input') as HTMLInputElement;
