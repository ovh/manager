...
export const getdedicatedServerVmacQueryKey = (params: GetDedicatedServerVmacParams) => [
...
export const getdedicatedServerVmac = async (
  ...
  fetchIcebergV6<DedicatedServerVmacType>({
    route: `/dedicated/server/${encodeURIComponent(params.serviceName)}/virtualMac`,
    page: 1,
    disableCache: true,
  });
...
export const getServerModels = async (): Promise<ApiResponse<ServerModelsType>> =>
