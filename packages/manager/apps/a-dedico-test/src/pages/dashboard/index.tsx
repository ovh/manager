...
import appConfig from '@/a-dedico-test.config';
...
export default function DashboardPage() {
  ...
  return (
    <BaseLayout
      breadcrumb={<Breadcrumb rootLabel={appConfig.rootLabel} appName="a-dedico-test" />}
      header={header}
      description="Description du a-dedico-test"
      tabs={
        <OdsTabs>
