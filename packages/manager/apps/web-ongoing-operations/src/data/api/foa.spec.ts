...
describe('foa api', () => {
  ...
  it('drops the tasks the api served outside of the requested filters', async () => {
    (v2.get as Mock).mockResolvedValue({
      data: [
        ...scheduledTasks,
        {
          id: 'f0a1c2d3-0000-4a1b-9b7e-000000000002',
          type: 'DomainTrade',
          status: 'DONE',
          createdAt: '2026-08-12T09:12:00+02:00',
        },
        {
          id: 'f0a1c2d3-0000-4a1b-9b7e-000000000003',
          type: 'DomainContactUpdate',
          status: 'SCHEDULED',
          createdAt: '2026-08-13T09:12:00+02:00',
        },
      ],
    });
  ...
  it('keeps a task whose type or status the api left out', async () => {
    const partialTask = { id: taskId } as TDomainTaskV2;
    (v2.get as Mock).mockResolvedValue({ data: [partialTask] });
