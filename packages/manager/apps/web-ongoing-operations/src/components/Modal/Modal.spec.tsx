...
describe('Modal by argument', () => {
  ...
  it('when the modal is contact', async () => {
    ...
    render(<Modal universe="domain" isModalOpen={true} data={modalContact} />, {
      wrapper,
    });
  ...
  it('when the modal is document', async () => {
    ...
    render(
      <Modal universe="domain" isModalOpen={true} data={modalDocument} />,
      {
        wrapper,
      },
    );
  ...
  it('when the modal is string', async () => {
    ...
    render(<Modal universe="domain" isModalOpen={true} data={modalString} />, {
      wrapper,
    });
