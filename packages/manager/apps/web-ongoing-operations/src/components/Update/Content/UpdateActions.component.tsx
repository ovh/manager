    ...
    <div className="flex flex-col gap-y-2 mt-8">
      <div className="flex items-center gap-x-2">
        ...
        <label
          ...
          className={!data?.canRelaunch ? 'text-[#808080]' : 'text-[#4D5592]'}
        >
      ...
      <div className="flex items-center gap-x-2">
        ...
        <label
          ...
          className={!data?.canAccelerate ? 'text-[#808080]' : 'text-[#4D5592]'}
        >
      ...
      <div className="flex items-center gap-x-2">
        ...
        <label
          ...
          className={!data?.canCancel ? 'text-[#808080]' : 'text-[#4D5592]'}
        >
