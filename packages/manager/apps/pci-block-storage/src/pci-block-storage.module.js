...
import routing from './pci-block-storage.routing';
import { TRACKING } from './pci-block-storage.constants';

import './pci-block-storage.styles.scss';
...
export default async (element, shellClient) => {
  const moduleName = 'ovhManagerPCIBlockStorageApp';
