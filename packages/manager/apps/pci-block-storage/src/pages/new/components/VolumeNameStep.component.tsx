...
export function VolumeNameStep({
  ...
  const { data } = useVolumePricing(projectId, region, volumeType, encryptionType, volumeCapacity);
  ...
  return (
    <>
      <OsdsFormField error={missingNameError ? tStepper('common_field_error_required') : ''}>
        ...
        <OsdsInput
          ...
          value={volumeName}
          color={missingNameError ? ODS_THEME_COLOR_INTENT.error : ODS_THEME_COLOR_INTENT.primary}
