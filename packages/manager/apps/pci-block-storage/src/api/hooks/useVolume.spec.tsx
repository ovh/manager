...
import { getVolumeCatalog, TVolumePricing } from '@/api/data/catalog';
...
vi.mocked(getVolumeCatalog).mockResolvedValue({
  regions: [],
  models: [
    {
      name: 'model1',
      ...
      pricings: [
        {
          regions: ['region1'],
          specs: { maxAttachableInstances: 2 },
        } as TVolumePricing,
      ],
      tags: [],
    },
  ],
  filters: { region: [], deployment: [] },
});
