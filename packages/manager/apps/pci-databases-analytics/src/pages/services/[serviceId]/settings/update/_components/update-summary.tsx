...
const NameDetails = ({ order }: UpdateSummaryProps) => {
...
const EngineDetails = ({ order }: UpdateSummaryProps) => {
  const { t } = useTranslation('pci-databases-analytics/services/new');
  return (
...
const PlanDetails = ({ order, onSectionClicked }: UpdateSummaryProps) => {
  const { t } = useTranslation('pci-databases-analytics/services/new');
  return (
    <div className="flex items-center gap-2">
      <Button
...
const RegionDetails = ({ order, onSectionClicked }: UpdateSummaryProps) => {
  const { t } = useTranslation('pci-databases-analytics/services/new');
...
const FlavorDetails = ({ order, onSectionClicked }: UpdateSummaryProps) => {
  const { t } = useTranslation('pci-databases-analytics/services/new');
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
...
const ClusterDetails = ({ order, onSectionClicked }: UpdateSummaryProps) => {
  const { t } = useTranslation('pci-databases-analytics/services/new');
...
const NetworkrDetails = ({ order, onSectionClicked }: UpdateSummaryProps) => {
  const { t } = useTranslation('pci-databases-analytics/services/new');
  return (
    <div className="flex items-start flex-col gap-2">
...
const IpsDetails = ({ order, onSectionClicked }: UpdateSummaryProps) => {
  const { t } = useTranslation('pci-databases-analytics/services/new');
  return (
    <div className="flex items-center gap-2">
      <Button
...
const UpdateSummary = ({ order, onSectionClicked }: UpdateSummaryProps) => {
  return (
