  ...
  customComponentExemple: (
    <Table className="border border-neutral-200">
      ...
      <TableHeader className="bg-neutral-50">
        <TableRow>
          <TableHead className="min-h-12 w-[100px] border border-neutral-200 text-primary-800 font-semibold px-4 py-3 bg-neutral-100">
            Invoice
          </TableHead>
          <TableHead className="border border-neutral-200 text-primary-800 font-semibold px-4 py-2 bg-neutral-100">
            Status
          </TableHead>
          <TableHead className="border border-neutral-200 text-primary-800 font-semibold px-4 py-2 bg-neutral-100">
            Method
