  ...
  return (
    <div data-testid="table-price-container">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 items-center text-xs">
        <div className="px-0 align-top">{t('pricing_instance_label')}</div>
        <div className="px-0 flex justify-end items-center flex-wrap gap-2">
          <Price
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 items-center text-xs">
        <div className="px-0 align-top">{t('pricing_storage_label')}</div>
        <div className="px-0 flex justify-end items-center flex-wrap gap-2">
          <Price
            className="flex justify-end items-center flex-wrap gap-2"
            decimals={3}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 items-center">
        <div className="font-semibold text-text px-0 align-top min-w-[110px]">
          {t('total_hour_label')}
        </div>
        <div className="px-0 flex justify-end items-center flex-wrap gap-2">
          <Price
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 items-center text-xs text-gray-500 italic">
        <div className="px-0 align-top">{t('estimated_month_label')}</div>
        <div className="px-0 flex justify-end items-center flex-wrap gap-2">
          <Price
            className="flex justify-end items-center flex-wrap gap-2"
            decimals={0}
