...
import { HelpCircle, Network as NetworkIcon, RefreshCcw } from 'lucide-react';
...
const NetworkOptions2 = React.forwardRef<HTMLInputElement, NetworkOptionsProps>(
  (
    {
      value,
      onChange,
...
NetworkOptions2.displayName = 'NetworkOptions2';

export default NetworkOptions2;
