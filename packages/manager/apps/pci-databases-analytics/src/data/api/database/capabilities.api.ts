...
export const getCapabilities = async (projectId: string) =>
         apiClient.v6
           ...
           .then(
             (res: { data: database.Capabilities }) =>
               res.data as database.Capabilities,
           );
...
export const getEnginesCapabilities = async (projectId: string) =>
         apiClient.v6
           ...
           .then(
             (res: { data: database.capabilities.EngineCapabilities[] }) =>
               res.data as database.capabilities.EngineCapabilities[],
           );
...
export const getRegionsCapabilities = async (projectId: string) =>
         apiClient.v6
           ...
           .then(
             (res: { data: database.capabilities.RegionCapabilities[] }) =>
               res.data as database.capabilities.RegionCapabilities[],
           );
