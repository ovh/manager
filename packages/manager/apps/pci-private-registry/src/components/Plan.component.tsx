...
export default function PlanComponent({
  ...
  const hourlyPricing =
    addon && /hour\.consumption/.test(addon.planCode) ? 'hour' : null;
  const monthlyPricing =
    addon && /month\.consumption/.test(addon.planCode) ? 'month' : null;
        ...
        <div>
          ...
          {pricing && (
            <div data-testid="price" className="text-center">
              ...
              >
                <p>
                  ~{monthly(convertHourlyPriceToMonthly(pricing.price))} / mois
                </p>
              </OsdsText>
            </div>
          )}
