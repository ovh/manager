...
export default function LiveChat({
  ...
  return (
    <>
      {chatbotOpen && (
        <div className="absolute w-full h-full xl:h-fit xl:w-auto bottom-2 right-2 z-[960] flex flex-col justify-end pointer-events-none">
          {chatType === 'Adrielly' && (
            <ChatDialog
              title="OVHcloud Chat"
          ...
          <div className="order-first xl:order-last relative p-3 bg-[#000e9c] xl:bg-transparent flex flex-row items-center justify-between xl:justify-end pointer-events-auto">
            {!chatbotReduced && (
              <>
                <OsdsButton
