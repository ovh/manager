...
export default function HostedPrivateCloudSidebar() {
  ...
  const getHPCMenu = (feature: Record<string, boolean>) => {
    ...
    if (feature.hycu || feature['veeam-backup'] || feature['hpc-backup-agent-iaas'] || true /* feature['hpc-backup-licenses'] TODO: remettre après test visuel */) {
      menu.push({
        ...
        pathMatcher: new RegExp('^/(hycu|veeam-backup|hpc-backup-agent-iaas|hpc-backup-licenses)'),
        badge: 'new',
        subItems: [
          ...
          true && { // TODO: remettre feature['hpc-backup-licenses'] après test visuel
