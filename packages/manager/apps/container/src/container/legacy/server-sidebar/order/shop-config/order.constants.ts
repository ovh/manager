...
> = {
  EU: {
    ...
    email_exchange: {
      ...
      IE: 'https://www.ovhcloud.com/en-ie/emails-exchange/',
      IT: 'https://www.ovhcloud.com/it/emails-exchange/',
      NL: 'https://www.ovhcloud.com/nl/emails-exchange/',
      PL: 'https://www.ovhcloud.com/pl/emails-exchange/',
      PT: 'https://www.ovhcloud.com/pt/emails-exchange/',
      GB: 'https://www.ovhcloud.com/en-gb/emails-exchange/',
      MA: 'https://www.ovhcloud.com/fr-ma/emails-exchange/',
      SN: 'https://www.ovhcloud.com/fr-sn/emails-exchange/',
      TN: 'https://www.ovhcloud.com/fr-tn/emails-exchange/'
    },
    zimbra_email: {
      FR: 'https://www.ovhcloud.com/fr/emails/',
      ES: 'https://www.ovhcloud.com/es-es/emails/',
      DE: 'https://www.ovhcloud.com/de/emails/',
      IE: 'https://www.ovhcloud.com/en-ie/emails/',
      IT: 'https://www.ovhcloud.com/it/emails/',
      NL: 'https://www.ovhcloud.com/nl/emails/',
      PL: 'https://www.ovhcloud.com/pl/emails/',
      PT: 'https://www.ovhcloud.com/pt/emails/',
      GB: 'https://www.ovhcloud.com/en-gb/emails/',
      MA: 'https://www.ovhcloud.com/fr-ma/emails/',
      SN: 'https://www.ovhcloud.com/fr-sn/emails/',
      TN: 'https://www.ovhcloud.com/fr-tn/emails/'
    },
    email_sharepoint: {
      ES: 'https://www.ovh.es/sharepoint/?range=mail',
      FR: 'https://www.ovhtelecom.fr/sharepoint/?range=mail',
  ...
  CA: {
    ...
    orderHosting: {
      ...
      WE: 'https://www.ovhcloud.com/en-ie/web-hosting/',
