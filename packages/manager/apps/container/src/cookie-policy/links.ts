...
export default {
  ...
  changeOpinionLink: {
    ...
    GB: 'https://www.ovh.co.uk/personal-data-protection/exercise-your-rights/',
    IE: 'https://www.ovh.ie/personal-data-protection/exercising-your-rights/',
    DE: 'https://www.ovh.de/schutz-personenbezogener-daten/rechte-ausueben/',
    ES: 'https://www.ovh.es/proteccion-datos-personales/ejercer-derechos/',
    IT: 'https://www.ovh.it/protezione-dati-personali/esercita-i-tuoi-diritti/',
    NL:
      'https://www.ovh.nl/beveiliging-persoonlijke-data/uw-rechten-uitoefenen/',
    PL: 'https://www.ovh.pl/ochrona-danych-osobowych/korzystanie-z-praw/',
    PT: 'https://www.ovh.pt/proteger-dados-pessoais/exercer-seus-direitos/',
    TN:
