...
describe('ListGuard', () => {
  ...
  it('should display the spinner while the aggregated gateways list is not available and isPending true', async () => {
    data = undefined;
    isPending = true;
    ...
    expect(getByTestId('listGuard-spinner')).toBeVisible();
  });
});
