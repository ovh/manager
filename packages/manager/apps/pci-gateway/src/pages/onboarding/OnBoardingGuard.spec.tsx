...
describe('ListGuard', () => {
  ...
  it('should display spinner while the aggregated gateways list is not available and isPending true', async () => {
    data = undefined;
    isPending = true;
    ...
    expect(getByTestId('onBoardingGuard-spinner')).toBeVisible();
  });
});
