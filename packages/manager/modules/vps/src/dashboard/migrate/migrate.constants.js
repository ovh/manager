export const MIGRATE_FAQ_LINK = {
  ...
  ES: 'https://www.ovhcloud.com/es-es/vps/vps-offer-migration/',
  ...
  IT: 'https://www.ovhcloud.com/it/vps/vps-offer-migration/',
  MA: 'https://www.ovhcloud.com/fr-ma/vps/vps-offer-migration/',
  NL: 'https://www.ovhcloud.com/nl/vps/vps-offer-migration/',
  PL: 'https://www.ovhcloud.com/pl/vps/vps-offer-migration/',
  PT: 'https://www.ovhcloud.com/pt/vps/vps-offer-migration/',
  ...
  WS: 'https://www.ovhcloud.com/es/vps/vps-offer-migration/',
};
export const MEMORY_MULTIPLE = 1024;
