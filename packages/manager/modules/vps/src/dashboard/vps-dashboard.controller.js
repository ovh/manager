...
export default class {
  ...
  initBackupStorageActions() {
    this.backupStorageActions = {
      manage: {
        ...
        callback: () => this.$state.go('vps.detail.backup-storage', { serviceName: this.serviceName }),
        isAvailable: () => !this.vps.loading,
      },
      order: {
        text: this.$translate.instant('vps_common_order'),
        callback: () => this.$state.go('vps.detail.backup-storage.order', { serviceName: this.serviceName }),
        isAvailable: () => !this.vps.loading,
      },
      terminate: {
  ...
  initSnapshotActions() {
    ...
    this.snapshotActions = {
      ...
      order: {
        text: this.$translate.instant('vps_common_order'),
        callback: () => this.$state.go('vps.detail.snapshot.order', { serviceName: this.serviceName }),
  ...
  initVeeamActions() {
    this.veeamActions = {
      manage: {
        text: this.$translate.instant('vps_common_manage'),
        callback: () => this.$state.go('vps.detail.veeam', { serviceName: this.serviceName }),
        isAvailable: () => !this.vps.loading,
      },
      order: {
        text: this.$translate.instant('vps_common_order'),
        callback: () => this.$state.go('vps.detail.veeam.order', { serviceName: this.serviceName }),
        isAvailable: () => !this.vps.loading,
      },
      terminate: {
        text: this.$translate.instant('vps_configuration_desactivate_option'),
  ...
  initActions() {
    return this.CucControllerHelper.navigation.getConstant(
      get(CHANGE_OWNER_URL, this.coreConfig.getRegion(), {}),
      ...
      this.actions = {
        ...
        orderWindows: {
          text: this.$translate.instant('vps_common_order'),
          callback: () => this.$state.go('vps.detail.windows.order', { serviceName: this.serviceName }),
        ...
        rebuild: {
          callback: () => this.$state.go('vps.detail.dashboard.rebuild', { serviceName: this.serviceName }),
          isAvailable: () => !this.loaders.polling && !this.vps.loading
