...
const URI = {
  ...
  serviceManagement: '#/billing/autorenew?serviceName=:serviceName',
  support: '#/ticket',
...
export default {
  EU: {
    ...
    serviceManagement: `${managerRoot.EU}/${universes.dedicated}/${URI.serviceManagement}`,
  ...
  CA: {
    ...
    serviceManagement: `${managerRoot.CA}/${universes.dedicated}/${URI.serviceManagement}`,
