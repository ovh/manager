...
export const ConsumptionDetails = () => {
  ...
  const consumptionInPercentage = (consumptionInTB / CONSUMPTION_MAX_VALUE_IN_TO) * 100;
  const consumptionLabel = `${consumptionInGB} ${t('unit_size_GB')} / ${CONSUMPTION_MAX_VALUE_IN_TO} ${t('unit_size_TB')} (${consumptionInPercentage}%)`;
