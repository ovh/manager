export const OTB_LOG_KEYS = ['message'];
...
const logsPrefix = 'telecom::overthebox::::logs';
export const OTB_LOGS_TRACKING_HITS = {
...
export const OTB_DATA_STREAMS_TRACKING_HITS = {
