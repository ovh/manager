...
export const MAX_NODES_BY_CLUSTER = 32;
...
export const PREFIX_TRACKING_NUTANIX_NUTANIX_POPUP = `${PREFIX_TRACKING_NUTANIX_NUTANIX}::pop-up`;
export const PREFIX_TRACKING_NUTANIX_DATAGRID = `${PREFIX_TRACKING_NUTANIX}::::datagrid`;
export const PREFIX_TRACKING_NUTANIX_POPUP = `${PREFIX_TRACKING_NUTANIX}::::pop-up`;

export const NUTANIX_CATALOGS_TYPES = {
  HGR: 'HGR',
  SCALE: 'Scale',
  OPTIONS: 'options',
};
