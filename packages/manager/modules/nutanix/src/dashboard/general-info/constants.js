...
export const GUIDE_PACKAGES_URL = {
  BYOL: {
    CA: `${GUIDES_URL.CA}byol`,
    QC: `${GUIDES_URL.QC}byol`,
    DE: `${GUIDES_URL.DE}byol`,
    ES: `${GUIDES_URL.ES}byol`,
    FR: `${GUIDES_URL.FR}byol`,
    GB: `${GUIDES_URL.GB}byol`,
    IE: `${GUIDES_URL.IE}byol`,
    IT: `${GUIDES_URL.IT}byol`,
    NL: `${GUIDES_URL.NL}byol`,
    PL: `${GUIDES_URL.PL}byol`,
    PT: `${GUIDES_URL.PT}byol`,
    MA: `${GUIDES_URL.MA}byol`,
    SN: `${GUIDES_URL.SN}byol`,
    TN: `${GUIDES_URL.TN}byol`,
    WS: `${GUIDES_URL.WS}byol`,
    US: `${GUIDES_URL.US}byol`,
    DEFAULT: `${GUIDES_URL.DEFAULT}byol`,
  },
  DEFAULT: {
