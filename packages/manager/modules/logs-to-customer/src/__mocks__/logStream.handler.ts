...
export const getLogStreamsMocks = ({ isLogStreamsKO }: GetLogStreamsMocksParams): Handler[] => [
  {
...
export const getLogStreamMocks = ({ isLogStreamKO }: GetLogStreamMocksParams): Handler[] => [
  {
