...
function addTranslations() {
  i18next.addResources('de_DE', 'logKind', de_DE);
  i18next.addResources('en_GB', 'logKind', en_GB);
  i18next.addResources('es_ES', 'logKind', es_ES);
  i18next.addResources('fr_CA', 'logKind', fr_CA);
  i18next.addResources('fr_FR', 'logKind', fr_FR);
  i18next.addResources('it_IT', 'logKind', it_IT);
  i18next.addResources('pl_PL', 'logKind', pl_PL);
  i18next.addResources('pt_PT', 'logKind', pt_PT);
}
