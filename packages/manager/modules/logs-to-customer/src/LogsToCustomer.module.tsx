...
import { Select, SelectControl, SelectContent, Spinner, Text } from '@ovhcloud/ods-react';
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        ...
        <Select
          ...
          value={currentLogKind?.kindId ? [currentLogKind.kindId] : []}
          onValueChange={(detail) => {
            const newLogKind = logKinds.find(
              (k) => k.kindId === detail?.value?.[0],
            );
            if (newLogKind) {
