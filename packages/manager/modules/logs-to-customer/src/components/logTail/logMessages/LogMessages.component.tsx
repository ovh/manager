...
import { Button, Input, Icon } from '@ovhcloud/ods-react';
...
export const LogMessages = ({ logTailMessageUrl }: ILogTailMessageUrl) => {
  ...
  return (
    <>
      <div className="h-[var(--toolbox-height)] flex items-center justify-between px-4 border-solid border-0 border-b border-slate-600">
        <div className="flex gap-2 items-center w-full">
          ...
          >
            <Icon name={isZoomedIn ? ICON_NAME.shrink : ICON_NAME.resize} />
          </Button>
        </div>
      </div>
