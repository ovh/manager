...
const testCases: TestParams[] = [
  ...
  },
  {
    ...
    engagementLabel: fr_FR.billing_informations_tile_engagement_status_engaged_renew.replace(
      '{{ date }}',
      '',
    ),
    renewLabel: fr_FR.billing_informations_tile_renew_state_automatic,
  },
  {
    ...
    engagementLabel: fr_FR.billing_informations_tile_engagement_status_engaged.replace(
      '{{ date }}',
      '',
    ),
