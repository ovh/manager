...
export namespace order {
  ...
  export namespace publicOrder {
    ...
    export interface Product {
      /** Product blobs */
      blobs?: order.publicOrder.ProductBlob | null;
      /** List of possible Configurations for this Commercial offer */
      configurations?: order.publicOrder.Configuration[] | null;
    ...
    export interface Plan {
      ...
      consumptionConfiguration?: order.publicOrder.ConsumptionConfiguration | null;
