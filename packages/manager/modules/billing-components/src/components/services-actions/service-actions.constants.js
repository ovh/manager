...
export const RENEW_URL = {
  ...
  EU: 'https://www.ovh.com/cgi-bin/order/renew.cgi?domainChooser=',
  ...
  IN: 'https://ca.ovh.com/cgi-bin/order/renew.cgi?domainChooser=',
  ...
  WS: 'https://ca.ovh.com/cgi-bin/order/renew.cgi?domainChooser=',
  ASIA: 'https://ca.ovh.com/cgi-bin/order/renew.cgi?domainChooser=',
};
