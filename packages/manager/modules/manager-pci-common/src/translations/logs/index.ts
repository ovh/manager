...
function addTranslations() {
  i18next.addResources('de_DE', 'pci-logs', de_DE);
  i18next.addResources('en_GB', 'pci-logs', en_GB);
  i18next.addResources('es_ES', 'pci-logs', es_ES);
  i18next.addResources('fr_CA', 'pci-logs', fr_CA);
  i18next.addResources('fr_FR', 'pci-logs', fr_FR);
  i18next.addResources('it_IT', 'pci-logs', it_IT);
  i18next.addResources('pl_PL', 'pci-logs', pl_PL);
  i18next.addResources('pt_PT', 'pci-logs', pt_PT);
}
