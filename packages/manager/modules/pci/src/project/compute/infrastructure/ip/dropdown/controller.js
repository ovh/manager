...
export default /* @ngInject */ function (
  ...
  self.failoverAttach = function failoverAttachFn(ip) {
  ...
  self.isIpUserSameContinent = function isIpUserSameContinentFn(ip) {
  ...
  self.getUserContinent = function getUserContinentFn() {
    let continent = null;
    if (self.user) {
  ...
  self.getIpContinent = function getIpContinentFn(ip) {
    let continent = null;
    let linkedVmId;
    switch (ip.type) {
      case 'failover':
