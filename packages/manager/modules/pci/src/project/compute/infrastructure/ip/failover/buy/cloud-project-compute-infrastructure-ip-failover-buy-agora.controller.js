...
angular
  .module('managerApp')
  .controller('CloudProjectComputeInfrastructureIpFailoverBuyAgoraCtrl', function ctrl(
    $http, $q, $stateParams, $translate, $uibModalInstance, $window, CucCloudMessage, OvhApiCloudProjectInstance,
  ) {
    const self = this;
