export const PUBLIC_CLOUD_GUIDES = {
...
export const DEPLOY_AN_APPLICATION = {
...
export const DIFFERENCES_BETWEEN_AI_NOTEBOOKS_AI_TRAINING_AI_APPS = {
...
export const GUIDE_TRACKING_TAG = {
  ...
  instance_backup: `${PREFIX_UNIVERSE_NAME}_instance_backup`,
  load_balancer: `${PREFIX_UNIVERSE_NAME}_load_balancer`,
  private_network: `${PREFIX_UNIVERSE_NAME}_private_network`,
  failover_ip: `${PREFIX_UNIVERSE_NAME}_failover_ip`,
  managed_kubernetes_service: `${PREFIX_UNIVERSE_NAME}_managed_kubernetes_service`,
  managed_private_registry: `${PREFIX_UNIVERSE_NAME}_managed_private_registry`,
  workflow_management: `${PREFIX_UNIVERSE_NAME}_workflow_management`,
  ai_notebooks: `${PREFIX_UNIVERSE_NAME}_ai_notebooks`,
  ai_training: `${PREFIX_UNIVERSE_NAME}_ai_training`,
  ai_apps: `${PREFIX_UNIVERSE_NAME}_ai_apps`,
  ml_serving: `${PREFIX_UNIVERSE_NAME}_ml_serving`,
  data_processing: `${PREFIX_UNIVERSE_NAME}_data_processing`,
  user_and_roles: `${PREFIX_UNIVERSE_NAME}_user_and_roles`,
  quota_and_regions: `${PREFIX_UNIVERSE_NAME}_quota_and_regions`,
  ssh_keys: `${PREFIX_UNIVERSE_NAME}_ssh_keys`,
  billing_control: `${PREFIX_UNIVERSE_NAME}_billing_control`,
  credit_and_vouchers: `${PREFIX_UNIVERSE_NAME}_credit_and_vouchers`,
  contacts_and_rights: `${PREFIX_UNIVERSE_NAME}_contacts_and_rights`,
};
