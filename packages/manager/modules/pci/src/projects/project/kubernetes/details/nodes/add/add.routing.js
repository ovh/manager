  ...
  $stateProvider.state('pci.projects.project.kubernetes.details.nodes.add', {
    ...
    resolve: {
      availableFlavors: /* @ngInject */ (
        ...
        Kubernetes,
        projectId,
      ) => Kubernetes.getAvailableFlavors(cluster, flavors, projectId),
      goBack: /* @ngInject */ (goToKubernetesNodes) => goToKubernetesNodes,
      flavors: /* @ngInject */ (cluster, OvhApiCloudProjectFlavor, projectId) =>
      ...
      prices: /* @ngInject */ (CucPriceHelper, projectId) =>
