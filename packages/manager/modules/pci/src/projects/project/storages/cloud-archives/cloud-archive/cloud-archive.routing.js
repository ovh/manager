export default /* @ngInject */ ($stateProvider) => {
  $stateProvider.state('pci.projects.project.storages.archives.archive', {
    url: '/{containerId}',
    ...
    resolve: {
      ...
      defaultPassword: /* @ngInject */ (
        ...
        PciProjectStorageContainersService.getArchivePassword(
          projectId,
          container,
        ),

      addObject: /* @ngInject */ ($state, projectId, containerId) => () =>
        $state.go('pci.projects.project.storages.archives.archive.add', {
          projectId,
          containerId,
        }),
      deleteObject: /* @ngInject */ ($state, projectId, containerId) => (
        ...
        $state.go('pci.projects.project.storages.archives.archive.delete', {
          projectId,
          containerId,
      ...
      goToStorageContainer: /* @ngInject */ (
        ...
        const promise = $state.go(
          'pci.projects.project.storages.archives.archive',
          {
            projectId,
            containerId,
          },
