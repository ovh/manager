export default /* @ngInject */ ($stateProvider) => {
  $stateProvider.state('pci.projects.project.serving.namespace', {
    ...
    resolve: {
      ...
      namespaceId: /* @ngInject */ ($transition$) =>
        $transition$.params().namespaceId,
      namespace: /* @ngInject */ (
      ...
      deleteNamespace: /* @ngInject */ ($state, projectId, namespaceId) => () =>
        $state.go('pci.projects.project.serving.namespace.delete', {
          projectId,
          namespaceId,
        }),
      ...
      infosLink: /* @ngInject */ ($state, projectId, namespaceId) =>
        $state.href('pci.projects.project.serving.namespace.infos', {
          projectId,
          namespaceId,
        }),
      modelsLink: /* @ngInject */ ($state, projectId, namespaceId) =>
        $state.href('pci.projects.project.serving.namespace.models', {
          projectId,
          namespaceId,
        }),
      tokensLink: /* @ngInject */ ($state, projectId, namespaceId) =>
