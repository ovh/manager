export default /* @ngInject */ ($stateProvider) => {
  $stateProvider
    .state('pci.projects.project.serving.namespace.models', {
      url: '/models',
      views: {
      ...
      resolve: {
        ...
        goToNamespaceModels: ($state, CucCloudMessage, projectId, namespaceId) => (message = false, type = 'success') => {
          const reload = message && type === 'success';

          const promise = $state.go('pci.projects.project.serving.namespace.models', {
            projectId,
            namespaceId,
          },
          {
          ...
          if (message) {
            promise.then(() => CucCloudMessage[type](message, 'pci.projects.project.serving.namespace.models'));
          }
