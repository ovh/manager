...
export default class {
  ...
  initializeTranslationKeys() {
    ...
    this.getEndOfLifeDateKey =
      'pci_projects_project_load_balancer_end_of_life_date_definitive';
    this.getMigrationIntroKey =
      'pci_projects_project_load_balancer_migration_intro_definitive';
