...
export default class CloudProjectComputeInfrastructureOpenstackClientCtrl {
  ...
  $onInit() {
    ...
    this.CucCloudMessage.unSubscribe('pci.projects.project.legacy.compute.openstack-console');
    this.messageHandler = this.CucCloudMessage.subscribe('pci.projects.project.legacy.compute.openstack-console', { onMessage: () => this.refreshMessages() });
  }
