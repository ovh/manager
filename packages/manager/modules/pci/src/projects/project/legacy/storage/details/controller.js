...
export default /* @ngInject */ function (
  ...
  function loadMessage() {
    CucCloudMessage.unSubscribe('pci.projects.project.legacy.compute.storage.details');
    $scope.messageHandler = CucCloudMessage.subscribe('pci.projects.project.legacy.compute.storage.details', {
