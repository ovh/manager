...
export default /* @ngInject */ function storageController(
  $filter,
  $rootScope,
  $scope,
  $stateParams,
  ...
  function loadMessage() {
    ...
    $scope.messageHandler = CucCloudMessage.subscribe('pci.projects.project.legacy.compute.storage', {
  ...
  function deleteContainer(container) {
    function createDeleteObjectTask(object) {
      return function deleteObjectTask() {
  ...
  $scope.delete = function openDeleteModal(container) {
    $uibModal.open({
