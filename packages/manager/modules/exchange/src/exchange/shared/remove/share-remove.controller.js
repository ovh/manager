angular.module('Module.exchange.controllers').controller(
  'ExchangeRemoveSharedCtrl',
  class ExchangeRemoveSharedCtrl {
      ...
      return this.services.ExchangePublicFolders.removingPublicFolders(
        ...
        .then((success) => {
          this.services.messaging.writeSuccess(
            this.services.$translate.instant('exchange_action_SHARED_delete_success'),
            success,
          );
        })
        .catch((failure) => {
          this.services.messaging.writeError(
            this.services.$translate.instant('exchange_action_SHARED_delete_error'),
            failure,
          );
        })
        .finally(() => {
