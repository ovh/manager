...
export const STATUS_TO_TEXT_MAP = {
  [GLOBAL_DKIM_STATUS.OK]: 'exchange_tab_domain_diagnostic_dkim_deactivation',
  [GLOBAL_DKIM_STATUS.DISABLED]:
    'exchange_tab_domain_diagnostic_dkim_activation',
  [GLOBAL_DKIM_STATUS.NOK]:
    'exchange_tab_domain_diagnostic_dkim_configuration_nok',
};
