export default class LogsAccountService {
  /* @ngInject */
  constructor(OvhApiDbaas, LogsHelperService, DbaasLogsConstants) {
  ...
  initializePasswordRules() {
    this.passwordRules = [
      ...
      },
      {
        ...
        translateParams: {
          specialCharacters: this.DbaasLogsConstants
        ...
        validator: (password) =>
          ...
          password.match(
            `.*[${this.constructor.escapeRegExp(
              this.DbaasLogsConstants.PASSWORD_SPECIAL_CHARACTERS,
            )}].*`,
          ),
      },
    ];
