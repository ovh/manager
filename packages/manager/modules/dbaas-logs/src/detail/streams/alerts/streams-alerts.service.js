export default class LogsStreamsAlertsService {
   ...
   *
   * @param {any} conditionType - the type of the condition (one of DbaasLogsConstants.alertType)
   * @returns the default alert object
   * @memberof LogsStreamsAlertsService
   */
  getNewAlert(conditionType) {
    const thresholdType =
      conditionType === this.DbaasLogsConstants.alertType.numeric
        ? this.DbaasLogsConstants.thresholdType.lower
        : this.DbaasLogsConstants.thresholdType.more;
    const constraintType = this.DbaasLogsConstants.constraintType.mean;
    return this.$q.when({
      data: {
        conditionType,
        thresholdType,
