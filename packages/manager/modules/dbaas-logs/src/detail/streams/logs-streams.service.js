...
export default class LogsStreamsService {
  ...
  initializeData() {
    ...
    this.storageTargets = [
      {
        value: this.DbaasLogsConstants.PCS,
        name: this.$translate.instant('logs_stream_target_pcs'),
      },
      {
        value: this.DbaasLogsConstants.PCA,
    ...
    this.storageContents = [
      {
        value: this.DbaasLogsConstants.CONTENT_GELF,
        name: this.$translate.instant('logs_stream_content_gelf'),
      },
      {
        value: this.DbaasLogsConstants.CONTENT_PLAIN,
        name: this.$translate.instant('logs_stream_content_plain'),
      },
      {
        value: this.DbaasLogsConstants.CONTENT_ALL,
  ...
  getSubscribedOptions(serviceName) {
    return this.LogsOptionsService.getSubscribedOptionsByType(
      serviceName,
      this.DbaasLogsConstants.STREAM_OPTION_REFERENCE,
    );
  }
  ...
  findStreamTokenValue(stream) {
    const ruleObj = find(
      stream.rules,
      (rule) => rule.field === this.DbaasLogsConstants.X_OVH_TOKEN,
    );
