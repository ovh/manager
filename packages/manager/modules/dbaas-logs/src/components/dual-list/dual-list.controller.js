export default class DualListCtrl {
  /* @ngInject */
  constructor($q, $element, dbaasLogsDualListProvider) {
    this.$q = $q;
    this.$element = $element;
    this.dbaasLogsDualListProvider = dbaasLogsDualListProvider;
  }

  $onInit() {
    this.sourceListLabel =
      this.sourceListLabel ||
      this.dbaasLogsDualListProvider.translations.sourceListLabel;
    this.targetListLabel =
      this.targetListLabel ||
      this.dbaasLogsDualListProvider.translations.targetListLabel;
    this.moveAllLabel =
      this.moveAllLabel ||
      this.dbaasLogsDualListProvider.translations.moveAllLabel;
    this.removeAllLabel =
      this.removeAllLabel ||
      this.dbaasLogsDualListProvider.translations.removeAllLabel;
    this.sourceListEmptyLabel =
      this.sourceListEmptyLabel ||
      this.dbaasLogsDualListProvider.translations.sourceListEmptyLabel;
    this.targetListEmptyLabel =
      this.targetListEmptyLabel ||
      this.dbaasLogsDualListProvider.translations.targetListEmptyLabel;
    this.addLabel =
      this.addLabel || this.dbaasLogsDualListProvider.translations.addLabel;
    this.height = this.height || this.dbaasLogsDualListProvider.height;
    this.bulkActionEnabled =
      this.bulkActionEnabled ||
      this.dbaasLogsDualListProvider.bulkActionEnabled;
