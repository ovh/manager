angular.module('managerApp').controller('XdslModemDhcpCtrl', function ($stateParams, PackXdslModemDhcpObject, OvhApiXdsl, $q, $translate, TucToast, tucValidator, TucPackXdslModemMediator) {
  const self = this;
