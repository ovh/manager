angular.module('managerApp').config(($stateProvider) => {
  $stateProvider.state('pack.migration', {
    url: '/migration',
    views: {
      ...
      'serviceDeleteView@pack.migration': {
      ...
      'buildingDetailsView@pack.migration': {
