...
export const DELETE_ENTITY_TAG = {
  ...
  [ENTITY.API_KEY]: {
    close: TAG.DELETE_API_KEY__CANCEL,
    delete: TAG.DELETE_API_KEY__CONFIRM,
    error: TAG.API_KEYS__DELETE_APPLICATION_CONFIRM_BANNER__ERROR,
    success: TAG.API_KEYS__DELETE_APPLICATION_CONFIRM_BANNER__SUCCESS,
  },
};
