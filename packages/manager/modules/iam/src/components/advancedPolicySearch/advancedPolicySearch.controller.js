export default class AdvancedPolicySearchController {
  ...
  onResourceChanged(changes) {
    console.group('[AdvancedPolicySearchController] onResourceChanged');
  ...
  onResourceError(error) {
    console.group('[AdvancedPolicySearchController] onError');
  ...
  trackClick() {
    this.testTrackClick = true; // TODO
  }

  trackPage() {
    this.testTrackPage = true; // TODO
  }
}
