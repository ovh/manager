...
angular
  ...
  .run(
    /* @ngInject */ ($templateCache) => {
      $templateCache.put(
        'cdn/dedicated/domain/rule/activate/cdn-dedicated-domain-rule-activate.html',
        template,
      );
      $templateCache.put(
        'cdn/dedicated/domain/rule/activate/all/cdn-dedicated-domain-rule-activate-all.html',
        activateAllTemplate,
      );
    },
  );
