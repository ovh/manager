 ...
 */
export type PostDedicatedNvmeofServiceNameChangeContactBody = {
...
export type GetDedicatedNvmeofParams = {
/**
...
export type PostDedicatedNvmeofServiceNameConfirmTerminationBody = {
 ...
 * @nullable
 */
export type DedicatedNvmeofClusterWithIAMOVHIam = IamResourceMetadataOVH | null;

/**
 * State of NVMeoF cluster
 */
export type DedicatedNvmeofClusterStateEnumOVH = typeof DedicatedNvmeofClusterStateEnumOVH[keyof typeof DedicatedNvmeofClusterStateEnumOVH];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DedicatedNvmeofClusterStateEnumOVH = {
  active: 'active',
  deleted: 'deleted',
  new: 'new',
  suspended: 'suspended',
 ...
 */
export interface DedicatedNvmeofClusterWithIAMOVH {
  /** Datacenter */
   ...
   * @nullable
   */
  readonly iam?: DedicatedNvmeofClusterWithIAMOVHIam;
  ...
  /** State of NVMeoF cluster */
  readonly state?: DedicatedNvmeofClusterStateEnumOVH;
}

/**
 * Structure describing access to NVMeoF cluster
 */
export interface DedicatedNvmeofClusterAccessOVH {
  /** Cluster data path access */
  readonly apiData?: DedicatedNvmeofApiAccessOVH;
  /** Cluster management API access */
  readonly apiManagement?: DedicatedNvmeofApiAccessOVH;
  /** CA certificate */
 ...
 * Structure describing a service
 */
export interface DedicatedNvmeofClusterOVH {
  /** Datacenter */
  readonly datacenter?: string;
  /** Label of NVMeoF cluster */
  readonly label?: string;
 ...
 */
export interface DedicatedNvmeofApiAccessOVH {
 ...
 */
export interface DedicatedNvmeofACLManagementOVH {
  /**
   * Cluster management clients
   * @nullable
   */
  networks: Ipv4BlockOVH[] | null;
}

/**
 * Structure describing NVMeoF cluster ACLs
 */
export interface DedicatedNvmeofACLDataOVH {
  /**
