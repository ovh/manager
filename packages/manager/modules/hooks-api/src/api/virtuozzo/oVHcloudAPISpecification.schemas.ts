 ...
 */
export type GetLicenseVirtuozzoServiceNameTasksParams = {
/**
...
export type GetLicenseVirtuozzoServiceNameOptionParams = {
/**
...
export type PostLicenseVirtuozzoServiceNameConfirmTerminationBody = {
...
export type PostLicenseVirtuozzoServiceNameChangeIpBody = {
  /** The Ip on which you want to move this license */
  destinationIp: Ipv4OVH;
};

export type GetLicenseVirtuozzoServiceNameCanLicenseBeMovedToParams = {
/**
 * The Ip on which you want to move this license
 */
destinationIp: Ipv4OVH;
...
export type GetLicenseVirtuozzoOrderableVersionsParams = {
/**
 * Your license Ip
 */
ip: Ipv4OVH;
...
export type GetLicenseVirtuozzoParams = {
/**
 ...
 * @nullable
 */
export type LicenseVirtuozzoVirtuozzoWithIAMOVHIam = IamResourceMetadataOVH | null;

/**
 * All versions available for Virtuozzo products
 */
export type LicenseVirtuozzoVersionEnumOVH = typeof LicenseVirtuozzoVersionEnumOVH[keyof typeof LicenseVirtuozzoVersionEnumOVH];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const LicenseVirtuozzoVersionEnumOVH = {
 ...
 */
export type LicenseVirtuozzoContainerNumberEnumOVH = typeof LicenseVirtuozzoContainerNumberEnumOVH[keyof typeof LicenseVirtuozzoContainerNumberEnumOVH];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const LicenseVirtuozzoContainerNumberEnumOVH = {
 ...
 */
export interface LicenseVirtuozzoVirtuozzoWithIAMOVH {
  /** The amount of containers this license can manage */
  readonly containerNumber?: LicenseVirtuozzoContainerNumberEnumOVH;
   ...
   * @nullable
   */
  readonly iam?: LicenseVirtuozzoVirtuozzoWithIAMOVHIam;
  /**
  ...
  readonly version?: LicenseVirtuozzoVersionEnumOVH;
}

/**
 * Your Virtuozzo license
 */
export interface LicenseVirtuozzoVirtuozzoOVH {
  /** The amount of containers this license can manage */
  readonly containerNumber?: LicenseVirtuozzoContainerNumberEnumOVH;
  /** This license creation date */
  readonly creation?: string;
 ...
 */
export type LicensePotentialProblemVirtuozzoEnumOVH = typeof LicensePotentialProblemVirtuozzoEnumOVH[keyof typeof LicensePotentialProblemVirtuozzoEnumOVH];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const LicensePotentialProblemVirtuozzoEnumOVH = {
  isLinuxOs: 'isLinuxOs',
...
export const LicenseOrderableVirtuozzoContainerNumberEnumOVH = {
  ...
  '2_CPU_060_CONTAINER': '2_CPU_060_CONTAINER',
  '2_CPU_100_CONTAINER': '2_CPU_100_CONTAINER',
  '1-container-for-2-cpu': '1-container-for-2-cpu',
  '10-containers-for-2-cpu': '10-containers-for-2-cpu',
  '100-containers-for-2-cpu': '100-containers-for-2-cpu',
  '3-containers-for-2-cpu': '3-containers-for-2-cpu',
  '30-containers-for-2-cpu': '30-containers-for-2-cpu',
  '60-containers-for-2-cpu': '60-containers-for-2-cpu',
} as const;

/**
 * All versions available for Virtuozzo products
 */
export interface LicenseOrderableVirtuozzoCompatibilityInfosOVH {
  compliantContainers?: LicenseOrderableVirtuozzoContainerNumberEnumOVH[];
  potentialProblems?: LicensePotentialProblemVirtuozzoEnumOVH[];
  version?: LicenseOrderableVirtuozzoVersionEnumOVH;
}

/**
 * The serviceTypes allowed to Order a Virtuozzo version
 */
export interface LicenseVirtuozzoOrderConfigurationOVH {
  orderableVersions?: LicenseOrderableVirtuozzoCompatibilityInfosOVH[];
