 ...
 */
export type VipUniverseEnumOVH = typeof VipUniverseEnumOVH[keyof typeof VipUniverseEnumOVH];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const VipUniverseEnumOVH = {
  cloud: 'cloud',
  dedicated: 'dedicated',
  telecom: 'telecom',
  web: 'web',
 ...
 * @nullable
 */
export type VipSupportVipWithIAMOVHIam = IamResourceMetadataOVH | null;

/**
 * Vip Service
 */
export interface VipSupportVipWithIAMOVH {
  /**
   * IAM resource metadata
   * @nullable
   */
  readonly iam?: VipSupportVipWithIAMOVHIam;
  /** Name of the VIP offer */
  readonly serviceName?: string;
  /** VIP universes of this service */
  readonly universe?: readonly VipUniverseEnumOVH[];
}

/**
 * Vip Service
 */
export interface VipSupportVipOVH {
  /** Name of the VIP offer */
  readonly serviceName?: string;
  /** VIP universes of this service */
  readonly universe?: readonly VipUniverseEnumOVH[];
