 ...
 * @nullable
 */
export type StackMisProductWithIAMOVHIam = IamResourceMetadataOVH | null;

/**
 * Stack type
 */
export type StackStackTypeEnumOVH = typeof StackStackTypeEnumOVH[keyof typeof StackStackTypeEnumOVH];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const StackStackTypeEnumOVH = {
  MDS: 'MDS',
  MIS: 'MIS',
  MOS: 'MOS',
} as const;
 ...
 * Stack MIS
 */
export interface StackMisProductWithIAMOVH {
   ...
   * @nullable
   */
  readonly iam?: StackMisProductWithIAMOVHIam;
  /** Type of the infrastructure */
  readonly type?: StackStackTypeEnumOVH;
}

/**
 * Stack MIS
 */
export interface StackMisProductOVH {
  /** Domain of the service */
  readonly domain?: string;
  /** Type of the infrastructure */
  readonly type?: StackStackTypeEnumOVH;
