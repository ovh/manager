 ...
 */
export type GetLicenseHycuParams = {
/**
...
export type PostLicenseHycuServiceNameConfirmTerminationBody = {
 ...
 * @nullable
 */
export type LicenseHycuHycuWithIAMOVHIam = IamResourceMetadataOVH | null;
 ...
 * Your Hycu license
 */
export interface LicenseHycuHycuWithIAMOVH {
   ...
   * @nullable
   */
  readonly iam?: LicenseHycuHycuWithIAMOVHIam;
  /** The Hycu license file */
 ...
 * Your Hycu license
 */
export interface LicenseHycuHycuOVH {
  /** This license creation date */
  readonly creation?: string;
  /** Shall we delete this on expiration ? */
  deleteAtExpiration?: boolean;
 ...
 * @nullable
 */
export type HycuStateWithIAMOVHIam = IamResourceMetadataOVH | null;

/**
 * HYCU license State
 */
export interface HycuStateWithIAMOVH {
   ...
   * @nullable
   */
  readonly iam?: HycuStateWithIAMOVHIam;
  /** The license status */
  readonly licenseStatus?: HycuLicenseStatusEnumOVH;
  /** License ID */
...
/**
 * HYCU license activation request
 */
export interface HycuRefreshLicensePayloadOVH {
  /** License request in base64 format */
 ...
 * HYCU license status
 */
export type HycuLicenseStatusEnumOVH = typeof HycuLicenseStatusEnumOVH[keyof typeof HycuLicenseStatusEnumOVH];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const HycuLicenseStatusEnumOVH = {
  active: 'active',
  error: 'error',
 ...
 * HYCU license file
 */
export interface HycuLicenseFileOVH {
 ...
 * HYCU license activation request
 */
export interface HycuActivateLicensePayloadOVH {
  /** License request in base64 format */
  licenseRequest: string;
}
