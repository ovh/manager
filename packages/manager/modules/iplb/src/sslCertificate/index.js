...
angular
  ...
  .controller('IpLoadBalancerSslCertificateCtrl', IpLoadBalancerSslCertificateCtrl)
  .controller('IpLoadBalancerSslCertificateEditCtrl', IpLoadBalancerSslCertificateEditCtrl)
  .controller('IpLoadBalancerSslCertificateUpdateCtrl', IpLoadBalancerSslCertificateUpdateCtrl)
  .controller('IpLoadBalancerSslCertificatePreviewCtrl', IpLoadBalancerSslCertificatePreviewCtrl)
  .controller('IpLoadBalancerSslCertificateOrderCtrl', IpLoadBalancerSslCertificateOrderCtrl)
  .controller('IpLoadBalancerSslCertificateDeleteCtrl', IpLoadBalancerSslCertificateDeleteCtrl)
