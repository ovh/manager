...
export default class IpLoadBalancerSslCertificateCtrl {
  ...
  init() {
    this.loading = true;
    this.IpLoadBalancerSslCertificateService.getCertificates(
  ...
  update(ssl) {
    return this.IpLoadBalancerActionService.updateCertificate(
      this.$stateParams.serviceName,
      ssl,
    ).then(() => {
      this.init();
  ...
  delete(ssl) {
    return this.IpLoadBalancerActionService.deleteCertificate(
      this.$stateParams.serviceName,
      ssl,
    ).then(() => {
      this.init();
