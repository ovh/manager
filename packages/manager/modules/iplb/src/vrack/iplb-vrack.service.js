...
export default class IpLoadBalancerVrackService {
  ...
  associateVrack(serviceName, vrackName) {
    return this.OvhApiVrack.IpLoadBalancing()
      .v6()
      .create(
        {
      ...
      .$promise.then((task) => task.data)
      .catch(
        this.CucServiceHelper.errorHandler('iplb_vrack_associate_vrack_error'),
      );
  }
    ...
    return this.OvhApiIpLoadBalancing.Vrack()
      ...
      .catch(
        this.CucServiceHelper.errorHandler(
          'iplb_vrack_deassociate_vrack_error',
        ),
      );
  }
  ...
  getNetworkCreationRules(serviceName, config = { resetCache: false }) {
    ...
    return this.OvhApiIpLoadBalancing.Vrack()
        ...
        const promises = {
          ...
          vrack:
            response.state === 'active'
              ? this.OvhApiVrack.v6().get({ serviceName: response.vrackName })
                  .$promise
              : this.$q.when({}),
          ...
          rules:
            response.state === 'active'
              ? this.OvhApiIpLoadBalancing.Vrack()
                  .v6()
                  .getCreationRules({ serviceName }, {}).$promise
              : this.$q.when({}),
        };
      ...
      .catch(
        this.CucServiceHelper.errorHandler('iplb_vrack_rules_loading_error'),
      );
  }
  ...
  getPrivateNetworks(serviceName) {
    return this.OvhApiIpLoadBalancing.Vrack()
      ...
      .query({ serviceName })
      .$promise.then((response) => {
        const promises = map(response, (networkId) =>
          this.getPrivateNetwork(serviceName, networkId),
        );
        return this.$q.all(promises);
      })
      .then((response) => {
      ...
      .catch(
        this.CucServiceHelper.errorHandler(
          'iplb_vrack_private_networks_loading_error',
        ),
      );
  }
    ...
    return this.OvhApiIpLoadBalancing.Vrack()
      ...
      .then(() =>
        this.CucServiceHelper.successHandler(
          'iplb_vrack_private_network_add_success',
        )(),
      )
      .catch(
        this.CucServiceHelper.errorHandler(
          'iplb_vrack_private_network_add_error',
        ),
      );
  }
  ...
  editPrivateNetwork(serviceName, network) {
    return this.$q
      ...
      .then(() =>
        this.CucServiceHelper.successHandler(
          'iplb_vrack_private_network_edit_success',
        )(),
      )
      .catch(
        this.CucServiceHelper.errorHandler(
          'iplb_vrack_private_network_edit_error',
        ),
      );
  }
  ...
  deletePrivateNetwork(serviceName, networkId) {
    return this.OvhApiIpLoadBalancing.Vrack()
      .v6()
      .updateFarmId({ serviceName, vrackNetworkId: networkId }, { farmId: [] })
      .$promise.then(
        () =>
          this.OvhApiIpLoadBalancing.Vrack()
            .v6()
      ...
      .then(() =>
        this.CucServiceHelper.successHandler(
          'iplb_vrack_private_network_delete_success',
        )(),
      )
      .catch(
        this.CucServiceHelper.errorHandler(
          'iplb_vrack_private_network_delete_error',
        ),
      );
  }
  ...
  getPrivateNetwork(serviceName, networkId) {
    return this.OvhApiIpLoadBalancing.Vrack()
      .v6()
      .get({ serviceName, vrackNetworkId: networkId })
      .$promise.then((response) => {
      ...
      .catch(
        this.CucServiceHelper.errorHandler(
          'iplb_vrack_private_network_loading_error',
        ),
      );
  }
}
