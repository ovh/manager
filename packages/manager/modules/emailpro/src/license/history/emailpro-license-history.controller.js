...
export default /* @ngInject */ ($rootScope, $stateParams, $scope, $translate, EmailPro) => {
  $scope.loading = false;
  ...
  const parseSerie = function parseSerie(serie) {
    set(serie, 'name', $translate.instant(`emailpro_action_license_history_type_${serie.name}`));
