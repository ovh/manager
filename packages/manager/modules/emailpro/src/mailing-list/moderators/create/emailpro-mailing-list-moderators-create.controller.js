...
export default class EmailProMXPlanMailingListsCreateModeratorCtrl {
  /* @ngInject */
  ...
  createModerator() {
    ...
    return this.EmailProMXPlanMailingLists.addModerators(get(this.$scope, 'exchange.associatedDomainName'), {
