...
export default /* @ngInject */ ($scope, EmailPro, $q,
  $stateParams, $translate, WucConverterService) => {
  ...
  $scope.convertBytesSize = function convertBytesSize(nb, unit, decimalWanted = 0) {
