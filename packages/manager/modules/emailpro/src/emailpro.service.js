...
export default class EmailPro {
  ...
  constructor(
    ...
    this.delegationRightsCache = $cacheFactory(
      'UNIVERS_WEB_EMAIL_PRO_DELEGATION_RIGHTS',
    );
    ...
    this.sharedAccountsCache = $cacheFactory(
      'UNIVERS_WEB_EMAIL_PRO_SHARED_ACCOUNTS',
    );
    ...
    this.publicFolderCache = $cacheFactory(
      'UNIVERS_WEB_EMAIL_PRO_PUBLIC_FOLDERS',
    );
  ...
  getModels() {
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.get(`/${baseAPIPath}.json`, {
          rootPath: 'apiv6',
        }),
      )
  ...
  getEmailProServer(organization, name) {
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.get(`/${baseAPIPath}/{exchangeService}/server`, {
          rootPath: 'apiv6',
          urlParams: {
  ...
  getTasks(serviceName, pageSize, offset, domainName) {
    return this.gettingIsServiceMXPlan().then((isMXPlan) => {
      if (isMXPlan) {
        return this.$q.all([
  ...
  getMxTasks(serviceName) {
    return this.OvhHttp.get('/sws/emailpro/{exchange}/tasks', {
      rootPath: '2api',
      urlParams: {
  ...
  getCapabilities(serviceName, accountEmailAddress) {
    return this.gettingBaseAPIPath().then((baseAPIPath) =>
      this.OvhHttp.get(
        `/${baseAPIPath}/{exchange}/account/{accountEmailAddress}/capabilities`,
        {
          rootPath: 'apiv6',
          urlParams: {
            exchange: serviceName,
   ...
   */
  getAccountsForEmailPro(
    exchange,
    cache,
    pageSizeParam,
    offsetParam,
    searchParam,
    configurableOnlyParam,
    typeParam,
    timeout,
  ) {
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/accounts', {
        rootPath: '2api',
        urlParams: {
  ...
  getAccountsAndContacts(
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/accounts/contacts', {
        rootPath: '2api',
        urlParams: {
          exchange: serviceName,
        },
  ...
  getNewAccountOptions(serviceName) {
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/accounts/options', {
        rootPath: '2api',
        urlParams: {
          exchange: serviceName,
        },
  ...
  addEmailProAccount(serviceName, accountToAdd) {
    ...
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.post(`/${baseAPIPath}/{exchange}/account`, {
          rootPath: 'apiv6',
          urlParams: {
            exchange: serviceName,
          },
  ...
  getOrderList(serviceName) {
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/accounts/orders', {
        rootPath: '2api',
        urlParams: {
          exchange: serviceName,
        },
  ...
  orderAccounts(serviceName, accountsToAdd) {
    ...
    return this.OvhHttp.post('/order/email/pro/{exchange}/account/{duration}', {
      rootPath: 'apiv6',
      urlParams: {
        exchange: serviceName,
        duration,
  ...
  updatePassword(
    ...
    if (index > 10) {
      return this.$q.reject({
        message: this.$translate.instant(
          'emailpro_ACTION_update_account_timeout',
          { accountEmailAddress },
        ),
        type: 'error',
      });
    ...
    return this.OvhHttp.post(
      `/${baseAPIPath}/{exchange}/account/{primaryEmailAddress}/changePassword`,
      {
        rootPath: 'apiv6',
        urlParams: {
          exchange: serviceName,
  ...
  updateAccount(serviceName, account) {
    ...
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.put(
          `/${baseAPIPath}/{exchange}/account/{primaryEmailAddress}`,
          {
            rootPath: 'apiv6',
            urlParams: {
              exchange: serviceName,
  ...
  updateRenew(serviceName, accounts) {
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.put('/sws/emailpro/{exchange}/accounts/renew', {
        rootPath: '2api',
        urlParams: {
          exchange: serviceName,
        },
  ...
  getAccountDelegationRight(
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/accounts/{account}/rights', {
        rootPath: '2api',
        urlParams: {
          exchange: serviceName,
          account,
  ...
  updateAccountDelegationRights(serviceName, model) {
    return this.gettingIsServiceMXPlan()
      .then((isMXPlan) =>
        this.OvhHttp.post(
          '/sws/emailpro/{exchange}/accounts/{account}/rights-update',
          {
            rootPath: '2api',
            urlParams: {
              exchange: serviceName,
  ...
  getAliases(serviceName, account, pageSizeParam, offsetParam) {
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/accounts/{account}/alias', {
        rootPath: '2api',
        urlParams: {
          exchange: serviceName,
          account,
  ...
  getNewAliasOptions(serviceName, emailParam, type) {
    ...
    return this.gettingIsServiceMXPlan()
      .then((isMXPlan) =>
        this.OvhHttp.get('/sws/emailpro/{exchange}/aliasOptions', {
          rootPath: '2api',
          urlParams: {
            exchange: serviceName,
          },
  ...
  addAlias(serviceName, account, aliasModel) {
    ...
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.post(
          `/${baseAPIPath}/{exchange}/account/{primaryEmailAddress}/alias`,
          {
            rootPath: 'apiv6',
            urlParams: {
              exchange: serviceName,
      ...
      .then((data) => {
        this.resetAccounts();
        this.resetTasks();
        set(data, 'displayName', completeAlias);
        return data;
      });
  }
  ...
  deleteAlias(serviceName, account, alias) {
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.delete(
          `/${baseAPIPath}/{exchange}/account/{primaryEmailAddress}/alias/{alias}`,
          {
            rootPath: 'apiv6',
            urlParams: {
              exchange: serviceName,
  ...
  getGroups(serviceName, pageSizeParam, offsetParam, searchParam) {
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/groups', {
        rootPath: '2api',
        clearCache: true,
        urlParams: {
          exchange: serviceName,
  ...
  getMailingListDelegationRights(
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/groups/{mailinglist}/rights', {
        rootPath: '2api',
        clearCache: true,
        urlParams: {
          exchange: serviceName,
  ...
  updateMailingListDelegationRights(serviceName, model) {
    return this.gettingIsServiceMXPlan()
      .then((isMXPlan) =>
        this.OvhHttp.put(
          '/sws/emailpro/{exchange}/groups/{mailinglist}/rights-update',
          {
            rootPath: '2api',
            clearCache: true,
            urlParams: {
  ...
  deleteGroup(serviceName, groupName) {
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.delete(
          `/${baseAPIPath}/{exchange}/mailingList/{mailingListAddress}`,
          {
            rootPath: 'apiv6',
            urlParams: {
              exchange: serviceName,
  ...
  getNewGroupOptions(serviceName) {
    return this.$q
      .all({
        ...
        options: this.gettingBaseAPIPath().then((baseAPIPath) =>
          this.OvhHttp.get(`/${baseAPIPath}/{exchange}/domain`, {
            rootPath: 'apiv6',
            urlParams: {
              exchange: serviceName,
            },
      ...
      .then((data) => ({
        availableDepartRestrictions: data.models[
  ...
  getAccountsByGroup(
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get(
        '/sws/emailpro/{exchange}/groups/{mailinglist}/accounts',
        {
          rootPath: '2api',
          clearCache: true,
          urlParams: {
  ...
  retrievingAssociatedDomainName(serviceName) {
    return this.OvhHttp.get(`/email/mxplan/${serviceName}/domain`, {
      rootPath: 'apiv6',
  ...
  getManagersByGroup(
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get(
        '/sws/emailpro/{exchange}/groups/{mailinglist}/managers',
        {
          rootPath: '2api',
          clearCache: true,
          urlParams: {
  ...
  getMembersByGroup(
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get(
        '/sws/emailpro/{exchange}/groups/{mailinglist}/members',
        {
          rootPath: '2api',
          clearCache: true,
          urlParams: {
  ...
  removeManager(serviceName, groupName, accountId) {
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.delete(
          `/${baseAPIPath}/{exchange}/mailingList/{mailingListAddress}/manager/account/{managerAccountId}`,
          {
            rootPath: 'apiv6',
            urlParams: {
              exchange: serviceName,
  ...
  removeMember(serviceName, groupName, accountId, type) {
    return this.gettingBaseAPIPath().then((baseAPIPath) => {
      ...
      return this.OvhHttp.delete(url, {
        rootPath: 'apiv6',
        urlParams: {
          exchange: serviceName,
          mailingListAddress: groupName,
  ...
  getGroupAliasList(serviceName, groupName, pageSizeParam, offsetParam) {
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/group/{group}/alias', {
        rootPath: '2api',
        urlParams: {
          exchange: serviceName,
          mailingListAddress: groupName,
  ...
  addGroupAlias(serviceName, groupName, aliasModel) {
    ...
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.post(
          `/${baseAPIPath}/{exchange}/mailingList/{mailingListAddress}/alias`,
          {
            rootPath: 'apiv6',
            urlParams: {
              exchange: serviceName,
  ...
  deleteGroupAlias(serviceName, groupName, alias) {
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.delete(
          `/${baseAPIPath}/{exchange}/mailingList/{mailingListAddress}/alias/{alias}`,
          {
            rootPath: 'apiv6',
            urlParams: {
              exchange: serviceName,
  ...
  getDisclaimers(serviceName, pageSizeParam, offsetParam) {
    ...
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/disclaimers', {
        rootPath: '2api',
        urlParams: {
          exchange: serviceName,
        },
  ...
  getNewDisclaimerOptions(serviceName) {
    return this.gettingIsServiceMXPlan().then((isMXPlan) =>
      this.OvhHttp.get('/sws/emailpro/{exchange}/disclaimers/new/options', {
        rootPath: '2api',
        urlParams: {
          exchange: serviceName,
        },
  ...
  saveDisclaimer(serviceName, model) {
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.post(
          `/${baseAPIPath}/{exchange}/domain/{domainName}/disclaimer`,
          {
            rootPath: 'apiv6',
            urlParams: {
              exchange: serviceName,
  ...
  getEmailProLicenseHistory(serviceName, period) {
    ...
    return this.gettingBaseAPIPath()
      .then((baseAPIPath) =>
        this.OvhHttp.get(`/${baseAPIPath}/{exchange}/license`, {
          rootPath: 'apiv6',
          urlParams: {
            exchange: serviceName,
          },
      ...
      .then((data) => {
        ...
        ['basic', 'entreprise', 'standard'].forEach((currentLicense) => {
          data.forEach((d) => {
            ...
            license.max = max(map(license.data, 'value'));
  ...
  updateDeleteAtExpiration(serviceName, renewType) {
    return this.gettingIsServiceMXPlan()
      .then((isMXPlan) => {
        ...
        return this.OvhHttp.put('/sws/emailpro/{exchange}/deleteAtExpiration', {
          rootPath: '2api',
          urlParams: {
            exchange: serviceName,
          },
  ...
  getAccountIds(opts) {
    return this.gettingBaseAPIPath().then((baseAPIPath) =>
      this.OvhHttp.get(`/${baseAPIPath}/{exchangeService}/account`, {
        rootPath: 'apiv6',
        urlParams: {
  ...
  getAccount(opts) {
    return this.gettingBaseAPIPath().then((baseAPIPath) =>
      this.OvhHttp.get(
        `/${baseAPIPath}/{exchangeService}/account/{primaryEmailAddress}`,
        {
          rootPath: 'apiv6',
          urlParams: {
            exchangeService: opts.exchangeService,
  ...
  getAliasIds(opts) {
    return this.gettingBaseAPIPath().then((baseAPIPath) =>
      this.OvhHttp.get(
        `/${baseAPIPath}/{exchangeService}/account/{primaryEmailAddress}/alias`,
        {
          rootPath: 'apiv6',
          urlParams: {
            exchangeService: opts.exchangeService,
  ...
  gettingBaseAPIPath() {
    return this.gettingIsServiceMXPlan().then(
      (serviceIsMXPlan) => `email/${serviceIsMXPlan ? 'mxplan' : 'pro'}`,
    );
  }
}
