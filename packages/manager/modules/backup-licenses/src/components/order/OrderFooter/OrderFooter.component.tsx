  ...
  return (
    <div
      className={`mt-10 flex items-center justify-between gap-4 ${
        isSticky
          ? 'sticky bottom-4 z-10 rounded-md border border-solid border-[var(--ods-color-form-element-border-default)] bg-[var(--ods-color-neutral-000)] px-6 py-4'
          : 'border-0 border-t border-solid border-[var(--ods-color-neutral-200)] pt-8'
      }`}
    >
      <OdsButton
        type="button"
