...
function addTranslations() {
  i18next.addResources('de_DE', NAMESPACES.DASHBOARDS, de_DE);
  i18next.addResources('en_GB', NAMESPACES.DASHBOARDS, en_GB);
  i18next.addResources('es_ES', NAMESPACES.DASHBOARDS, es_ES);
  i18next.addResources('fr_FR', NAMESPACES.DASHBOARDS, fr_CA);
  i18next.addResources('fr_FR', NAMESPACES.DASHBOARDS, fr_FR);
  i18next.addResources('it_IT', NAMESPACES.DASHBOARDS, it_IT);
  i18next.addResources('pl_PL', NAMESPACES.DASHBOARDS, pl_PL);
  i18next.addResources('pt_PT', NAMESPACES.DASHBOARDS, pt_PT);
}
