...
export const fetchPrometheusData = async ({
  ...
  const defaultProjectId = 'f5e4920126564c76a8d94bb2af868fee';
  const defaultInstanceId = '9042f190-6431-495e-b870-35fc7c6f3222';
  const defaultResourceUrn = `urn:v1:eu:resource:publicCloudProject:${defaultProjectId}/instance/${defaultInstanceId}`;

  const processedQuery = query.replace('<resource_urn>', `"${defaultResourceUrn}"`);
